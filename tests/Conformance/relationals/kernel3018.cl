...
__kernel void sample_test(__global double8 *secondSource,
  ...
  tmp = (double4)((double)0);
  {
    ...
    ulong4 mask = (ulong4)(11, 12, 13, 13);
    tmp = shuffle2(src1, src2, mask);
    dest[17] = tmp;
  }
  tmp = (double4)((double)0);
