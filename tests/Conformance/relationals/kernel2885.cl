...
__kernel void sample_test(__global uint4 *secondSource, __global uint4 *source,
  ...
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(6, 0, 0, 7, 7, 2, 6, 0);
  ...
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(2, 6, 6, 7, 1, 7, 7, 0);
    tmp = shuffle2(src1, src2, mask);
    dest[1] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(5, 6, 6, 7, 3, 3, 6, 3);
    tmp = shuffle2(src1, src2, mask);
    dest[2] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(3, 1, 6, 1, 0, 4, 1, 5);
    tmp = shuffle2(src1, src2, mask);
    dest[3] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(4, 1, 5, 7, 0, 0, 1, 1);
    tmp = shuffle2(src1, src2, mask);
    dest[4] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(5, 7, 2, 5, 5, 7, 4, 0);
    tmp = shuffle2(src1, src2, mask);
    dest[5] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(6, 3, 4, 5, 4, 4, 2, 7);
    tmp = shuffle2(src1, src2, mask);
    dest[6] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(1, 1, 0, 4, 6, 7, 2, 2);
    tmp = shuffle2(src1, src2, mask);
    dest[7] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(3, 4, 7, 4, 1, 4, 5, 1);
    tmp = shuffle2(src1, src2, mask);
    dest[8] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(2, 2, 0, 4, 5, 2, 0, 6);
    tmp = shuffle2(src1, src2, mask);
    dest[9] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(5, 2, 3, 1, 4, 2, 5, 3);
    tmp = shuffle2(src1, src2, mask);
    dest[10] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(5, 1, 4, 2, 7, 6, 7, 6);
    tmp = shuffle2(src1, src2, mask);
    dest[11] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(6, 6, 7, 5, 5, 6, 6, 1);
    tmp = shuffle2(src1, src2, mask);
    dest[12] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(2, 5, 0, 7, 3, 5, 0, 0);
    tmp = shuffle2(src1, src2, mask);
    dest[13] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(6, 2, 3, 2, 2, 1, 0, 6);
    tmp = shuffle2(src1, src2, mask);
    dest[14] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(7, 5, 4, 0, 4, 7, 7, 2);
    tmp = shuffle2(src1, src2, mask);
    dest[15] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(6, 6, 3, 7, 4, 6, 1, 6);
    tmp = shuffle2(src1, src2, mask);
    dest[16] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(7, 2, 7, 6, 4, 6, 2, 0);
    tmp = shuffle2(src1, src2, mask);
    dest[17] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(7, 0, 1, 3, 0, 1, 3, 6);
    tmp = shuffle2(src1, src2, mask);
    dest[18] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(6, 6, 0, 5, 5, 5, 4, 7);
    tmp = shuffle2(src1, src2, mask);
    dest[19] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(0, 1, 2, 7, 6, 5, 5, 0);
    tmp = shuffle2(src1, src2, mask);
    dest[20] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(3, 4, 1, 0, 4, 3, 5, 3);
    tmp = shuffle2(src1, src2, mask);
    dest[21] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(0, 3, 1, 1, 2, 7, 4, 0);
    tmp = shuffle2(src1, src2, mask);
    dest[22] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(7, 4, 5, 4, 0, 0, 6, 2);
    tmp = shuffle2(src1, src2, mask);
    dest[23] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(0, 1, 6, 5, 3, 0, 7, 7);
    tmp = shuffle2(src1, src2, mask);
    dest[24] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(4, 3, 2, 0, 5, 2, 0, 5);
    tmp = shuffle2(src1, src2, mask);
    dest[25] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(0, 0, 1, 7, 6, 3, 3, 0);
    tmp = shuffle2(src1, src2, mask);
    dest[26] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(6, 6, 2, 7, 5, 6, 0, 0);
    tmp = shuffle2(src1, src2, mask);
    dest[27] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(7, 2, 6, 7, 1, 3, 1, 7);
    tmp = shuffle2(src1, src2, mask);
    dest[28] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(0, 3, 7, 1, 6, 3, 1, 3);
    tmp = shuffle2(src1, src2, mask);
    dest[29] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(4, 6, 6, 2, 6, 7, 1, 4);
    tmp = shuffle2(src1, src2, mask);
    dest[30] = tmp;
  }
  tmp = (uint8)((uint)0);
  {
    ...
    uint8 mask = (uint8)(4, 4, 4, 1, 1, 4, 1, 6);
    tmp = shuffle2(src1, src2, mask);
    dest[31] = tmp;
  }
}
