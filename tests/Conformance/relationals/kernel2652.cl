...
__kernel void sample_test(__global float2 *source, __global float8 *dest) {
  ...
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(1, 1, 0, 0, 1, 1, 0, 0);
    tmp = shuffle(src1, mask);
    dest[3] = tmp;
  }
  tmp = (float8)((float)0);
  ...
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(1, 1, 0, 1, 0, 0, 0, 1);
    tmp = shuffle(src1, mask);
    dest[5] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(0, 0, 0, 0, 1, 0, 0, 0);
    tmp = shuffle(src1, mask);
    dest[6] = tmp;
  }
  tmp = (float8)((float)0);
  ...
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(1, 1, 0, 1, 1, 0, 0, 1);
    tmp = shuffle(src1, mask);
    dest[11] = tmp;
  }
  tmp = (float8)((float)0);
  ...
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(0, 0, 1, 1, 1, 1, 0, 0);
    tmp = shuffle(src1, mask);
    dest[15] = tmp;
  }
  tmp = (float8)((float)0);
  ...
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(1, 1, 0, 0, 0, 0, 1, 1);
    tmp = shuffle(src1, mask);
    dest[19] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(0, 0, 0, 0, 0, 0, 0, 0);
    tmp = shuffle(src1, mask);
    dest[20] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(0, 1, 0, 0, 1, 1, 1, 0);
    tmp = shuffle(src1, mask);
    dest[21] = tmp;
  }
  tmp = (float8)((float)0);
  ...
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(1, 0, 1, 1, 1, 1, 0, 0);
    tmp = shuffle(src1, mask);
    dest[27] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(1, 1, 0, 1, 1, 1, 1, 0);
    tmp = shuffle(src1, mask);
    dest[28] = tmp;
  }
  tmp = (float8)((float)0);
