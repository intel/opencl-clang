...
__kernel void sample_test(__global float2 *secondSource,
  ...
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(0, 1, 0, 0, 2, 3, 1, 3, 0, 0, 1, 3, 0, 1, 2, 3);
  ...
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(3, 2, 1, 0, 2, 2, 1, 3, 3, 2, 0, 2, 3, 1, 1, 3);
    tmp = shuffle2(src1, src2, mask);
    dest[1] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(3, 2, 0, 3, 0, 1, 0, 0, 3, 1, 1, 0, 1, 2, 1, 0);
    tmp = shuffle2(src1, src2, mask);
    dest[2] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(0, 3, 3, 1, 1, 3, 1, 3, 0, 3, 0, 2, 0, 1, 2, 3);
    tmp = shuffle2(src1, src2, mask);
    dest[3] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(1, 2, 0, 3, 3, 0, 3, 3, 2, 1, 2, 1, 0, 1, 2, 0);
    tmp = shuffle2(src1, src2, mask);
    dest[4] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(2, 0, 0, 1, 1, 0, 3, 0, 0, 2, 2, 1, 3, 2, 3, 2);
    tmp = shuffle2(src1, src2, mask);
    dest[5] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(2, 0, 1, 3, 0, 0, 1, 2, 1, 3, 3, 1, 1, 0, 0, 3);
    tmp = shuffle2(src1, src2, mask);
    dest[6] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(2, 2, 3, 2, 0, 0, 1, 2, 1, 2, 3, 0, 3, 0, 3, 3);
    tmp = shuffle2(src1, src2, mask);
    dest[7] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(0, 3, 0, 0, 3, 1, 3, 3, 0, 0, 1, 1, 3, 2, 0, 3);
    tmp = shuffle2(src1, src2, mask);
    dest[8] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(2, 3, 3, 2, 3, 2, 3, 1, 3, 2, 2, 1, 0, 1, 2, 2);
    tmp = shuffle2(src1, src2, mask);
    dest[9] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(3, 2, 3, 1, 3, 0, 0, 2, 2, 0, 0, 3, 1, 3, 0, 3);
    tmp = shuffle2(src1, src2, mask);
    dest[10] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(3, 3, 2, 3, 0, 3, 2, 0, 2, 0, 3, 3, 3, 3, 0, 0);
    tmp = shuffle2(src1, src2, mask);
    dest[11] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(0, 3, 2, 2, 1, 2, 0, 2, 1, 2, 1, 3, 1, 2, 3, 2);
    tmp = shuffle2(src1, src2, mask);
    dest[12] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(1, 1, 3, 0, 1, 2, 2, 1, 2, 2, 2, 3, 3, 1, 0, 1);
    tmp = shuffle2(src1, src2, mask);
    dest[13] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(3, 1, 0, 3, 2, 1, 0, 3, 3, 1, 3, 0, 1, 1, 1, 1);
    tmp = shuffle2(src1, src2, mask);
    dest[14] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(1, 2, 2, 0, 0, 0, 2, 3, 1, 1, 0, 3, 1, 2, 1, 0);
    tmp = shuffle2(src1, src2, mask);
    dest[15] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(3, 0, 2, 3, 2, 1, 3, 0, 1, 2, 2, 0, 3, 1, 0, 3);
    tmp = shuffle2(src1, src2, mask);
    dest[16] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(2, 0, 0, 2, 1, 1, 1, 0, 3, 2, 3, 3, 1, 1, 3, 0);
    tmp = shuffle2(src1, src2, mask);
    dest[17] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(2, 0, 3, 0, 1, 0, 0, 0, 2, 0, 2, 0, 0, 2, 3, 0);
    tmp = shuffle2(src1, src2, mask);
    dest[18] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(2, 1, 1, 0, 2, 0, 3, 0, 0, 1, 0, 0, 0, 2, 0, 3);
    tmp = shuffle2(src1, src2, mask);
    dest[19] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(3, 1, 3, 3, 0, 2, 1, 2, 1, 3, 3, 3, 1, 1, 1, 2);
    tmp = shuffle2(src1, src2, mask);
    dest[20] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(2, 3, 0, 2, 3, 0, 0, 1, 1, 3, 0, 0, 2, 1, 1, 2);
    tmp = shuffle2(src1, src2, mask);
    dest[21] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(3, 2, 3, 0, 0, 3, 0, 3, 3, 1, 3, 2, 0, 1, 2, 2);
    tmp = shuffle2(src1, src2, mask);
    dest[22] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(1, 3, 0, 3, 1, 1, 0, 1, 3, 3, 3, 0, 3, 1, 1, 0);
    tmp = shuffle2(src1, src2, mask);
    dest[23] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(0, 3, 1, 0, 2, 3, 1, 0, 3, 3, 2, 0, 1, 3, 0, 3);
    tmp = shuffle2(src1, src2, mask);
    dest[24] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(0, 2, 1, 1, 0, 1, 1, 0, 2, 1, 1, 3, 3, 1, 0, 0);
    tmp = shuffle2(src1, src2, mask);
    dest[25] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(3, 1, 2, 0, 1, 1, 1, 2, 2, 0, 0, 0, 2, 2, 2, 2);
    tmp = shuffle2(src1, src2, mask);
    dest[26] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(2, 2, 2, 2, 1, 0, 0, 2, 1, 2, 1, 3, 0, 1, 3, 2);
    tmp = shuffle2(src1, src2, mask);
    dest[27] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(2, 3, 0, 0, 3, 3, 2, 1, 0, 2, 1, 3, 1, 3, 2, 2);
    tmp = shuffle2(src1, src2, mask);
    dest[28] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(1, 1, 1, 0, 1, 0, 0, 3, 2, 0, 2, 0, 2, 3, 2, 2);
    tmp = shuffle2(src1, src2, mask);
    dest[29] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(3, 0, 0, 0, 0, 1, 0, 0, 3, 0, 3, 3, 2, 1, 1, 1);
    tmp = shuffle2(src1, src2, mask);
    dest[30] = tmp;
  }
  tmp = (float16)((float)0);
  {
    ...
    uint16 mask = (uint16)(1, 1, 2, 0, 3, 3, 3, 2, 2, 3, 3, 3, 2, 1, 1, 3);
    tmp = shuffle2(src1, src2, mask);
    dest[31] = tmp;
  }
}
