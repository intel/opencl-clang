...
__kernel void sample_test(__global float4 *secondSource,
  ...
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(2, 6, 2, 5, 3, 6, 3, 4);
  ...
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(4, 5, 1, 5, 4, 2, 1, 1);
    tmp = shuffle2(src1, src2, mask);
    dest[1] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(5, 6, 3, 6, 5, 6, 4, 5);
    tmp = shuffle2(src1, src2, mask);
    dest[2] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(1, 0, 0, 3, 1, 4, 2, 3);
    tmp = shuffle2(src1, src2, mask);
    dest[3] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(3, 1, 6, 5, 3, 6, 1, 5);
    tmp = shuffle2(src1, src2, mask);
    dest[4] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(0, 1, 2, 1, 2, 3, 1, 5);
    tmp = shuffle2(src1, src2, mask);
    dest[5] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(7, 4, 6, 4, 2, 0, 3, 1);
    tmp = shuffle2(src1, src2, mask);
    dest[6] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(3, 3, 0, 0, 4, 7, 5, 2);
    tmp = shuffle2(src1, src2, mask);
    dest[7] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(0, 1, 3, 4, 6, 2, 3, 0);
    tmp = shuffle2(src1, src2, mask);
    dest[8] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(6, 3, 4, 6, 7, 3, 0, 4);
    tmp = shuffle2(src1, src2, mask);
    dest[9] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(1, 3, 5, 1, 1, 2, 7, 6);
    tmp = shuffle2(src1, src2, mask);
    dest[10] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(1, 5, 3, 4, 3, 7, 5, 5);
    tmp = shuffle2(src1, src2, mask);
    dest[11] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(4, 2, 5, 6, 4, 5, 4, 2);
    tmp = shuffle2(src1, src2, mask);
    dest[12] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(0, 7, 5, 0, 3, 2, 2, 6);
    tmp = shuffle2(src1, src2, mask);
    dest[13] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(0, 7, 2, 3, 5, 2, 5, 6);
    tmp = shuffle2(src1, src2, mask);
    dest[14] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(0, 5, 1, 2, 6, 6, 1, 7);
    tmp = shuffle2(src1, src2, mask);
    dest[15] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(5, 3, 4, 2, 2, 3, 7, 5);
    tmp = shuffle2(src1, src2, mask);
    dest[16] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(4, 5, 6, 4, 5, 6, 0, 0);
    tmp = shuffle2(src1, src2, mask);
    dest[17] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(3, 2, 2, 0, 3, 4, 2, 1);
    tmp = shuffle2(src1, src2, mask);
    dest[18] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(1, 7, 1, 7, 4, 7, 6, 5);
    tmp = shuffle2(src1, src2, mask);
    dest[19] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(0, 4, 1, 2, 4, 2, 5, 3);
    tmp = shuffle2(src1, src2, mask);
    dest[20] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(1, 0, 1, 6, 2, 4, 1, 4);
    tmp = shuffle2(src1, src2, mask);
    dest[21] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(2, 7, 3, 6, 2, 3, 7, 7);
    tmp = shuffle2(src1, src2, mask);
    dest[22] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(2, 0, 2, 7, 6, 3, 5, 7);
    tmp = shuffle2(src1, src2, mask);
    dest[23] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(0, 0, 1, 1, 3, 3, 5, 1);
    tmp = shuffle2(src1, src2, mask);
    dest[24] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(7, 1, 2, 2, 3, 4, 3, 1);
    tmp = shuffle2(src1, src2, mask);
    dest[25] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(2, 5, 2, 7, 2, 6, 5, 1);
    tmp = shuffle2(src1, src2, mask);
    dest[26] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(6, 3, 6, 6, 5, 7, 3, 0);
    tmp = shuffle2(src1, src2, mask);
    dest[27] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(0, 7, 6, 0, 3, 5, 4, 7);
    tmp = shuffle2(src1, src2, mask);
    dest[28] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(3, 1, 6, 0, 6, 2, 2, 7);
    tmp = shuffle2(src1, src2, mask);
    dest[29] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(7, 4, 7, 2, 2, 7, 1, 3);
    tmp = shuffle2(src1, src2, mask);
    dest[30] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(6, 7, 5, 0, 6, 6, 3, 4);
    tmp = shuffle2(src1, src2, mask);
    dest[31] = tmp;
  }
}
