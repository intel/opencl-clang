...
__kernel void sample_test(__global float8 *secondSource,
  ...
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(3, 0, 4, 0, 9, 0, 8, 11);
  ...
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(2, 13, 7, 14, 5, 15, 15, 0);
    tmp = shuffle2(src1, src2, mask);
    dest[1] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(4, 0, 10, 8, 15, 11, 5, 14);
    tmp = shuffle2(src1, src2, mask);
    dest[2] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(3, 7, 9, 12, 12, 3, 10, 11);
    tmp = shuffle2(src1, src2, mask);
    dest[3] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(3, 13, 7, 10, 13, 6, 2, 1);
    tmp = shuffle2(src1, src2, mask);
    dest[4] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(14, 11, 15, 7, 6, 7, 11, 11);
    tmp = shuffle2(src1, src2, mask);
    dest[5] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(0, 5, 10, 4, 10, 5, 0, 7);
    tmp = shuffle2(src1, src2, mask);
    dest[6] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(9, 1, 0, 4, 6, 2, 3, 12);
    tmp = shuffle2(src1, src2, mask);
    dest[7] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(11, 5, 0, 0, 10, 7, 5, 13);
    tmp = shuffle2(src1, src2, mask);
    dest[8] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(1, 6, 10, 14, 11, 13, 15, 0);
    tmp = shuffle2(src1, src2, mask);
    dest[9] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(14, 9, 3, 12, 13, 12, 5, 13);
    tmp = shuffle2(src1, src2, mask);
    dest[10] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(12, 4, 1, 6, 2, 2, 9, 3);
    tmp = shuffle2(src1, src2, mask);
    dest[11] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(10, 3, 8, 11, 11, 0, 1, 3);
    tmp = shuffle2(src1, src2, mask);
    dest[12] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(2, 4, 4, 8, 5, 7, 9, 11);
    tmp = shuffle2(src1, src2, mask);
    dest[13] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(10, 12, 5, 11, 7, 13, 1, 3);
    tmp = shuffle2(src1, src2, mask);
    dest[14] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(12, 11, 7, 14, 9, 7, 5, 8);
    tmp = shuffle2(src1, src2, mask);
    dest[15] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(4, 8, 5, 9, 14, 4, 1, 14);
    tmp = shuffle2(src1, src2, mask);
    dest[16] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(0, 0, 8, 5, 7, 3, 8, 11);
    tmp = shuffle2(src1, src2, mask);
    dest[17] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(2, 6, 9, 0, 10, 4, 12, 4);
    tmp = shuffle2(src1, src2, mask);
    dest[18] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(9, 7, 10, 5, 4, 15, 2, 3);
    tmp = shuffle2(src1, src2, mask);
    dest[19] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(7, 1, 13, 11, 9, 11, 7, 2);
    tmp = shuffle2(src1, src2, mask);
    dest[20] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(6, 14, 12, 11, 10, 15, 14, 15);
    tmp = shuffle2(src1, src2, mask);
    dest[21] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(11, 15, 9, 10, 14, 7, 0, 2);
    tmp = shuffle2(src1, src2, mask);
    dest[22] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(10, 7, 0, 5, 5, 14, 4, 0);
    tmp = shuffle2(src1, src2, mask);
    dest[23] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(14, 7, 2, 14, 11, 7, 14, 1);
    tmp = shuffle2(src1, src2, mask);
    dest[24] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(3, 2, 2, 4, 8, 5, 6, 9);
    tmp = shuffle2(src1, src2, mask);
    dest[25] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(8, 4, 13, 14, 12, 10, 10, 7);
    tmp = shuffle2(src1, src2, mask);
    dest[26] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(2, 1, 0, 6, 5, 12, 1, 0);
    tmp = shuffle2(src1, src2, mask);
    dest[27] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(6, 13, 4, 6, 12, 15, 13, 13);
    tmp = shuffle2(src1, src2, mask);
    dest[28] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(15, 9, 15, 8, 0, 0, 6, 5);
    tmp = shuffle2(src1, src2, mask);
    dest[29] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(15, 0, 5, 0, 7, 14, 12, 3);
    tmp = shuffle2(src1, src2, mask);
    dest[30] = tmp;
  }
  tmp = (float8)((float)0);
  {
    ...
    uint8 mask = (uint8)(11, 2, 13, 1, 4, 6, 0, 7);
    tmp = shuffle2(src1, src2, mask);
    dest[31] = tmp;
  }
}
