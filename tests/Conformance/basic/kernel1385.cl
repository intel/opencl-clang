...
__kernel void test_fn(const __global ushort16 *src, __global ushort16 *dst,
  ...
  for (i = 0; i < copiesPerWorkItem; i++)
    localBuffer[get_local_id(0) * copiesPerWorkItem + i] = (ushort16)(ushort)0;
  ...
  event = async_work_group_copy(
      (__global ushort16 *)(dst + copiesPerWorkgroup * get_group_id(0)),
      (__local const ushort16 *)localBuffer, (size_t)copiesPerWorkgroup, 0);
