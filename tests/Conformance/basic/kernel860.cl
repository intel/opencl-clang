...
__kernel void test_fn(__global long2 *srcValues, __global uint *offsets,
                      __global long2 *destBuffer, uint alignmentOffset) {
  __private long2 sPrivateStorage[16];
  int tid = get_global_id(0);
  sPrivateStorage[tid] = (long2)(long)0;
