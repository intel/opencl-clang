...
__kernel void test_fn(__local int2 *sSharedStorage, __global int2 *srcValues,
                      __global uint *offsets, __global int2 *destBuffer,
                      uint alignmentOffset) {
  int tid = get_global_id(0);
  sSharedStorage[offsets[tid]] = (int2)(int)0;
