...
__kernel void test_fn(__local int4 *sSharedStorage, __global int4 *srcValues,
                      __global uint *offsets, __global int4 *destBuffer,
                      uint alignmentOffset) {
  int tid = get_global_id(0);
  sSharedStorage[offsets[tid]] = (int4)(int)0;
