...
__kernel void test_fn(const __global short16 *src, __global short16 *dst,
  ...
  for (i = 0; i < copiesPerWorkItem; i++)
    localBuffer[get_local_id(0) * copiesPerWorkItem + i] = (short16)(short)0;
  ...
  event = async_work_group_strided_copy(
      (__global short16 *)(dst + copiesPerWorkgroup * stride * get_group_id(0)),
      (__local const short16 *)localBuffer, (size_t)copiesPerWorkgroup,
      (size_t)stride, 0);
