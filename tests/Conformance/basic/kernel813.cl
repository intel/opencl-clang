...
__kernel void test_fn(__local long8 *sSharedStorage, __global long8 *srcValues,
                      __global uint *offsets, __global long8 *destBuffer,
                      uint alignmentOffset) {
  int tid = get_global_id(0);
  sSharedStorage[offsets[tid]] = (long8)(long)0;
