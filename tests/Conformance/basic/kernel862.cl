...
__kernel void test_fn(__global long4 *srcValues, __global uint *offsets,
                      __global long4 *destBuffer, uint alignmentOffset) {
  __private long4 sPrivateStorage[8];
  int tid = get_global_id(0);
  sPrivateStorage[tid] = (long4)(long)0;
