...
__kernel void test_fn(const __global long16 *src, __global long16 *dst,
  ...
  for (i = 0; i < copiesPerWorkItem; i++)
    localBuffer[get_local_id(0) * copiesPerWorkItem + i] = (long16)(long)0;
  ...
  event = async_work_group_strided_copy(
      (__global long16 *)(dst + copiesPerWorkgroup * stride * get_group_id(0)),
      (__local const long16 *)localBuffer, (size_t)copiesPerWorkgroup,
      (size_t)stride, 0);
