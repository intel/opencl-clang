...
__kernel void test_fn(__local uint8 *sSharedStorage, __global uint8 *srcValues,
                      __global uint *offsets, __global uint8 *destBuffer,
                      uint alignmentOffset) {
  int tid = get_global_id(0);
  sSharedStorage[offsets[tid]] = (uint8)(uint)0;
