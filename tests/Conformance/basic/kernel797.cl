...
__kernel void test_fn(__local ushort4 *sSharedStorage,
                      __global ushort4 *srcValues, __global uint *offsets,
                      __global ushort4 *destBuffer, uint alignmentOffset) {
  int tid = get_global_id(0);
  sSharedStorage[offsets[tid]] = (ushort4)(ushort)0;
