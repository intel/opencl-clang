...
__kernel void test_fn(__local long16 *sSharedStorage,
                      __global long16 *srcValues, __global uint *offsets,
                      __global long16 *destBuffer, uint alignmentOffset) {
  int tid = get_global_id(0);
  sSharedStorage[offsets[tid]] = (long16)(long)0;
