...
__kernel void test_fn(__local int8 *sSharedStorage, __global int8 *srcValues,
                      __global uint *offsets, __global int8 *destBuffer,
                      uint alignmentOffset) {
  int tid = get_global_id(0);
  sSharedStorage[offsets[tid]] = (int8)(int)0;
