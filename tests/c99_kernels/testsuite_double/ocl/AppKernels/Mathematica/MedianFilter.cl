...
//*****************************************************************************
__kernel void ckMedian(__global uchar4* uc4Source, __global unsigned mint* uiDest,
                       __local uchar4* uc4LocalData, mint iLocalPixPitch,
                       unsigned mint uiImageWidth, unsigned mint uiDevImageHeight
                       )
{
    ...
    if (get_local_id(0) == (get_local_size(0) - 1))
    {
        ...
        if ((iDevYPrime >= 0) && (iDevYPrime < uiDevImageHeight) && (get_group_id(0) > 0))
        {
            ...
            uc4LocalData[iLocalPixOffset] = uc4Source[mul24(iDevYPrime, (int)get_global_size(0)) + mul24((uint)get_group_id(0), (uint)get_local_size(0)) - 1];
        }
        else
        {
            uc4LocalData[iLocalPixOffset] = (uchar4)0;
        ...
        if (get_local_id(1) < 2)
        {
            ...
            if (((iDevYPrime + get_local_size(1)) < uiDevImageHeight) && (get_group_id(0) > 0))
            {
                ...
                uc4LocalData[iLocalPixOffset] = uc4Source[mul24((iDevYPrime + (int)get_local_size(1)), (int)get_global_size(0)) + mul24((uint)get_group_id(0), (uint)get_local_size(0)) - 1];
            }
            else
            {
                uc4LocalData[iLocalPixOffset] = (uchar4)0;
    ...
    else if (get_local_id(0) == 0) // Work items with x ID at left workgroup edge will read right apron pixel
    {
        ...
        if ((iDevYPrime >= 0) && (iDevYPrime < uiDevImageHeight) && (mul24(((int)get_group_id(0) + 1), (int)get_local_size(0)) < uiImageWidth))
        {
            ...
            uc4LocalData[iLocalPixOffset] = uc4Source[mul24(iDevYPrime, (int)get_global_size(0)) + mul24(((uint)get_group_id(0) + 1), (uint)get_local_size(0))];
        }
        else
        {
            uc4LocalData[iLocalPixOffset] = (uchar4)0;
        ...
        if (get_local_id(1) < 2)
        {
            ...
            if (((iDevYPrime + get_local_size(1)) < uiDevImageHeight) && (mul24(((uint)get_group_id(0) + 1), (uint)get_local_size(0)) < uiImageWidth) )
            {
                ...
                uc4LocalData[iLocalPixOffset] = uc4Source[mul24((iDevYPrime + (int)get_local_size(1)), (int)get_global_size(0)) + mul24(((uint)get_group_id(0) + 1), (uint)get_local_size(0))];
            }
            else
            {
                uc4LocalData[iLocalPixOffset] = (uchar4)0;
