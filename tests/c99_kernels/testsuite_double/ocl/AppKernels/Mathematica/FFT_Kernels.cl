...
__attribute__((always_inline)) void
kfft_pass2(unsigned mint me, __local float *lds)
{
    __local float *lp;
...
__attribute__((always_inline)) void
kfft_pass3(unsigned mint me, __local float *lds)
{
    __local float *lp;
...
__attribute__((always_inline)) void
kfft_pass4(unsigned mint me, __local float *lds)
{
    __local float *lp;
