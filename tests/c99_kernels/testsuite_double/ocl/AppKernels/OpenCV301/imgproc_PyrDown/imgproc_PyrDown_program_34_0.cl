...
// buildOptions=-D T=short4 -D FT=float4 -D convertToT=convert_short4_sat_rte -D convertToFT=convert_float4 -D T1=short -D cn=4 -D kercn=1 -D fdepth=5 -D BORDER_REPLICATE -D LOCAL_SIZE=256 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D T=short4 -D FT=float4 -D convertToT=convert_short4_sat_rte -D convertToFT=convert_float4 -D T1=short -D cn=4 -D kercn=1 -D fdepth=5 -D BORDER_REPLICATE -D LOCAL_SIZE=256 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
