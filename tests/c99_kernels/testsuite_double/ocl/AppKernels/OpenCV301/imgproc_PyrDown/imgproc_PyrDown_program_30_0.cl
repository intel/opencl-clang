...
// buildOptions=-D T=short2 -D FT=float2 -D convertToT=convert_short2_sat_rte -D convertToFT=convert_float2 -D T1=short -D cn=2 -D kercn=1 -D fdepth=5 -D BORDER_REFLECT_101 -D LOCAL_SIZE=256 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D T=short2 -D FT=float2 -D convertToT=convert_short2_sat_rte -D convertToFT=convert_float2 -D T1=short -D cn=2 -D kercn=1 -D fdepth=5 -D BORDER_REFLECT_101 -D LOCAL_SIZE=256 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
