...
// buildOptions=-D T=ushort3 -D FT=float3 -D convertToT=convert_ushort3_sat_rte -D convertToFT=convert_float3 -D T1=ushort -D cn=3 -D kercn=1 -D fdepth=5 -D BORDER_REFLECT -D LOCAL_SIZE=256 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D T=ushort3 -D FT=float3 -D convertToT=convert_ushort3_sat_rte -D convertToFT=convert_float3 -D T1=ushort -D cn=3 -D kercn=1 -D fdepth=5 -D BORDER_REFLECT -D LOCAL_SIZE=256 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
