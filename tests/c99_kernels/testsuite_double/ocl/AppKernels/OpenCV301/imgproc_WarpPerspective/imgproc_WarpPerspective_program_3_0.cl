...
// buildOptions=-D INTER_CUBIC -D T=uchar -D T1=uchar -D ST=int -D WT=int -D depth=0 -D convertToWT=convert_int -D convertToT=convert_uchar_sat -D cn=1 -D rowsPerWI=1 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D INTER_CUBIC -D T=uchar -D T1=uchar -D ST=int -D WT=int -D depth=0 -D convertToWT=convert_int -D convertToT=convert_uchar_sat -D cn=1 -D rowsPerWI=1 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
