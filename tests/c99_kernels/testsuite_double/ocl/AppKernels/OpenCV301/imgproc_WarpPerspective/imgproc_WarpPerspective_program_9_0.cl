...
// buildOptions=-D INTER_CUBIC -D T=uchar4 -D T1=uchar -D ST=int4 -D WT=int4 -D depth=0 -D convertToWT=convert_int4 -D convertToT=convert_uchar4_sat -D cn=4 -D rowsPerWI=1 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D INTER_CUBIC -D T=uchar4 -D T1=uchar -D ST=int4 -D WT=int4 -D depth=0 -D convertToWT=convert_int4 -D convertToT=convert_uchar4_sat -D cn=4 -D rowsPerWI=1 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
