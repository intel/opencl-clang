...
// buildOptions= -D INTEL_DEVICE -D DEPTH_0 -D REPEAT_S0 -D REPEAT_E0
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D DEPTH_0 -D REPEAT_S0 -D REPEAT_E0" %cfg_path --cl-device=%cl_device 2>&1
