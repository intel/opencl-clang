...
// buildOptions= -D INTEL_DEVICE -D LOCAL_SIZE=256 -D BLOCK_SIZE_Y=1 -D DATA_DEPTH=0 -D DATA_CHAN=4 -D USE_DOUBLE=0 -D ANCHOR_X=1 -D ANCHOR_Y=1 -D KERNEL_SIZE_X=3 -D KERNEL_SIZE_Y=3 -D KERNEL_SIZE_Y2_ALIGNED=8 -D BORDER_REFLECT_101 -D NO_EXTRA_EXTRAPOLATION -D NO_BORDER_ISOLATED
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D LOCAL_SIZE=256 -D BLOCK_SIZE_Y=1 -D DATA_DEPTH=0 -D DATA_CHAN=4 -D USE_DOUBLE=0 -D ANCHOR_X=1 -D ANCHOR_Y=1 -D KERNEL_SIZE_X=3 -D KERNEL_SIZE_Y=3 -D KERNEL_SIZE_Y2_ALIGNED=8 -D BORDER_REFLECT_101 -D NO_EXTRA_EXTRAPOLATION -D NO_BORDER_ISOLATED" %cfg_path --cl-device=%cl_device 2>&1
