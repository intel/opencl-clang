...
// buildOptions= -D INTEL_DEVICE -D anX=2 -D anY=2 -D ksX=5 -D ksY=5 -D BORDER_REFLECT
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D anX=2 -D anY=2 -D ksX=5 -D ksY=5 -D BORDER_REFLECT" %cfg_path --cl-device=%cl_device 2>&1
