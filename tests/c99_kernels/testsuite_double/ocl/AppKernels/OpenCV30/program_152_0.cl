...
// buildOptions= -D INTEL_DEVICE -D VEC_SIZE=4 -D DATA_DEPTH=0 -D DATA_CHAN=3 -D DST0_ALIGNED -D DST1_ALIGNED -D DST2_ALIGNED
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D VEC_SIZE=4 -D DATA_DEPTH=0 -D DATA_CHAN=3 -D DST0_ALIGNED -D DST1_ALIGNED -D DST2_ALIGNED" %cfg_path --cl-device=%cl_device 2>&1
