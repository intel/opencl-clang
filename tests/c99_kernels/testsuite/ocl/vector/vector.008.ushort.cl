...
void transpose( ushort4 m[4] ) {
    // read matrix into a ushort16 vector
    ushort16 x = (ushort16)( m[0], m[1], m[2], m[3] );
    ushort16 t;
    //transpose
    t.even = x.lo;
    t.odd = x.hi;
...
int main_function_ocl(int argc, ushort **argv, __global int *ocl_test_results) {
    ushort4 a = (ushort4)(1, 2, 3, 4);
	ushort4 b = (ushort4)(5, 6, 7, 8);
    ushort4 c = (ushort4)(9, 10, 11, 12);
	ushort4 d = (ushort4)(13, 14, 15, 16);
	ushort4 temp[4] = {a, b, c, d};
