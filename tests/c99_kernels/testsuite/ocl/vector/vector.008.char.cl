...
void transpose( char4 m[4] ) {
    // read matrix into a char16 vector
    char16 x = (char16)( m[0], m[1], m[2], m[3] );
    char16 t;
    //transpose
    t.even = x.lo;
    t.odd = x.hi;
...
int main_function_ocl(int argc, char **argv, __global int *ocl_test_results) {
    char4 a = (char4)(1, 2, 3, 4);
	char4 b = (char4)(5, 6, 7, 8);
    char4 c = (char4)(9, 10, 11, 12);
	char4 d = (char4)(13, 14, 15, 16);
	char4 temp[4] = {a, b, c, d};
