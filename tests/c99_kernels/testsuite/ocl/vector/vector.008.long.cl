...
void transpose( long4 m[4] ) {
    // read matrix into a long16 vector
    long16 x = (long16)( m[0], m[1], m[2], m[3] );
    long16 t;
    //transpose
    t.even = x.lo;
    t.odd = x.hi;
...
int main_function_ocl(int argc, long **argv, __global int *ocl_test_results) {
    long4 a = (long4)(1, 2, 3, 4);
	long4 b = (long4)(5, 6, 7, 8);
    long4 c = (long4)(9, 10, 11, 12);
	long4 d = (long4)(13, 14, 15, 16);
	long4 temp[4] = {a, b, c, d};
