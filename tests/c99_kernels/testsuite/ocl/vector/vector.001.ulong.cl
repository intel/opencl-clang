...
int main_function_ocl(int argc, ulong **argv, __global int *ocl_test_results) {
    ulong4 pos = (ulong4)(1, 2, 3, 4);
    ulong4 swiz= pos.wzyx; // swiz = (4, 3, 2, 1)
    ulong4 dup = pos.xxyy; // dup = (1, 1, 2, 2)

    ulong3 vf = (ulong3)(1, 2, 3);
    ulong2 low = vf.lo; // (1, 2);
    ulong2 high = vf.hi; // (3, undefined);
