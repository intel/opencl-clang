...
int main_function_ocl(int argc, short **argv, __global int *ocl_test_results) {
    short4 pos = (short4)(1, 2, 3, 4);
    short4 swiz= pos.wzyx; // swiz = (4, 3, 2, 1)
    short4 dup = pos.xxyy; // dup = (1, 1, 2, 2)

    short3 vf = (short3)(1, 2, 3);
    short2 low = vf.lo; // (1, 2);
    short2 high = vf.hi; // (3, undefined);
