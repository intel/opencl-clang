...
int main_function_ocl(int argc, char **argv, __global int *ocl_test_results) {
    char4 a;
    char4 f = (char4)(CHAR_MAX, 2, CHAR_MIN, 4);

    a.xyzw = f.s0123;
    if (!((a.s0 == CHAR_MAX) && (a.s1 == 2) && (a.s2 == CHAR_MIN) && (a.s3 == 4)))
        return -1;

    a.xyzw = f.s3021;
    if (!((a.s0 == 4) && (a.s1 == CHAR_MAX) && (a.s2 == CHAR_MIN) && (a.s3 == 2)))
        return -1;

    a.wyzx = f.s1231;
    if (!((a.s0 == 2) && (a.s1 == CHAR_MIN) && (a.s2 == 4) && (a.s3 == 2)))
        return -1;
