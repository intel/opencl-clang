...
int main_function_ocl(int argc, uchar **argv, __global int *ocl_test_results) {
    uchar4 pos = (uchar4)(1, 2, 3, 4);
    uchar4 swiz= pos.wzyx; // swiz = (4, 3, 2, 1)
    uchar4 dup = pos.xxyy; // dup = (1, 1, 2, 2)

    uchar3 vf = (uchar3)(1, 2, 3);
    uchar2 low = vf.lo; // (1, 2);
    uchar2 high = vf.hi; // (3, undefined);
