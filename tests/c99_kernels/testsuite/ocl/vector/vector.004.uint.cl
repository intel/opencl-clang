...
int main_function_ocl(int argc, uint **argv, __global int *ocl_test_results) {
    uint4 a;
    uint4 f = (uint4)(UINT_MAX, 2, UINT_MAX - 1, 4);

    a.xyzw = f.s0123;
    if (!((a.s0 == UINT_MAX) && (a.s1 == 2) && (a.s2 == UINT_MAX - 1) && (a.s3 == 4)))
        return -1;

    a.xyzw = f.s3021;
    if (!((a.s0 == 4) && (a.s1 == UINT_MAX) && (a.s2 == UINT_MAX - 1) && (a.s3 == 2)))
        return -1;

    a.wyzx = f.s1231;
    if (!((a.s0 == 2) && (a.s1 == UINT_MAX - 1) && (a.s2 == 4) && (a.s3 == 2)))
        return -1;
