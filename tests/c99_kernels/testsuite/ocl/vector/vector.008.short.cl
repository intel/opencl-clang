...
void transpose( short4 m[4] ) {
    // read matrix into a short16 vector
    short16 x = (short16)( m[0], m[1], m[2], m[3] );
    short16 t;
    //transpose
    t.even = x.lo;
    t.odd = x.hi;
...
int main_function_ocl(int argc, short **argv, __global int *ocl_test_results) {
    short4 a = (short4)(1, 2, 3, 4);
	short4 b = (short4)(5, 6, 7, 8);
    short4 c = (short4)(9, 10, 11, 12);
	short4 d = (short4)(13, 14, 15, 16);
	short4 temp[4] = {a, b, c, d};
