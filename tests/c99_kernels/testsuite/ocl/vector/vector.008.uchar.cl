...
void transpose( uchar4 m[4] ) {
    // read matrix into a uchar16 vector
    uchar16 x = (uchar16)( m[0], m[1], m[2], m[3] );
    uchar16 t;
    //transpose
    t.even = x.lo;
    t.odd = x.hi;
...
int main_function_ocl(int argc, uchar **argv, __global int *ocl_test_results) {
    uchar4 a = (uchar4)(1, 2, 3, 4);
	uchar4 b = (uchar4)(5, 6, 7, 8);
    uchar4 c = (uchar4)(9, 10, 11, 12);
	uchar4 d = (uchar4)(13, 14, 15, 16);
	uchar4 temp[4] = {a, b, c, d};
