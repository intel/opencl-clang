...
int main_function_ocl(int argc, long **argv, __global int *ocl_test_results) {
    long4 a;
    long4 f = (long4)(LONG_MAX, 2, LONG_MIN, 4);

    a.xyzw = f.s0123;
    if (!((a.s0 == LONG_MAX) && (a.s1 == 2) && (a.s2 == LONG_MIN) && (a.s3 == 4)))
        return -1;

    a.xyzw = f.s3021;
    if (!((a.s0 == 4) && (a.s1 == LONG_MAX) && (a.s2 == LONG_MIN) && (a.s3 == 2)))
        return -1;

    a.wyzx = f.s1231;
    if (!((a.s0 == 2) && (a.s1 == LONG_MIN) && (a.s2 == 4) && (a.s3 == 2)))
        return -1;
