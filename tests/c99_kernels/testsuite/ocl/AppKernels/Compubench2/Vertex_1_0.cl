...
//__kernel __attribute__((reqd_work_group_size(8,8,1)))
__kernel
void intersectScene_KDTreeEX(const float alphaMask, __global const float* restrict rayweights, __global const CLRay* restrict rays,
