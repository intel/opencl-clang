...
// buildOptions=-D USE_IMAGE_STORAGE -D QBVH_STACK_SIZE=24
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D USE_IMAGE_STORAGE -D QBVH_STACK_SIZE=24" %cfg_path --cl-device=%cl_device 2>&1
