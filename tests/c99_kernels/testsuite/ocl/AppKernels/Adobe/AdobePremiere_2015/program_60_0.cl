...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_KERNEL ShaderKernel_fxMedianFilter7x7H(COMMON_PARAMS) { BEGIN_NORMAL TEMP r0, r1, r2, r3, r4, r5, r6, r7, r8; SUB (&r7, s(fragment_texcoord0, xxxy), co_xxxy(3, 2, 1, 0)); ADD (&r8, s(fragment_texcoord0, xxxy), co_xxxy(3, 2, 1, 0)); TEX (&r0, s(r7, xwxw), texture0_RECT); TEX (&r1, s(r7, ywyw), texture0_RECT); TEX (&r2, s(r7, zwzw), texture0_RECT); TEX (&r3, fragment_texcoord0, texture0_RECT); TEX (&r4, s(r8, zwzw), texture0_RECT); TEX (&r5, s(r8, ywyw), texture0_RECT); TEX (&r6, s(r8, xwxw), texture0_RECT); MIN (&r7, r0, r1); MAX (&r8, r0, r1); MIN (&r0, r2, r3); MAX (&r1, r2, r3); MIN (&r2, r4, r5); MAX (&r3, r4, r5); MIN (&r4, r8, r0); MAX (&r5, r8, r0); MIN (&r0, r1, r2); MAX (&r8, r1, r2); MIN (&r1, r3, r6); MAX (&r2, r3, r6); MIN (&r3, r7, r4); MAX (&r6, r7, r4); MIN (&r4, r5, r0); MAX (&r7, r5, r0); MIN (&r0, r8, r1); MAX (&r5, r8, r1); MIN (&r1, r6, r4); MAX (&r8, r6, r4); MIN (&r4, r7, r0); MAX (&r6, r7, r0); MIN (&r0, r5, r2); MAX (&r5, r3, r1); MIN (&r1, r8, r4); MAX (&r3, r8, r4); MIN (&r4, r6, r0); MAX (&r6, r5, r1); MIN (&r1, r3, r4); MAX (&result_color, r6, r1); END }
