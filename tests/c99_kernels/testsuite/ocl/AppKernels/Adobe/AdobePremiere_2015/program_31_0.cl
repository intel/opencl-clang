...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_CUDA_TEXTURE(float4, texture2_2D) GF_KERNEL ShaderKernel_Wheels(COMMON_PARAMS, GF_OPENCL_TEXTURE(texture2_2D)) { BEGIN_NORMAL TEMP r0, r1, r2, r3; TEX (&r0, fragment_texcoord0, texture0_RECT); CMPvvss (&r2, r0, -1, 1); ABS (&r1, r0); MOV_SAT_xyz (&r0, r1); SUB (&r3, r1, r0); POWs (r1.x, r0.x, 0.454545454545); POWs (r1.y, r0.y, 0.454545454545); POWs (r1.z, r0.z, 0.454545454545); MADvvss (&r1, r1, ONE_MINUS_TEXEL, HALF_TEXEL); MOVs (r1.w, 0.5); TEXs_2d_x (r0.x, s(r1, xwxw), texture2_2D); TEXs_2d_y (r0.y, s(r1, ywyw), texture2_2D); TEXs_2d_z (r0.z, s(r1, zwzw), texture2_2D); MAD (&r3, r3, r0, r0); MUL_xyz (&r0, r3, r2); MOV (&result_color, r0); END }
