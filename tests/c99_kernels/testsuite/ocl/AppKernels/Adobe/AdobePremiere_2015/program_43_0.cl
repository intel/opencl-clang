...
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_KERNEL ShaderKernel_IRIDASAutoColorMatch(COMMON_PARAMS, GF_PTR(int) paiBrVector) { BEGIN_NORMAL LOAD_PARAMS(6) PARAM (gainLow , program_local[0]) PARAM (gainMid , program_local[1]) PARAM (gainHigh , program_local[2]) PARAM (offsetLow , program_local[3]) PARAM (offsetMid , program_local[4]) PARAM (offsetHigh, program_local[5]) PARAMC RGBtoLMS_r0 = c3(0.3811, 0.5783, 0.0402); PARAMC RGBtoLMS_r1 = c3(0.1967, 0.7244, 0.0782); PARAMC RGBtoLMS_r2 = c3(0.0241, 0.1288, 0.8444); PARAMC LMStoRGB_r0 = c3(4.4679, -3.5873, 0.1193); PARAMC LMStoRGB_r1 = c3(-1.2186, 2.3809, -0.1624); PARAMC LMStoRGB_r2 = c3(0.0497, -0.2439, 1.2045); TEMP r0, r1, r2, r3, r4; TEX (&r0, fragment_texcoord0, texture0_RECT); MOV_SAT (&r4, r0); DP3svv (r1.x, r4, RGBtoLMS_r0); DP3svv (r1.y, r4, RGBtoLMS_r1); DP3svv (r1.z, r4, RGBtoLMS_r2); ADDvvs (&r1, r1, 1); LG2s (r1.x, r1.x); LG2s (r1.y, r1.y); LG2s (r1.z, r1.z); MULvvs (&r1, r1, 0.30102999566398); DP3svs (r2.x, r1, 1); DP3svv (r2.y, r1, c3(1, 1, -2)); SUBs (r2.z, r1.x, r1.y); MUL (&r4, r2, c3(0.5773502691896, 0.408248290463863, 0.7071067811865475)); if (bLMH) { DP3 (&r3, r0, c3(0.299, 0.587, 0.114)); MAD_SAT (&r2, r3, c3(-2, 0, 2), c3(1, 1, -1)); DP3svv_SAT (r2.y, r2, c3(-1, 1, -1)); MAD (&r1, r4, gainLow, offsetLow); MULvsv (&r3, r2.x, r1); MAD (&r1, r4, gainMid, offsetMid); MADvsvv (&r3, r2.y, r1, r3); MAD (&r1, r4, gainHigh, offsetHigh); MADvsvv (&r4, r2.z, r1, r3); } else { MAD (&r4, r4, gainLow, offsetLow); } MUL (&r2, r4, c3(0.5773502691896, 0.408248290463863, 0.7071067811865475)); DP3svs (r1.x, r2, 1); DP3svv (r1.y, r2, c3(1, 1, -1)); DP3svv (r1.z, r2, c3(1, -2, 0)); POWs (r1.x, 10, r1.x); POWs (r1.y, 10, r1.y); POWs (r1.z, 10, r1.z); SUBvvs (&r1, r1, 1); DP3svv_SAT (result_color.x, r1, LMStoRGB_r0); DP3svv_SAT (result_color.y, r1, LMStoRGB_r1); DP3svv_SAT (result_color.z, r1, LMStoRGB_r2); MOVs (result_color.w, r0.w); END }
