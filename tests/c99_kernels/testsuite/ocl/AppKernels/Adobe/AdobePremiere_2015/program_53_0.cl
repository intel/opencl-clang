...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_KERNEL ShaderKernel_fxTechnicolor2strip(COMMON_PARAMS) { BEGIN_NORMAL TEMP r0; TEX (&r0, fragment_texcoord0, texture0_RECT); DP3_yz (&r0, r0, c3(0, 0.8, 0.2)); MOV (&result_color, r0); END }
