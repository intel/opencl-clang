...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_KERNEL ShaderKernel_SecondaryPass1(COMMON_PARAMS) { BEGIN_NORMAL LOAD_PARAMS(1) PARAM (maxDiff3, program_local[0]) TEMP r0, r1, r2, r3, r4, r5, r6, r7, r8, r9; TEMP r15, r16, r17, r18, r25, r26, r27, r28, r29, r30, r31; ADD (&r15, s(fragment_texcoord0, xyxy), co_xyxy(-1, -1, 0, -1)); ADD (&r16, s(fragment_texcoord0, xyxy), co_xyxy(1, -1, -1, 0)); ADD (&r17, s(fragment_texcoord0, xyxy), co_xyxy(1, 0, -1, 1)); ADD (&r18, s(fragment_texcoord0, xyxy), co_xyxy(0, 1, 1, 1)); TEX (&r1, r15, texture0_RECT); TEX (&r2, s(r15, zwzw), texture0_RECT); TEX (&r3, r16, texture0_RECT); TEX (&r4, s(r16, zwzw), texture0_RECT); TEX (&r5, fragment_texcoord0, texture0_RECT); TEX (&r6, r17, texture0_RECT); ADD (&r31, r6, r4); TEX (&r7, s(r17, zwzw), texture0_RECT); ADD (&r30, r7, r3); TEX (&r8, r18, texture0_RECT); ADD (&r29, r8, r2); TEX (&r9, s(r18, zwzw), texture0_RECT); ADD (&r28, r9, r1); DP3svv (r27.x, r4, c3(0.9, 1, 0.8)); DP3svv (r27.y, r3, c3(0.9, 1, 0.8)); DP3svv (r27.z, r2, c3(0.9, 1, 0.8)); DP3svv (r27.w, r1, c3(0.9, 1, 0.8)); DP3 (&r26, r5, c3(0.9, 1, 0.8)); DP3svv (r25.x, r6, c3(0.9, 1, 0.8)); DP3svv (r25.y, r7, c3(0.9, 1, 0.8)); DP3svv (r25.z, r8, c3(0.9, 1, 0.8)); DP3svv (r25.w, r9, c3(0.9, 1, 0.8)); DP3svv (r0.x, r31, c3(0.0996666667, 0.1956666667, 0.038)); DP3svv (r0.y, r30, c3(0.0996666667, 0.1956666667, 0.038)); DP3svv (r0.z, r29, c3(0.0996666667, 0.1956666667, 0.038)); DP3svv (r0.w, r28, c3(0.0996666667, 0.1956666667, 0.038)); DP3 (&r1, r5, c3(0.0996666667, 0.1956666667, 0.038)); ADD_SAT (&r0, r0, r1); MIN (&r2, r25, r26); MIN (&r2, r2, r27); MAX (&r1, r25, r26); MAX (&r1, r1, r27); SUB (&r1, r1, r2); LRPvvss (&r0, r0, maxDiff3.y, maxDiff3.x); SLT (&r3, r1, r0); DP4svs (r1.x, r3, 1); MADs (r1.x, r1.x, 2, 1); RCPs (r1.x, r1.x); MADvsvv (&r2, r3.x, r31, r5); MADvsvv (&r2, r3.y, r30, r2); MADvsvv (&r2, r3.z, r29, r2); MADvsvv (&r2, r3.w, r28, r2); MULvvs (&result_color, r2, r1.x); END }
