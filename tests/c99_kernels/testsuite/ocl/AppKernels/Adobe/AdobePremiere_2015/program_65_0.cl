...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_KERNEL ShaderKernel_fxLegalizePAL(COMMON_PARAMS) { BEGIN_NORMAL LOAD_PARAMS(1) PARAM (clampScale, program_local[0]) PARAMC YCoeffs = c3(0.299, 0.587, 0.114); PARAMC UCoeffs = c3(-0.147, -0.289, 0.436); PARAMC VCoeffs = c3(0.615, -0.5151, -0.1); PARAMC YInvCoeffs = c3(1, 0.000039457, 1.139827967); PARAMC UInvCoeffs = c3(1, -0.39461016, -0.580500316); PARAMC VInvCoeffs = c3(1, 2.031999684, 0.000481376); TEMP r0, r1, r2, r3, r4, r5; TEX (&r0, fragment_texcoord0, texture0_RECT); MOV_SAT (&r5, r0); DP3svv (r2.x, r5, YCoeffs); DP3svv (r2.y, r5, UCoeffs); DP3svv (r2.z, r5, VCoeffs); MOVs (r2.w, 0); DP3svv (r3.x, s(r2, yzww), s(r2, yzww)); RSQs (r1.y, r3.x); MULs (r1.y, r3.x, r1.y); MOVs (r4.x, r1.y); MADvsvs_yz (&r4, r1.y, c3(0, 1, -1), r2.x); MAD (&r4, r4, c3(1.3264874579, 0.5701676863, -0.5701676863), c3(0, 0, 0.5701676863)); DPHsvv (r4.y, r4, clampScale); MADs (r4.y, -r4.y, r1.y, r1.y); MADvsvs_zw (&r1, r4.y, c4(0, 0, 1, -1), r2.x); MAXs (r1.w, r1.w, -0.214); MINs (r1.z, r1.z, 1.079); SUBs (r4.z, r1.z, r2.x); SUBs (r4.w, r2.x, r1.w); MINs (r4.x, r4.w, r4.z); MINs (r4.x, r4.x, 1.079); RCPs (r2.w, r1.y); MULs (r2.w, r2.w, r4.x); MULvsv_yz (&r2, r2.w, s(r2, yyzz)); DP3svv (r3.x, YInvCoeffs, r2); DP3svv (r3.y, UInvCoeffs, r2); DP3svv (r3.z, VInvCoeffs, r2); MAXvvs_xyz (&result_color, r3, 0); MOVs (result_color.w, r0.w); END }
