...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_KERNEL ShaderKernel_Linearize(COMMON_PARAMS) { BEGIN_NORMAL LOAD_PARAMS(1) PARAM (Gamma, program_local[0]) TEMP r0, r1, r2, r3; TEX (&r0, fragment_texcoord0, texture0_RECT); CMPvvss (&r2, r0, -1, 1); ABS (&r1, r0); MOV_SAT_xyz (&r0, r1); SUB (&r3, r1, r0); POWs (r0.x, r0.x, Gamma.x); POWs (r0.y, r0.y, Gamma.x); POWs (r0.z, r0.z, Gamma.x); MAD (&r3, r3, r0, r0); MUL_xyz (&r0, r3, r2); MOV (&result_color, r0); END }
