...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_KERNEL ShaderKernel_SecondaryPass3(COMMON_PARAMS) { BEGIN_NORMAL LOAD_PARAMS(2) PARAM (weights, program_local[0]) PARAM (invSum , program_local[1]) TEMP r0, r1, r2, r3, r4, r5, r6, r7, r8; ADD (&r1, s(fragment_texcoord0, xxxy), co_xxxy(1, -1, 2, 0)); ADD (&r2, s(fragment_texcoord0, xxxy), co_xxxy(-2, 3, -3, 0)); ADD (&r3, s(fragment_texcoord0, xxxy), co_xxxy(4, -4, 0, 0)); TEX (&r0, fragment_texcoord0, texture0_RECT); TEX (&r7, s(r1, xwxw), texture0_RECT); TEX (&r6, s(r1, zwzw), texture0_RECT); TEX (&r5, s(r2, ywyw), texture0_RECT); TEX (&r4, s(r3, xwxw), texture0_RECT); MOVs (r4.x, r7.w); MOVs (r4.y, r6.w); MOVs (r4.z, r5.w); MUL (&r4, r4, weights); TEX (&r5, s(r1, ywyw), texture0_RECT); TEX (&r6, s(r2, xwxw), texture0_RECT); TEX (&r7, s(r2, zwzw), texture0_RECT); TEX (&r8, s(r3, ywyw), texture0_RECT); MOVs (r8.x, r5.w); MOVs (r8.y, r6.w); MOVs (r8.z, r7.w); MAD (&r8, r8, weights, r4); DP4svs (r8.w, r8, 1); ADDs (r8.w, r8.w, r0.w); MULs (r0.w, r8.w, invSum.w); MOV (&result_color, r0); END }
