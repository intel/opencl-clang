...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_KERNEL ShaderKernel_BleachBypass(COMMON_PARAMS) { BEGIN_NORMAL LOAD_PARAMS(3) PARAM (saturation, program_local[0]) PARAM (gain , program_local[1]) PARAM (luminance , program_local[2]) TEMP r0, r1, r2; TEX (&r0, fragment_texcoord0, texture0_RECT); DP3 (&r1, r0, luminance); MUL (&r2, r0, r1); MUL (&r1, r1, r1); SUB (&r2, r2, r1); MAD (&r2, r2, saturation, r1); MUL_xyz (&result_color, r2, gain); MOVs (result_color.w, r0.w); END }
