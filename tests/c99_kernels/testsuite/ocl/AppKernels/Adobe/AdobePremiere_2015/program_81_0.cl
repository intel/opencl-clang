...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_KERNEL ShaderKernel_fxAntiAliasV(COMMON_PARAMS) { BEGIN_NORMAL PARAMC maxVertDiff = c1(0.35); PARAMC minHorizDiff = c1(0.065); TEMP r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, r18; ADD (&r10, s(fragment_texcoord0, xyxy), co_xyxy(-1, -1, -1, 0)); ADD (&r11, s(fragment_texcoord0, xyxy), co_xyxy(-1, 1, 0, -1)); ADD (&r12, s(fragment_texcoord0, xyxy), co_xyxy(0, 1, 1, -1)); ADD (&r13, s(fragment_texcoord0, xyxy), co_xyxy(1, 0, 1, 1)); TEX (&r1, r10, texture0_RECT); TEX (&r2, s(r10, zwzw), texture0_RECT); TEX (&r3, r11, texture0_RECT); TEX (&r4, s(r11, zwzw), texture0_RECT); TEX (&r5, fragment_texcoord0, texture0_RECT); TEX (&r6, r12, texture0_RECT); TEX (&r7, s(r12, zwzw), texture0_RECT); TEX (&r8, r13, texture0_RECT); TEX (&r9, s(r13, zwzw), texture0_RECT); SUB (&r10, r1, r2); ABS (&r10, r10); SUB (&r11, r1, r3); ABS (&r11, r11); ADD (&r13, r11, r10); DP3svs (r3.x, r13, 1); SUB (&r10, r4, r5); ABS (&r10, r10); SUB (&r11, r4, r6); ABS (&r11, r11); ADD (&r14, r11, r10); DP3svs (r3.y, r14, 1); SUB (&r10, r7, r8); ABS (&r10, r10); SUB (&r11, r7, r9); ABS (&r11, r11); ADD (&r15, r11, r10); DP3svs (r3.z, r15, 1); ADD (&r15, r1, r2); ADD (&r15, r15, r3); ADD (&r16, r4, r5); ADD (&r16, r16, r6); ADD (&r17, r7, r8); ADD (&r17, r17, r9); SUB (&r18, r16, r15); ABS (&r18, r18); DP3svs (r18.x, r18, 0.3333333333); SUB (&r17, r16, r17); ABS (&r17, r17); DP3svs (r18.y, r17, 0.3333333333); SLT (&r1, r3, maxVertDiff); SGE (&r2, r18, minHorizDiff); MUL (&r1, s(r2, xyxy), r1); MULs (r1.x, r1.x, r1.y); MULvss_xyz (&result_color, r1.x, r1.z); END }
