...
#define bSplitToning paiBrVector[0]

#define bFade paiBrVector[1]

#define bVibrancePlus paiBrVector[2]

#define bVibranceMinus paiBrVector[3]

#define bSaturation paiBrVector[4]
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_CUDA_TEXTURE(float4, texture2_2D) GF_KERNEL ShaderKernel_PrColorLookAdjustments(COMMON_PARAMS, GF_OPENCL_TEXTURE(texture2_2D), GF_PTR(int) paiBrVector) { BEGIN_NORMAL LOAD_PARAMS(5) PARAM (Vibrance, program_local[0]) PARAM (Saturation, program_local[1]) PARAM (lumaCoeff, program_local[2]) TEMP r0, r1, r2, r3, r4, r5, r6, r7; TEX (&r0, fragment_texcoord0, texture0_RECT); CMPvvss (&r6, r0, -1, 1); MOV (&r1, r0); MOV_SAT_xyz (&r0, r1); SUB (&r7, r1, r0); if (bFade) { DP3 (&r1, r0, lumaCoeff); POWs (r1.x, r1.x, 0.454545454545); MAD (&r4, r1, c2(ONE_MINUS_TEXEL, 0), c2(HALF_TEXEL, 0.75)); TEX_2d (&r3, r4, texture2_2D); MADvsvs_xyz (&r0, r3.x, r0, r3.y); } if (bVibrancePlus | bVibranceMinus | bSaturation) { SUBvsv (&r1, 1, r0); MAD (&r1, r1, r7, r0); MAD (&r7, r7, r0, r0); CMP_xyz (&r0, r6, r1, r7); if (bVibrancePlus) { MINs (r1.x, r0.x, r0.y); MINs_SAT (r1.x, r1.x, r0.z); MAXs (r1.y, r0.x, r0.y); MAXs_SAT (r1.y, r1.y, r0.z); SUBs (r1.z, r1.y, r1.x); MAXs (r1.w, r1.z, 0.0000000001); RCPs (r3.x, r1.w); MOV_SAT (&r5, r0); SUB (&r4, s(r5, yzxx), s(r5, zxyx)); MULvsv (&r4, r3.x, r4); MADvvsv (&r4, r4, 0.1666666667, c4(0, 0.3333333333, 0.6666666667, 0)); SUBvvs (&r5, r0, r1.y); CMPs (r1.w, r5.x, r4.z, r4.x); CMPs (r1.w, r5.y, r1.w, r4.y); ADDs (r1.w, r1.w, 0.1666666667); FRCs (r1.w, r1.w); MULs (r1.w, r1.w, 6); MADs (r3.x, r1.w, -4, 7); MINs_SAT (r3.x, r3.x, r1.w); MAXs (r1.w, r1.y, 0.0000000001); RCPs (r3.y, r1.w); MULs (r3.y, r1.z, r3.y); MADs (r3.z, -r3.y, r3.y, 1); MULs (r3.x, r3.z, r3.x); MADs (r3.z, Vibrance.x, r3.x, -r3.x); MADs (r3.z, r3.z, Vibrance.x, Vibrance.x); MADs (r3.w, r3.x, -0.404761571, 0.833333333); MULs (r3.w, r3.w, r3.z); MADs (r3.w, -r1.x, r3.w, r3.w); MULs_SAT (r1.z, r1.y, 16); MADs (r1.w, -r3.y, r3.y, r3.y); SUBvsv (&r4, 2, r1); MUL_zw (&r1, r4, r1); MULvsv_zw (&r3, r1.z, r3); MULs (r3.z, r3.z, r1.w); MADs (r3.w, r3.w, -r3.y, r3.w); SUBs (r3.w, 1, r3.w); RCPs (r3.w, r3.w); MADs (r3.z, -r1.y, r3.z, r3.z); MADs (r3.z, r3.z, 0.25, 1); MULvsv_zw (&r1, r1.y, r3); SUBs (r1.w, r1.z, r1.w); MADvsvs_xyz (&r0, r3.w, r0, r1.w); } else if (bVibranceMinus) { MINs (r1.x, r0.x, r0.y); MINs_SAT (r1.x, r1.x, r0.z); MAXs (r1.y, r0.x, r0.y); MAXs_SAT (r1.y, r1.y, r0.z); SUBs (r1.z, r1.y, r1.x); MAXs (r1.w, r1.y, 0.0000000001); RCPs (r3.y, r1.w); MULs (r3.y, r1.z, r3.y); MULs_SAT (r1.z, r1.y, 16); MADs (r1.w, -r3.y, r3.y, r3.y); SUBvsv (&r4, 2, r1); MUL_zw (&r1, r4, r1); MOVs (r3.w, -Vibrance.x); MULs (r3.z, r3.w, r1.z); MULs (r3.z, r3.z, r1.w); MADs (r1.x, r3.y, 0.5, 0.5); MUL (&r4, s(r3, ywww), s(r1, xzzz)); MADs (r1.x, r4.x, r4.y, -r3.w); ADDs (r1.x, r1.x, 1); MADs (r4.x, -0.25, r3.w, 1); MULs (r3.w, r4.x, r1.x); MADs (r3.z, -r1.y, r3.z, r3.z); SUBs (r3.z, 1, r3.z); MULvsv_zw (&r1, r1.y, r3); SUBs (r1.w, r1.z, r1.w); MADvsvs_xyz (&r0, r3.w, r0, r1.w); } if (bSaturation) { DP3 (&r1, r0, lumaCoeff); SUB (&r2, r0, r1); MADvsvv_xyz (&r0, Saturation.x, r2, r1); } CMPvvss (&r6, r0, -1, 1); MOV (&r1, r0); MOV_SAT_xyz (&r0, r1); SUB (&r7, r1, r0); } if (bSplitToning) { POWs (r2.x, r0.x, 0.454545454545); POWs (r2.y, r0.y, 0.454545454545); POWs (r2.z, r0.z, 0.454545454545); MADvvss (&r2, r2, ONE_MINUS_TEXEL, HALF_TEXEL); MOVs (r2.w, 0.25); TEXs_2d_x (r0.x, s(r2, xwxw), texture2_2D); TEXs_2d_y (r0.y, s(r2, ywyw), texture2_2D); TEXs_2d_z (r0.z, s(r2, zwzw), texture2_2D); } SUBvsv (&r1, 1, r0); MAD (&r1, r1, r7, r0); MAD (&r7, r7, r0, r0); CMP_xyz (&r0, r6, r1, r7); MOV (&result_color, r0); END }
