...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_CUDA_TEXTURE(float4, texture1_RECT) GF_KERNEL ShaderKernel_fxBloomV(COMMON_PARAMS, GF_OPENCL_TEXTURE(texture1_RECT)) { BEGIN_MULTITEXTURE LOAD_PARAMS(11) PARAM (w1 , program_local[0]) PARAM (w2 , program_local[1]) PARAM (w3 , program_local[2]) PARAM (w4 , program_local[3]) PARAM (w5 , program_local[4]) PARAM (w6 , program_local[5]) PARAM (w7 , program_local[6]) PARAM (invSum, program_local[7]) PARAM (negThreshold, program_local[8]) PARAM (intensity , program_local[9]) PARAM (blend , program_local[10]) TEMP r0, r1, r2, r3, r4, r5, r6, r10; TEX (&r10, fragment_texcoord1, texture1_RECT); ADD (&r2, s(fragment_texcoord0, yyyx), co_yyyx(1, -1, 2, 0)); ADD (&r3, s(fragment_texcoord0, yyyx), co_yyyx(-2, 3, -3, 0)); ADD (&r4, s(fragment_texcoord0, yyyx), co_yyyx(4, -4, 5, 0)); ADD (&r5, s(fragment_texcoord0, yyyx), co_yyyx(-5, 6, -6, 0)); ADD (&r6, s(fragment_texcoord0, yyyx), co_yyyx(7, -7, 0, 0)); TEX (&r0, fragment_texcoord0, texture0_RECT); TEX (&r1, s(r2, wxwx), texture0_RECT); MAD (&r0, r1, w1, r0); TEX (&r1, s(r2, wywy), texture0_RECT); MAD (&r0, r1, w1, r0); TEX (&r1, s(r2, wzwz), texture0_RECT); MAD (&r0, r1, w2, r0); TEX (&r1, s(r3, wxwx), texture0_RECT); MAD (&r0, r1, w2, r0); TEX (&r1, s(r3, wywy), texture0_RECT); MAD (&r0, r1, w3, r0); TEX (&r1, s(r3, wzwz), texture0_RECT); MAD (&r0, r1, w3, r0); TEX (&r1, s(r4, wxwx), texture0_RECT); MAD (&r0, r1, w4, r0); TEX (&r1, s(r4, wywy), texture0_RECT); MAD (&r0, r1, w4, r0); TEX (&r1, s(r4, wzwz), texture0_RECT); MAD (&r0, r1, w5, r0); TEX (&r1, s(r5, wxwx), texture0_RECT); MAD (&r0, r1, w5, r0); TEX (&r1, s(r5, wywy), texture0_RECT); MAD (&r0, r1, w6, r0); TEX (&r1, s(r5, wzwz), texture0_RECT); MAD (&r0, r1, w6, r0); TEX (&r1, s(r6, wxwx), texture0_RECT); MAD (&r0, r1, w7, r0); TEX (&r1, s(r6, wywy), texture0_RECT); MAD (&r0, r1, w7, r0); MAD (&r0, r0, invSum, negThreshold); MAD (&r0, r0, intensity, r10); LRP (&result_color, blend, r0, r10); END }
