...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_KERNEL ShaderKernel_fxKuwaharaFilter5x5(COMMON_PARAMS) { BEGIN_NORMAL TEMP r0, r1, r2, r3, r4, r5, r6, r7, r8, r9; TEMP r10, r11, r12, r13, r14, r15, r16, r17, r18, r19; TEMP r20, r21, r22, r28, r29, r30, r31; ADD (&r11, s(fragment_texcoord0, xyxy), co_xyxy(2, -2, 0, -1)); ADD (&r12, s(fragment_texcoord0, xyxy), co_xyxy(-1, -1, -1, 0)); ADD (&r13, s(fragment_texcoord0, xyxy), co_xyxy(-1, 1, 0, 1)); ADD (&r14, s(fragment_texcoord0, xyxy), co_xyxy(1, 1, 1, 0)); ADD (&r15, s(fragment_texcoord0, xyxy), co_xyxy(1, -1, 1, -2)); ADD (&r16, s(fragment_texcoord0, xyxy), co_xyxy(0, -2, -1, -2)); ADD (&r17, s(fragment_texcoord0, xyxy), co_xyxy(-2, -2, -2, -1)); ADD (&r18, s(fragment_texcoord0, xyxy), co_xyxy(-2, 0, -2, 1)); ADD (&r19, s(fragment_texcoord0, xyxy), co_xyxy(-2, 2, -1, 2)); ADD (&r20, s(fragment_texcoord0, xyxy), co_xyxy(0, 2, 1, 2)); ADD (&r21, s(fragment_texcoord0, xyxy), co_xyxy(2, 2, 2, 1)); ADD (&r22, s(fragment_texcoord0, xyxy), co_xyxy(2, 0, 2, -1)); TEX (&r1, r17, texture0_RECT); TEX (&r2, s(r16, zwzw), texture0_RECT); ADD (&r10, r2, r1); TEX (&r3, r16, texture0_RECT); ADD (&r10, r3, r10); TEX (&r4, s(r17, zwzw), texture0_RECT); ADD (&r10, r4, r10); TEX (&r5, r12, texture0_RECT); ADD (&r10, r5, r10); TEX (&r6, s(r11, zwzw), texture0_RECT); ADD (&r10, r6, r10); TEX (&r7, r18, texture0_RECT); ADD (&r10, r7, r10); TEX (&r8, s(r12, zwzw), texture0_RECT); ADD (&r10, r8, r10); TEX (&r9, fragment_texcoord0, texture0_RECT); ADD (&r10, r9, r10); MULvvs (&r28, r10, 0.1111111111); SUB (&r0, r28, r1); MUL (&r10, r0, r0); SUB (&r0, r28, r2); MAD (&r10, r0, r0, r10); SUB (&r0, r28, r3); MAD (&r10, r0, r0, r10); SUB (&r0, r28, r4); MAD (&r10, r0, r0, r10); SUB (&r0, r28, r5); MAD (&r10, r0, r0, r10); SUB (&r0, r28, r6); MAD (&r10, r0, r0, r10); SUB (&r0, r28, r7); MAD (&r10, r0, r0, r10); SUB (&r0, r28, r8); MAD (&r10, r0, r0, r10); SUB (&r0, r28, r9); MAD (&r10, r0, r0, r10); DP3svs (r28.w, r10, 0.1111111111); TEX (&r1, r16, texture0_RECT); TEX (&r2, s(r15, zwzw), texture0_RECT); ADD (&r10, r2, r1); TEX (&r3, r11, texture0_RECT); ADD (&r10, r3, r10); TEX (&r4, s(r11, zwzw), texture0_RECT); ADD (&r10, r4, r10); TEX (&r5, r15, texture0_RECT); ADD (&r10, r5, r10); TEX (&r6, s(r22, zwzw), texture0_RECT); ADD (&r10, r6, r10); TEX (&r7, fragment_texcoord0, texture0_RECT); ADD (&r10, r7, r10); TEX (&r8, s(r14, zwzw), texture0_RECT); ADD (&r10, r8, r10); TEX (&r9, r22, texture0_RECT); ADD (&r10, r9, r10); MULvvs (&r29, r10, 0.1111111111); SUB (&r0, r29, r1); MUL (&r10, r0, r0); SUB (&r0, r29, r2); MAD (&r10, r0, r0, r10); SUB (&r0, r29, r3); MAD (&r10, r0, r0, r10); SUB (&r0, r29, r4); MAD (&r10, r0, r0, r10); SUB (&r0, r29, r5); MAD (&r10, r0, r0, r10); SUB (&r0, r29, r6); MAD (&r10, r0, r0, r10); SUB (&r0, r29, r7); MAD (&r10, r0, r0, r10); SUB (&r0, r29, r8); MAD (&r10, r0, r0, r10); SUB (&r0, r29, r9); MAD (&r10, r0, r0, r10); DP3svs (r29.w, r10, 0.1111111111); TEX (&r1, fragment_texcoord0, texture0_RECT); TEX (&r2, s(r14, zwzw), texture0_RECT); ADD (&r10, r2, r1); TEX (&r3, r22, texture0_RECT); ADD (&r10, r3, r10); TEX (&r4, s(r13, zwzw), texture0_RECT); ADD (&r10, r4, r10); TEX (&r5, r14, texture0_RECT); ADD (&r10, r5, r10); TEX (&r6, s(r21, zwzw), texture0_RECT); ADD (&r10, r6, r10); TEX (&r7, r20, texture0_RECT); ADD (&r10, r7, r10); TEX (&r8, s(r20, zwzw), texture0_RECT); ADD (&r10, r8, r10); TEX (&r9, r21, texture0_RECT); ADD (&r10, r9, r10); MULvvs (&r31, r10, 0.1111111111); SUB (&r0, r31, r1); MUL (&r10, r0, r0); SUB (&r0, r31, r2); MAD (&r10, r0, r0, r10); SUB (&r0, r31, r3); MAD (&r10, r0, r0, r10); SUB (&r0, r31, r4); MAD (&r10, r0, r0, r10); SUB (&r0, r31, r5); MAD (&r10, r0, r0, r10); SUB (&r0, r31, r6); MAD (&r10, r0, r0, r10); SUB (&r0, r31, r7); MAD (&r10, r0, r0, r10); SUB (&r0, r31, r8); MAD (&r10, r0, r0, r10); SUB (&r0, r31, r9); MAD (&r10, r0, r0, r10); DP3svs (r31.w, r10, 0.1111111111); TEX (&r1, r18, texture0_RECT); TEX (&r2, s(r12, zwzw), texture0_RECT); ADD (&r10, r2, r1); TEX (&r3, fragment_texcoord0, texture0_RECT); ADD (&r10, r3, r10); TEX (&r4, s(r18, zwzw), texture0_RECT); ADD (&r10, r4, r10); TEX (&r5, r13, texture0_RECT); ADD (&r10, r5, r10); TEX (&r6, s(r13, zwzw), texture0_RECT); ADD (&r10, r6, r10); TEX (&r7, r19, texture0_RECT); ADD (&r10, r7, r10); TEX (&r8, s(r19, zwzw), texture0_RECT); ADD (&r10, r8, r10); TEX (&r9, r20, texture0_RECT); ADD (&r10, r9, r10); MULvvs (&r30, r10, 0.1111111111); SUB (&r0, r30, r1); MUL (&r10, r0, r0); SUB (&r0, r30, r2); MAD (&r10, r0, r0, r10); SUB (&r0, r30, r3); MAD (&r10, r0, r0, r10); SUB (&r0, r30, r4); MAD (&r10, r0, r0, r10); SUB (&r0, r30, r5); MAD (&r10, r0, r0, r10); SUB (&r0, r30, r6); MAD (&r10, r0, r0, r10); SUB (&r0, r30, r7); MAD (&r10, r0, r0, r10); SUB (&r0, r30, r8); MAD (&r10, r0, r0, r10); SUB (&r0, r30, r9); MAD (&r10, r0, r0, r10); DP3svs (r30.w, r10, 0.1111111111); SLTs (r0.w, r28.w, r29.w); LRPvsvv (&r0, r0.w, r28, r29); SLTs (r2.w, r30.w, r31.w); LRPvsvv (&r2, r2.w, r30, r31); SLTs (r1.w, r2.w, r0.w); LRPvsvv_xyz (&result_color, r1.w, r2, r0); MOVs (result_color.w, r3.w); END }
