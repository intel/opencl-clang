...
#define bToneCurve paiBrVector[0]

#define bRGBCurves paiBrVector[1]
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_CUDA_TEXTURE(float4, texture2_2D) GF_KERNEL ShaderKernel_PrColorToneCurves(COMMON_PARAMS, GF_OPENCL_TEXTURE(texture2_2D), GF_PTR(int) paiBrVector) { BEGIN_NORMAL TEMP r0, r1, r2, r3, r4, r5, r6; TEX (&r0, fragment_texcoord0, texture0_RECT); CMPvvss (&r5, r0, -1, 1); MOV (&r1, r0); MOV_SAT_xyz (&r0, r1); SUB (&r6, r1, r0); if (bToneCurve) { MINs (r3.x, r0.x, r0.y); MINs (r3.x, r3.x, r0.z); MAXs (r3.y, r0.x, r0.y); MAXs (r3.y, r3.y, r0.z); POWs (r2.x, r0.x, 0.454545454545); POWs (r2.y, r0.y, 0.454545454545); POWs (r2.z, r0.z, 0.454545454545); MADvvss (&r2, r2, ONE_MINUS_TEXEL, HALF_TEXEL); MOVs (r2.w, 0.5); TEX_2d (&r4, s(r2, xwxw), texture2_2D); MOVs (r1.x, r4.w); TEX_2d (&r4, s(r2, ywyw), texture2_2D); MOVs (r1.y, r4.w); TEX_2d (&r4, s(r2, zwzw), texture2_2D); MOVs (r1.z, r4.w); MINs (r3.z, r1.x, r1.y); MINs (r3.z, r3.z, r1.z); MAXs (r3.w, r1.x, r1.y); MAXs (r3.w, r3.w, r1.z); SUB_xy (&r2, s(r3, ywww), s(r3, xzzz)); MAXs (r2.x, r2.x, 0.0000000001); RCPs (r2.x, r2.x); MULs (r2.x, r2.x, r2.y); SUBvvs_xyz (&r0, r0, r3.x); MADvsvs_xyz (&r0, r2.x, r0, r3.z); } if (bRGBCurves) { POWs (r2.x, r0.x, 0.454545454545); POWs (r2.y, r0.y, 0.454545454545); POWs (r2.z, r0.z, 0.454545454545); MADvvss (&r2, r2, ONE_MINUS_TEXEL, HALF_TEXEL); MOVs (r2.w, 0.5); TEXs_2d_x (r0.x, s(r2, xwxw), texture2_2D); TEXs_2d_y (r0.y, s(r2, ywyw), texture2_2D); TEXs_2d_z (r0.z, s(r2, zwzw), texture2_2D); } SUBvsv (&r1, 1, r0); MAD (&r1, r1, r6, r0); MAD (&r6, r6, r0, r0); CMP_xyz (&r0, r5, r1, r6); MOV (&result_color, r0); END }
