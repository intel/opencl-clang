...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_KERNEL ShaderKernel_fxMedianFilter5x5V(COMMON_PARAMS) { BEGIN_NORMAL TEMP r0, r1, r2, r3, r4, r5, r6; SUB (&r5, s(fragment_texcoord0, xyxy), co_xyxy(0, 1, 0, 2)); ADD (&r6, s(fragment_texcoord0, xyxy), co_xyxy(0, 1, 0, 2)); TEX (&r0, s(r5, zwzw), texture0_RECT); TEX (&r1, r5, texture0_RECT); TEX (&r2, fragment_texcoord0, texture0_RECT); TEX (&r3, r6, texture0_RECT); TEX (&r4, s(r6, zwzw), texture0_RECT); MIN (&r5, r0, r1); MAX (&r6, r0, r1); MIN (&r0, r2, r3); MAX (&r1, r2, r3); MIN (&r2, r6, r0); MAX (&r3, r6, r0); MIN (&r0, r1, r4); MAX (&r1, r1, r4); MAX (&r6, r5, r2); MIN (&r2, r3, r0); MAX (&r3, r3, r0); MAX (&r2, r6, r2); MIN (&r5, r3, r1); MIN (&result_color, r2, r5); END }
