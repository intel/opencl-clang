...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_KERNEL ShaderKernel_fxKeyer(COMMON_PARAMS) { BEGIN_NORMAL LOAD_PARAMS(4) PARAM (screenColor, program_local[0]) PARAM (scaleToOne , program_local[1]) PARAM (remap , program_local[2]) PARAM (showRange , program_local[3]) TEMP r0, r1, r2, r3; TEX (&r0, fragment_texcoord0, texture0_RECT); MOVs (r3.x, r0.w); MAXvsv (&r1, r0.x, s(r0, zyzy)); SUB_SAT (&r1, s(r0, yzyz), r1); CMPs (r0.w, screenColor.x, r1.x, r1.y); MULs_SAT (r0.w, r0.w, scaleToOne.x); LRPvsss (&r1, r0.w, 2000, 1000); MINvvs_SAT (&r2, r0, 0.9995); FLR (&r1, r1); ADD (&r1, r1, r2); CMPvsvv (&r1, -r0.w, r1, r0); MOVs (r1.w, r3.x); SUBs (r0.w, 1, r0.w); MULvvs (&r2, r0, r0.w); MOVs (r2.w, r3.x); LRP (&r0, showRange, r2, r0); LRP (&result_color, remap, r1, r0); END }
