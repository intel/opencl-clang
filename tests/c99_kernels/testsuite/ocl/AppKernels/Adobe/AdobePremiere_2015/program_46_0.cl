...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_KERNEL ShaderKernel_IRIDASGainOffset(COMMON_PARAMS) { BEGIN_NORMAL LOAD_PARAMS(2) PARAM (gain , program_local[0]) PARAM (offset, program_local[1]) TEMP r0; TEX (&r0, fragment_texcoord0, texture0_RECT); MAD_xyz (&result_color, r0, gain, offset); MOVs (result_color.w, r0.w); END }
