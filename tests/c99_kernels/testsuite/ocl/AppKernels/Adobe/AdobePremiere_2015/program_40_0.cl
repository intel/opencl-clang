...
#define bDesaturation paiBrVector[0]
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_KERNEL ShaderKernel_PrColorHighlightRecovery(COMMON_PARAMS, GF_PTR(int) paiBrVector) { BEGIN_NORMAL LOAD_PARAMS(2) PARAM (Gamma, program_local[0]) PARAM (lumaCoeff, program_local[1]) TEMP r0, r1, r2, r3, r4, r5; TEX (&r0, fragment_texcoord0, texture0_RECT); CMPvvss (&r4, r0, -1, 1); ABS (&r1, r0); MOV_SAT_xyz (&r0, r1); SUB (&r5, r1, r0); if (bDesaturation) { MAXs (r1.x, r0.x, r0.y); MAXs (r1.x, r1.x, r0.z); MINs (r1.z, r0.x, r0.y); MINs (r1.z, r1.z, r0.z); MOVs_SAT (r1.y, r1.x); MOVs_SAT (r1.w, r1.z); DP3_SAT (&r3, r0, lumaCoeff); SUB_zw (&r1, r3, r1); SUB_xy (&r1, r1, r3); MAXs (r1.x, r1.x, 0.0000000001); RCPs (r1.x, r1.x); MAXs (r1.x, r1.x, 0); MULs (r1.x, r1.x, r1.y); MAXs (r1.z, r1.z, 0.0000000001); RCPs (r1.z, r1.z); MAXs (r1.z, r1.z, 0); MULs (r1.z, r1.z, r1.w); MINs (r1.x, r1.z, r1.x); SUB (&r2, r0, r3); MADvvsv_xyz (&r0, r2, r1.x, r3); } else { MINs (r1.z, r0.x, r0.y); MINs (r1.z, r1.z, r0.z); MOVs_SAT (r1.w, r1.z); DP3_SAT (&r3, r0, lumaCoeff); SUB_zw (&r1, r3, r1); MAXs (r1.z, r1.z, 0.0000000001); RCPs (r1.z, r1.z); MAXs (r1.z, r1.z, 0); MULs (r1.z, r1.z, r1.w); SUB (&r2, r0, r3); MADvvsv_xyz (&r0, r2, r1.z, r3); } ABS_xyz (&r0, r0); POWs (r0.x, r0.x, Gamma.x); POWs (r0.y, r0.y, Gamma.x); POWs (r0.z, r0.z, Gamma.x); MAD (&r5, r5, r0, r0); MUL_xyz (&r0, r5, r4); MOV (&result_color, r0); END }
