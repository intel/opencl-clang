...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_KERNEL ShaderKernel_fxInversion(COMMON_PARAMS) { BEGIN_NORMAL LOAD_PARAMS(1) PARAM (inverse, program_local[0]) TEMP r0, r1; TEX (&r0, fragment_texcoord0, texture0_RECT); SUBvsv (&r1, 1, r0); LRP (&result_color, inverse, r1, r0); END }
