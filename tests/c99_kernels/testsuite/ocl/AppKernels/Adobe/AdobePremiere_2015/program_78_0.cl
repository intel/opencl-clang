...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_KERNEL ShaderKernel_fxCopperplate(COMMON_PARAMS) { BEGIN_NORMAL LOAD_PARAMS(5) PARAM (exponent, program_local[0]) PARAM (ambient, program_local[1]) PARAM (diffuse, program_local[2]) PARAM (specular, program_local[3]) PARAM (embossLevel, program_local[4]) PARAMC lightVector = c3(0, 0, 1); PARAMC eyeVector = c3(0.35777, 0.2683, 0.8944); TEMP r1, r2, r3, r4, r5, r6; ADD (&r5, s(fragment_texcoord0, xyxy), co_xyxy(1, 0, -1, 0)); ADD (&r6, s(fragment_texcoord0, xyxy), co_xyxy(0, -1, 0, 1)); TEX (&r1, r5, texture0_RECT); DP3svv (r3.y, r1, embossLevel); TEX (&r2, s(r5, zwzw), texture0_RECT); DP3svv (r4.y, r2, embossLevel); SUBs (r3.z, r3.y, r4.y); TEX (&r1, r6, texture0_RECT); DP3svv (r3.y, r1, embossLevel); TEX (&r2, s(r6, zwzw), texture0_RECT); DP3svv (r4.y, r2, embossLevel); SUBs (r4.z, r3.y, r4.y); MOV_xy (&r3, c4(1, 0, 0, 0)); MOV_xy (&r4, c4(0, 1, 0, 0)); XPD (&r2, r3, r4); DP3 (&r3, r2, r2); RSQvs (&r3, r3.x); MUL (&r2, r2, r3); TEX (&r3, fragment_texcoord0, texture0_RECT); DP3 (&r5, r3, embossLevel); MUL (&r4, diffuse, r5); MAD (&r4, r4, ambient, r4); DP3 (&r5, r2, lightVector); MULvvs (&r5, r5, 2); MAD (&r5, r5, r2, neg(lightVector)); DP3svv_SAT (r2.x, eyeVector, r5); POWvss (&r2, r2.x, exponent.x); MAD_xyz (&result_color, r2, specular, r4); MOVs (result_color.w, r3.w); END }
