...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_CUDA_TEXTURE(float4, texture2_2D) GF_KERNEL ShaderKernel_HueSatCurve(COMMON_PARAMS, GF_OPENCL_TEXTURE(texture2_2D)) { BEGIN_NORMAL LOAD_PARAMS(2) PARAM (luminance, program_local[0]) PARAM (rangeScaleOffset, program_local[1]) TEMP r0, r1, r2, r3, r4, r5; TEX (&r0, fragment_texcoord0, texture0_RECT); MAXs (r3.x, r0.x, r0.y); MAXs_SAT (r3.x, r3.x, r0.z); MINs (r2.x, r0.x, r0.y); MINs_SAT (r2.x, r2.x, r0.z); SUBs (r2.y, r3.x, r2.x); MAXs (r2.y, r2.y, 0.0000000001); RCPs (r2.z, r2.y); MOV_SAT (&r5, r0); SUB (&r4, s(r0, yzxx), s(r5, zxyx)); MULvsv (&r4, r2.z, r4); MADvvsv (&r4, r4, 0.1666666667, c4(0, 0.3333333333, 0.6666666667, 0)); SUBvvs (&r5, r0, r3.x); CMPs (r1.x, r5.x, r4.z, r4.x); CMPs (r1.x, r5.y, r1.x, r4.y); FRCs (r1.x, r1.x); MADs (r1.x, r1.x, ONE_MINUS_TEXEL, HALF_TEXEL); MOVs (r1.y, 0.0625); TEX_2d (&r3, r1, texture2_2D); DP3 (&r1, r0, luminance); MADs (r3.x, r3.x, rangeScaleOffset.x, rangeScaleOffset.y); SUB (&r2, r0, r1); MADvvsv_xyz (&result_color, r2, r3.x, r1); MOVs (result_color.w, r0.w); END }
