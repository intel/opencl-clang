...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_KERNEL ShaderKernel_fxDay2NiteH(COMMON_PARAMS) { BEGIN_NORMAL LOAD_PARAMS(6) PARAM (w1 , program_local[0]) PARAM (w2 , program_local[1]) PARAM (w3 , program_local[2]) PARAM (w4 , program_local[3]) PARAM (invSum, program_local[4]) PARAM (bleachBypass, program_local[5]) PARAMC XCoeffs = c3(0.5149, 0.3244, 0.1607); PARAMC YCoeffs = c3(0.2654, 0.6704, 0.0642); PARAMC ZCoeffs = c3(0.0248, 0.1248, 0.8504); TEMP r0, r1, r2, r3, r4, r5, r6; ADD (&r4, s(fragment_texcoord0, xxxy), co_xxxy(1, -1, 2, 0)); ADD (&r5, s(fragment_texcoord0, xxxy), co_xxxy(-2, 3, -3, 0)); ADD (&r6, s(fragment_texcoord0, xxxy), co_xxxy(4, -4, 0, 0)); TEX (&r0, fragment_texcoord0, texture0_RECT); TEX (&r1, s(r4, xwxw), texture0_RECT); MADvvsv (&r2, r1, w1.x, r0); MADvvsv (&r3, r1, w1.y, r0); TEX (&r1, s(r4, ywyw), texture0_RECT); MADvvsv (&r2, r1, w1.x, r2); MADvvsv (&r3, r1, w1.y, r3); TEX (&r1, s(r4, zwzw), texture0_RECT); MADvvsv (&r2, r1, w2.x, r2); MADvvsv (&r3, r1, w2.y, r3); TEX (&r1, s(r5, xwxw), texture0_RECT); MADvvsv (&r2, r1, w2.x, r2); MADvvsv (&r3, r1, w2.y, r3); TEX (&r1, s(r5, ywyw), texture0_RECT); MADvvsv (&r2, r1, w3.x, r2); MADvvsv (&r3, r1, w3.y, r3); TEX (&r1, s(r5, zwzw), texture0_RECT); MADvvsv (&r2, r1, w3.x, r2); MADvvsv (&r3, r1, w3.y, r3); TEX (&r1, s(r6, xwxw), texture0_RECT); MADvvsv (&r2, r1, w4.x, r2); MADvvsv (&r3, r1, w4.y, r3); TEX (&r1, s(r6, ywyw), texture0_RECT); MADvvsv (&r2, r1, w4.x, r2); MADvvsv (&r3, r1, w4.y, r3); MULvsv (&r2, invSum.x, r2); MULvsv (&r3, invSum.y, r3); DP3svs (r1.x, r2, 0.5); DP3svs (r1.y, r3, 0.5); MULvvs (&r4, r2, r1.x); MULvvs (&r5, r3, r1.y); MUL (&r1, r1, r1); SUBvvs (&r4, r4, r1.x); MADvvss (&r4, r4, 0.75, r1.x); MULvvs (&r4, r4, 2); LRP (&r2, bleachBypass, r4, r2); SUBvvs (&r5, r5, r1.y); MADvvss (&r5, r5, 0.75, r1.y); MULvvs (&r5, r5, 2); LRP (&r3, bleachBypass, r5, r3); DP3svv (r4.x, XCoeffs, r2); DP3svv (r5.x, YCoeffs, r2); DP3svv (r6.x, ZCoeffs, r2); DP3svv (r4.y, XCoeffs, r3); DP3svv (r5.y, YCoeffs, r3); DP3svv (r6.y, ZCoeffs, r3); MAXvvs (&r4, r4, 0.001); ADD (&r0, r5, r6); RCPs (r1.x, r4.x); RCPs (r1.y, r4.y); MADvvvs (&r0, r1, r0, 1); MADvvss (&r0, r0, 1.33, -1.68); MUL_xy (&result_color, r0, r5); END }
