...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_CUDA_TEXTURE(float4, texture1_RECT) GF_KERNEL ShaderKernel_GaussianBlurRange(COMMON_PARAMS, GF_OPENCL_TEXTURE(texture1_RECT)) { BEGIN_MULTITEXTURE LOAD_PARAMS(12) PARAM (w1 , program_local[0]) PARAM (w2 , program_local[1]) PARAM (w3 , program_local[2]) PARAM (w4 , program_local[3]) PARAM (invSum, program_local[4]) PARAM (middleHLS , program_local[5]) PARAM (toleranceHLS , program_local[6]) PARAM (oneOverToleranceHLS, program_local[7]) PARAM (center , program_local[8]) PARAM (side , program_local[9]) PARAM (corner , program_local[10]) PARAM (invSumRange, program_local[11]) TEMP r0, r1, r2, r3, r4, r5, r10, r13; ADD (&r2, s(fragment_texcoord1, xyxy), co_xyxy(-1, -1, 0, 0)); ADD (&r3, s(fragment_texcoord1, xyxy), co_xyxy( 1, 1, 0, 0)); ADD (&r4, s(fragment_texcoord1, xyxy), co_xyxy(-1, -1, 1, 1)); TEX (&r10, fragment_texcoord1, texture1_RECT); MUL (&r1, r10, center); TEX (&r0, r2, texture1_RECT); MAD (&r1, r0, corner, r1); TEX (&r0, s(r4, zyzy), texture1_RECT); MAD (&r1, r0, corner, r1); TEX (&r0, s(r4, xwxw), texture1_RECT); MAD (&r1, r0, corner, r1); TEX (&r0, s(r4, zwzw), texture1_RECT); MAD (&r1, r0, corner, r1); TEX (&r0, s(r2, xwxw), texture1_RECT); MAD (&r1, r0, side, r1); TEX (&r0, s(r3, xwxw), texture1_RECT); MAD (&r1, r0, side, r1); TEX (&r0, s(r2, zyzy), texture1_RECT); MAD (&r1, r0, side, r1); TEX (&r0, s(r3, zyzy), texture1_RECT); MAD (&r1, r0, side, r1); MUL (&r0, r1, invSumRange); MAXs (r3.x, r0.x, r0.y); MAXs_SAT (r3.x, r3.x, r0.z); MINs (r2.x, r0.x, r0.y); MINs_SAT (r2.x, r2.x, r0.z); SUBs (r2.y, r3.x, r2.x); MAXs (r2.y, r2.y, 0.0000000001); ADDs (r3.y, r3.x, r2.x); RCPs (r2.z, r2.y); RCPs (r3.z, r3.y); MOV_SAT (&r5, r0); SUB (&r4, s(r0, yzxx), s(r5, zxyx)); MULvsv (&r4, r2.z, r4); MADvvsv (&r4, r4, 0.1666666667, c4(0, 0.3333333333, 0.6666666667, 0)); SUBs (r3.w, 2.000001, r3.y); RCPs (r3.w, r3.w); MULvvs_xz (&r1, s(r3, wwzz), r2.y); MULs (r1.y, r3.y, 0.5); SUBs (r5.y, 0.5, r1.y); CMPs (r1.z, r5.y, r1.x, r1.z); SUBvvs (&r5, r0, r3.x); CMPs (r1.x, r5.x, r4.z, r4.x); CMPs (r1.x, r5.y, r1.x, r4.y); FRCs (r1.x, r1.x); SUB (&r2, r1, middleHLS); ABS (&r2, r2); SUBs (r3.x, r2.x, 1); ABSs (r3.x, r3.x); MINs (r2.x, r3.x, r2.x); SUB (&r2, toleranceHLS, r2); MUL_SAT (&r2, r2, oneOverToleranceHLS); MULs (r2.x, r2.x, r2.y); MULs (r13.x, r2.x, r2.z); ADD (&r2, s(fragment_texcoord0, yyyx), co_yyyx(1, -1, 2, 0)); ADD (&r3, s(fragment_texcoord0, yyyx), co_yyyx(-2, 3, -3, 0)); ADD (&r4, s(fragment_texcoord0, yyyx), co_yyyx(4, -4, 0, 0)); TEX (&r5, fragment_texcoord0, texture0_RECT); TEX (&r1, s(r2, wxwx), texture0_RECT); MAD (&r5, r1, w1, r5); TEX (&r1, s(r2, wywy), texture0_RECT); MAD (&r5, r1, w1, r5); TEX (&r1, s(r2, wzwz), texture0_RECT); MAD (&r5, r1, w2, r5); TEX (&r1, s(r3, wxwx), texture0_RECT); MAD (&r5, r1, w2, r5); TEX (&r1, s(r3, wywy), texture0_RECT); MAD (&r5, r1, w3, r5); TEX (&r1, s(r3, wzwz), texture0_RECT); MAD (&r5, r1, w3, r5); TEX (&r1, s(r4, wxwx), texture0_RECT); MAD (&r5, r1, w4, r5); TEX (&r1, s(r4, wywy), texture0_RECT); MAD (&r5, r1, w4, r5); MUL (&r5, r5, invSum); LRPvsvv (&result_color, r13.x, r5, r10); END }
