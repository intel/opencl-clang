...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_KERNEL ShaderKernel_fxLegalizeNTSC(COMMON_PARAMS) { BEGIN_NORMAL LOAD_PARAMS(1) PARAM (clampScale, program_local[0]) PARAMC YCoeffs = c3(0.2989, 0.5866, 0.1144); PARAMC ICoeffs = c3(0.5959, -0.2741, -0.3218); PARAMC QCoeffs = c3(0.2113, -0.5227, 0.3113); PARAMC YInvCoeffs = c3(1.000162113, 0.956268146, 0.620971871); PARAMC IInvCoeffs = c3(1.000035166, -0.271705205, -0.64837378); PARAMC QInvCoeffs = c3(1.000270243, -1.105299613, 1.70216405); TEMP r0, r1, r2, r3, r4, r5; TEX (&r0, fragment_texcoord0, texture0_RECT); MOV_SAT (&r5, r0); DP3svv (r2.x, r5, YCoeffs); DP3svv (r2.y, r5, ICoeffs); DP3svv (r2.z, r5, QCoeffs); MOVs (r2.w, 0); DP3svv (r3.x, s(r2, yzww), s(r2, yzww)); RSQs (r1.y, r3.x); MULs (r1.y, r3.x, r1.y); MOVs (r4.x, r1.y); MADvsvs_yz (&r4, r1.y, c3(0, 1, -1), r2.x); MAD (&r4, r4, c3(1.2619, 0.5578953, -0.5578953), c3(0, 0, 0.5578953)); DPHsvv_SAT (r4.y, r4, clampScale); MADs (r4.y, -r4.y, r1.y, r1.y); MADvsvs_zw (&r1, r4.y, c4(0, 0, 1, -1), r2.x); MAXs (r1.w, r1.w, -0.297); MINs (r1.z, r1.z, 0.999); SUBs (r4.z, r1.z, r2.x); SUBs (r4.w, r2.x, r1.w); MINs (r4.x, r4.w, r4.z); MINs (r4.x, r4.x, 0.538); RCPs (r2.w, r1.y); MULs (r2.w, r2.w, r4.x); MULvsv_yz (&r2, r2.w, s(r2, yyzz)); DP3svv (r3.x, YInvCoeffs, r2); DP3svv (r3.y, IInvCoeffs, r2); DP3svv (r3.z, QInvCoeffs, r2); MAXvvs_xyz (&result_color, r3, 0); MOVs (result_color.w, r0.w); END }
