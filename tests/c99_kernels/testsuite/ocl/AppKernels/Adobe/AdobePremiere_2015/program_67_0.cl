...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_KERNEL ShaderKernel_fxKuwaharaFilter7x7(COMMON_PARAMS) { BEGIN_NORMAL TEMP r0, r1, r2, r3, r4, r5, r6, r7, r8, r9; TEMP r10, r11, r12, r13, r14, r15, r16, r19; TEMP r20, r21, r22, r23, r24, r25, r26, r27; TEMP r28, r29, r30, r31; ADD (&r20, s(fragment_texcoord0, xyxy), co_xyxy(-3, -3, -2, -3)); ADD (&r21, s(fragment_texcoord0, xyxy), co_xyxy(-1, -3, 0, -3)); ADD (&r22, s(fragment_texcoord0, xyxy), co_xyxy(-3, -2, -2, -2)); ADD (&r23, s(fragment_texcoord0, xyxy), co_xyxy(-1, -2, 0, -2)); ADD (&r24, s(fragment_texcoord0, xyxy), co_xyxy(-3, -1, -2, -1)); ADD (&r25, s(fragment_texcoord0, xyxy), co_xyxy(-1, -1, 0, -1)); ADD (&r26, s(fragment_texcoord0, xyxy), co_xyxy(-3, 0, -2, 0)); ADD (&r27, s(fragment_texcoord0, xyxy), co_xyxy(-1, 0, 0, 0)); TEX (&r1, r20, texture0_RECT); TEX (&r2, s(r20, zwzw), texture0_RECT); TEX (&r3, r21, texture0_RECT); TEX (&r4, s(r21, zwzw), texture0_RECT); TEX (&r5, r22, texture0_RECT); TEX (&r6, s(r22, zwzw), texture0_RECT); TEX (&r7, r23, texture0_RECT); TEX (&r8, s(r23, zwzw), texture0_RECT); TEX (&r9, r24, texture0_RECT); TEX (&r10, s(r24, zwzw), texture0_RECT); TEX (&r11, r25, texture0_RECT); TEX (&r12, s(r25, zwzw), texture0_RECT); TEX (&r13, r26, texture0_RECT); TEX (&r14, s(r26, zwzw), texture0_RECT); TEX (&r15, r27, texture0_RECT); TEX (&r16, s(r27, zwzw), texture0_RECT); ADD (&r19, r1, r2); ADD (&r19, r19, r3); ADD (&r19, r19, r4); ADD (&r19, r19, r5); ADD (&r19, r19, r6); ADD (&r19, r19, r7); ADD (&r19, r19, r8); ADD (&r19, r19, r9); ADD (&r19, r19, r10); ADD (&r19, r19, r11); ADD (&r19, r19, r12); ADD (&r19, r19, r13); ADD (&r19, r19, r14); ADD (&r19, r19, r15); ADD (&r19, r19, r16); MULvvs (&r28, r19, 0.0625); SUB (&r0, r28, r1); MUL (&r19, r0, r0); SUB (&r0, r28, r2); MAD (&r19, r0, r0, r19); SUB (&r0, r28, r3); MAD (&r19, r0, r0, r19); SUB (&r0, r28, r4); MAD (&r19, r0, r0, r19); SUB (&r0, r28, r5); MAD (&r19, r0, r0, r19); SUB (&r0, r28, r6); MAD (&r19, r0, r0, r19); SUB (&r0, r28, r7); MAD (&r19, r0, r0, r19); SUB (&r0, r28, r8); MAD (&r19, r0, r0, r19); SUB (&r0, r28, r9); MAD (&r19, r0, r0, r19); SUB (&r0, r28, r10); MAD (&r19, r0, r0, r19); SUB (&r0, r28, r11); MAD (&r19, r0, r0, r19); SUB (&r0, r28, r12); MAD (&r19, r0, r0, r19); SUB (&r0, r28, r13); MAD (&r19, r0, r0, r19); SUB (&r0, r28, r14); MAD (&r19, r0, r0, r19); SUB (&r0, r28, r15); MAD (&r19, r0, r0, r19); SUB (&r0, r28, r16); MAD (&r19, r0, r0, r19); DP3svs (r28.w, r19, 0.0625); ADD (&r20, s(fragment_texcoord0, xyxy), co_xyxy(0, -3, 1, -3)); ADD (&r21, s(fragment_texcoord0, xyxy), co_xyxy(2, -3, 3, -3)); ADD (&r22, s(fragment_texcoord0, xyxy), co_xyxy(0, -2, 1, -2)); ADD (&r23, s(fragment_texcoord0, xyxy), co_xyxy(2, -2, 3, -2)); ADD (&r24, s(fragment_texcoord0, xyxy), co_xyxy(0, -1, 1, -1)); ADD (&r25, s(fragment_texcoord0, xyxy), co_xyxy(2, -1, 3, -1)); ADD (&r26, s(fragment_texcoord0, xyxy), co_xyxy(0, 0, 1, 0)); ADD (&r27, s(fragment_texcoord0, xyxy), co_xyxy(2, 0, 3, 0)); TEX (&r1, r20, texture0_RECT); TEX (&r2, s(r20, zwzw), texture0_RECT); TEX (&r3, r21, texture0_RECT); TEX (&r4, s(r21, zwzw), texture0_RECT); TEX (&r5, r22, texture0_RECT); TEX (&r6, s(r22, zwzw), texture0_RECT); TEX (&r7, r23, texture0_RECT); TEX (&r8, s(r23, zwzw), texture0_RECT); TEX (&r9, r24, texture0_RECT); TEX (&r10, s(r24, zwzw), texture0_RECT); TEX (&r11, r25, texture0_RECT); TEX (&r12, s(r25, zwzw), texture0_RECT); TEX (&r13, r26, texture0_RECT); TEX (&r14, s(r26, zwzw), texture0_RECT); TEX (&r15, r27, texture0_RECT); TEX (&r16, s(r27, zwzw), texture0_RECT); ADD (&r19, r1, r2); ADD (&r19, r19, r3); ADD (&r19, r19, r4); ADD (&r19, r19, r5); ADD (&r19, r19, r6); ADD (&r19, r19, r7); ADD (&r19, r19, r8); ADD (&r19, r19, r9); ADD (&r19, r19, r10); ADD (&r19, r19, r11); ADD (&r19, r19, r12); ADD (&r19, r19, r13); ADD (&r19, r19, r14); ADD (&r19, r19, r15); ADD (&r19, r19, r16); MULvvs (&r29, r19, 0.0625); SUB (&r0, r29, r1); MUL (&r19, r0, r0); SUB (&r0, r29, r2); MAD (&r19, r0, r0, r19); SUB (&r0, r29, r3); MAD (&r19, r0, r0, r19); SUB (&r0, r29, r4); MAD (&r19, r0, r0, r19); SUB (&r0, r29, r5); MAD (&r19, r0, r0, r19); SUB (&r0, r29, r6); MAD (&r19, r0, r0, r19); SUB (&r0, r29, r7); MAD (&r19, r0, r0, r19); SUB (&r0, r29, r8); MAD (&r19, r0, r0, r19); SUB (&r0, r29, r9); MAD (&r19, r0, r0, r19); SUB (&r0, r29, r10); MAD (&r19, r0, r0, r19); SUB (&r0, r29, r11); MAD (&r19, r0, r0, r19); SUB (&r0, r29, r12); MAD (&r19, r0, r0, r19); SUB (&r0, r29, r13); MAD (&r19, r0, r0, r19); SUB (&r0, r29, r14); MAD (&r19, r0, r0, r19); SUB (&r0, r29, r15); MAD (&r19, r0, r0, r19); SUB (&r0, r29, r16); MAD (&r19, r0, r0, r19); DP3svs (r29.w, r19, 0.0625); ADD (&r20, s(fragment_texcoord0, xyxy), co_xyxy(0, 0, 1, 0)); ADD (&r21, s(fragment_texcoord0, xyxy), co_xyxy(2, 0, 3, 0)); ADD (&r22, s(fragment_texcoord0, xyxy), co_xyxy(0, 1, 1, 1)); ADD (&r23, s(fragment_texcoord0, xyxy), co_xyxy(2, 1, 3, 1)); ADD (&r24, s(fragment_texcoord0, xyxy), co_xyxy(0, 2, 1, 2)); ADD (&r25, s(fragment_texcoord0, xyxy), co_xyxy(2, 2, 3, 2)); ADD (&r26, s(fragment_texcoord0, xyxy), co_xyxy(0, 3, 1, 3)); ADD (&r27, s(fragment_texcoord0, xyxy), co_xyxy(2, 3, 3, 3)); TEX (&r1, r20, texture0_RECT); TEX (&r2, s(r20, zwzw), texture0_RECT); TEX (&r3, r21, texture0_RECT); TEX (&r4, s(r21, zwzw), texture0_RECT); TEX (&r5, r22, texture0_RECT); TEX (&r6, s(r22, zwzw), texture0_RECT); TEX (&r7, r23, texture0_RECT); TEX (&r8, s(r23, zwzw), texture0_RECT); TEX (&r9, r24, texture0_RECT); TEX (&r10, s(r24, zwzw), texture0_RECT); TEX (&r11, r25, texture0_RECT); TEX (&r12, s(r25, zwzw), texture0_RECT); TEX (&r13, r26, texture0_RECT); TEX (&r14, s(r26, zwzw), texture0_RECT); TEX (&r15, r27, texture0_RECT); TEX (&r16, s(r27, zwzw), texture0_RECT); ADD (&r19, r1, r2); ADD (&r19, r19, r3); ADD (&r19, r19, r4); ADD (&r19, r19, r5); ADD (&r19, r19, r6); ADD (&r19, r19, r7); ADD (&r19, r19, r8); ADD (&r19, r19, r9); ADD (&r19, r19, r10); ADD (&r19, r19, r11); ADD (&r19, r19, r12); ADD (&r19, r19, r13); ADD (&r19, r19, r14); ADD (&r19, r19, r15); ADD (&r19, r19, r16); MULvvs (&r31, r19, 0.0625); SUB (&r0, r31, r1); MUL (&r19, r0, r0); SUB (&r0, r31, r2); MAD (&r19, r0, r0, r19); SUB (&r0, r31, r3); MAD (&r19, r0, r0, r19); SUB (&r0, r31, r4); MAD (&r19, r0, r0, r19); SUB (&r0, r31, r5); MAD (&r19, r0, r0, r19); SUB (&r0, r31, r6); MAD (&r19, r0, r0, r19); SUB (&r0, r31, r7); MAD (&r19, r0, r0, r19); SUB (&r0, r31, r8); MAD (&r19, r0, r0, r19); SUB (&r0, r31, r9); MAD (&r19, r0, r0, r19); SUB (&r0, r31, r10); MAD (&r19, r0, r0, r19); SUB (&r0, r31, r11); MAD (&r19, r0, r0, r19); SUB (&r0, r31, r12); MAD (&r19, r0, r0, r19); SUB (&r0, r31, r13); MAD (&r19, r0, r0, r19); SUB (&r0, r31, r14); MAD (&r19, r0, r0, r19); SUB (&r0, r31, r15); MAD (&r19, r0, r0, r19); SUB (&r0, r31, r16); MAD (&r19, r0, r0, r19); DP3svs (r31.w, r19, 0.0625); ADD (&r20, s(fragment_texcoord0, xyxy), co_xyxy(-3, 0, -2, 0)); ADD (&r21, s(fragment_texcoord0, xyxy), co_xyxy(-1, 0, 0, 0)); ADD (&r22, s(fragment_texcoord0, xyxy), co_xyxy(-3, 1, -2, 1)); ADD (&r23, s(fragment_texcoord0, xyxy), co_xyxy(-1, 1, 0, 1)); ADD (&r24, s(fragment_texcoord0, xyxy), co_xyxy(-3, 2, -2, 2)); ADD (&r25, s(fragment_texcoord0, xyxy), co_xyxy(-1, 2, 0, 2)); ADD (&r26, s(fragment_texcoord0, xyxy), co_xyxy(-3, 3, -2, 3)); ADD (&r27, s(fragment_texcoord0, xyxy), co_xyxy(-1, 3, 0, 3)); TEX (&r1, r20, texture0_RECT); TEX (&r2, s(r20, zwzw), texture0_RECT); TEX (&r3, r21, texture0_RECT); TEX (&r4, s(r21, zwzw), texture0_RECT); TEX (&r5, r22, texture0_RECT); TEX (&r6, s(r22, zwzw), texture0_RECT); TEX (&r7, r23, texture0_RECT); TEX (&r8, s(r23, zwzw), texture0_RECT); TEX (&r9, r24, texture0_RECT); TEX (&r10, s(r24, zwzw), texture0_RECT); TEX (&r11, r25, texture0_RECT); TEX (&r12, s(r25, zwzw), texture0_RECT); TEX (&r13, r26, texture0_RECT); TEX (&r14, s(r26, zwzw), texture0_RECT); TEX (&r15, r27, texture0_RECT); TEX (&r16, s(r27, zwzw), texture0_RECT); ADD (&r19, r1, r2); ADD (&r19, r19, r3); ADD (&r19, r19, r4); ADD (&r19, r19, r5); ADD (&r19, r19, r6); ADD (&r19, r19, r7); ADD (&r19, r19, r8); ADD (&r19, r19, r9); ADD (&r19, r19, r10); ADD (&r19, r19, r11); ADD (&r19, r19, r12); ADD (&r19, r19, r13); ADD (&r19, r19, r14); ADD (&r19, r19, r15); ADD (&r19, r19, r16); MULvvs (&r30, r19, 0.0625); SUB (&r0, r30, r1); MUL (&r19, r0, r0); SUB (&r0, r30, r2); MAD (&r19, r0, r0, r19); SUB (&r0, r30, r3); MAD (&r19, r0, r0, r19); SUB (&r0, r30, r4); MAD (&r19, r0, r0, r19); SUB (&r0, r30, r5); MAD (&r19, r0, r0, r19); SUB (&r0, r30, r6); MAD (&r19, r0, r0, r19); SUB (&r0, r30, r7); MAD (&r19, r0, r0, r19); SUB (&r0, r30, r8); MAD (&r19, r0, r0, r19); SUB (&r0, r30, r9); MAD (&r19, r0, r0, r19); SUB (&r0, r30, r10); MAD (&r19, r0, r0, r19); SUB (&r0, r30, r11); MAD (&r19, r0, r0, r19); SUB (&r0, r30, r12); MAD (&r19, r0, r0, r19); SUB (&r0, r30, r13); MAD (&r19, r0, r0, r19); SUB (&r0, r30, r14); MAD (&r19, r0, r0, r19); SUB (&r0, r30, r15); MAD (&r19, r0, r0, r19); SUB (&r0, r30, r16); MAD (&r19, r0, r0, r19); DP3svs (r30.w, r19, 0.0625); SLTs (r0.w, r28.w, r29.w); LRPvsvv (&r0, r0.w, r28, r29); SLTs (r2.w, r30.w, r31.w); LRPvsvv (&r2, r2.w, r30, r31); SLTs (r1.w, r2.w, r0.w); LRPvsvv_xyz (&result_color, r1.w, r2, r0); MOVs (result_color.w, r4.w); END }
