...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_KERNEL ShaderKernel_fxMedianFilter3x3V(COMMON_PARAMS) { BEGIN_NORMAL TEMP r0, r1, r2, r3, r4; ADD (&r3, s(fragment_texcoord0, xyxy), co_xyxy(0, -1, 0, 1)); TEX (&r0, r3, texture0_RECT); TEX (&r1, fragment_texcoord0, texture0_RECT); TEX (&r2, s(r3, zwzw), texture0_RECT); MIN (&r3, r0, r1); MAX (&r4, r0, r1); MIN (&r4, r4, r2); MAX (&result_color, r3, r4); END }
