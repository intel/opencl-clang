...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_KERNEL ShaderKernel_fxNight(COMMON_PARAMS) { BEGIN_NORMAL LOAD_PARAMS(1) PARAM (colorTone, program_local[0]) PARAMC cxf1 = c3(0.5149, 0.3244, 0.1607); PARAMC cxf2 = c3(0.2654, 0.6704, 0.0642); PARAMC cxf3 = c3(0.0248, 0.1248, 0.8504); TEMP r0, r1; TEX (&r0, fragment_texcoord0, texture0_RECT); DP3svv (r1.x, cxf1, r0); DP3svv (r1.y, cxf2, r0); DP3svv (r1.z, cxf3, r0); MAX (&r1, r1, c3(0.01, 0, 0)); ADDs (r0.x, r1.y, r1.z); RCPs (r0.y, r1.x); MADs (r0.x, r0.y, r0.x, 1); MADs (r0.x, r0.x, 1.33, -1.68); MULs (r0.x, r0.x, r1.y); MULvsv_xyz (&result_color, r0.x, colorTone); MOVs (result_color.w, r0.w); END }
