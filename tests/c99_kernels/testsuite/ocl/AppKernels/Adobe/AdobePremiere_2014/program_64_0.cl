...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_KERNEL ShaderKernel_fxCrayonDrawing(COMMON_PARAMS) { BEGIN_NORMAL LOAD_PARAMS(1) PARAM (desatCoeffs, program_local[0]) TEMP r0, r1, r2, r11, r13, r15, r17; ADD (&r11, s(fragment_texcoord0, xyxy), co_xyxy(0, 1, -1, 1)); ADD (&r13, s(fragment_texcoord0, xyxy), co_xyxy(-1, 0, -1, -1)); ADD (&r15, s(fragment_texcoord0, xyxy), co_xyxy(0, -1, 1, -1)); ADD (&r17, s(fragment_texcoord0, xyxy), co_xyxy(1, 0, 1, 1)); TEX (&r2, s(r13, zwzw), texture0_RECT); TEX (&r1, s(r17, zwzw), texture0_RECT); SUB (&r2, r1, r2); TEX (&r1, s(r11, zwzw), texture0_RECT); SUB (&r0, r2, r1); ADD (&r2, r1, r2); TEX (&r1, r11, texture0_RECT); MADvvsv (&r2, r1, 2, r2); TEX (&r1, r13, texture0_RECT); MADvvsv (&r0, r1, -2, r0); TEX (&r1, r15, texture0_RECT); MADvvsv (&r2, r1, -2, r2); TEX (&r1, s(r15, zwzw), texture0_RECT); ADD (&r0, r1, r0); SUB (&r2, r2, r1); TEX (&r1, r17, texture0_RECT); MADvvsv (&r0, r1, 2, r0); MUL (&r0, r0, r0); MAD (&r2, r2, r2, r0); DP3 (&r2, r2, desatCoeffs); MAXs (r2.x, r2.x, 0.00000001); RSQs (r1.x, r2.x); MULs_SAT (r0.x, r1.x, r2.x); SUBvss_xyz (&result_color, 1, r0.x); TEXs_w (result_color.w, fragment_texcoord0, texture0_RECT); END }
