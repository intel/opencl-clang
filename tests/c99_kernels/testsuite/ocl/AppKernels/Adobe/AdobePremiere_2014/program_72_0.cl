...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_KERNEL ShaderKernel_ConvolveV(COMMON_PARAMS) { BEGIN_NORMAL LOAD_PARAMS(5) PARAM (w1 , program_local[0]) PARAM (w2 , program_local[1]) PARAM (w3 , program_local[2]) PARAM (w4 , program_local[3]) PARAM (invSum, program_local[4]) TEMP r0, r1, r2, r3, r4; ADD (&r2, s(fragment_texcoord0, yyyx), co_yyyx(1, -1, 2, 0)); ADD (&r3, s(fragment_texcoord0, yyyx), co_yyyx(-2, 3, -3, 0)); ADD (&r4, s(fragment_texcoord0, yyyx), co_yyyx(4, -4, 0, 0)); TEX (&r0, fragment_texcoord0, texture0_RECT); TEX (&r1, s(r2, wxwx), texture0_RECT); MAD (&r0, r1, w1, r0); TEX (&r1, s(r2, wywy), texture0_RECT); MAD (&r0, r1, w1, r0); TEX (&r1, s(r2, wzwz), texture0_RECT); MAD (&r0, r1, w2, r0); TEX (&r1, s(r3, wxwx), texture0_RECT); MAD (&r0, r1, w2, r0); TEX (&r1, s(r3, wywy), texture0_RECT); MAD (&r0, r1, w3, r0); TEX (&r1, s(r3, wzwz), texture0_RECT); MAD (&r0, r1, w3, r0); TEX (&r1, s(r4, wxwx), texture0_RECT); MAD (&r0, r1, w4, r0); TEX (&r1, s(r4, wywy), texture0_RECT); MAD (&r0, r1, w4, r0); MUL (&result_color, r0, invSum); END }
