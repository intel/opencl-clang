...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_KERNEL ShaderKernel_fxOutline(COMMON_PARAMS) { BEGIN_NORMAL LOAD_PARAMS(1) PARAM (lineWidth, program_local[0]) TEMP r1, r2, r3, r4, r5, r6, r13, r14, r15; ADD (&r13, s(fragment_texcoord0, xyyy), co_xyyy(-1, -1, 0, 1)); ADD (&r14, s(fragment_texcoord0, xyyy), co_xyyy(0, -1, 0, 1)); ADD (&r15, s(fragment_texcoord0, xyyy), co_xyyy(1, -1, 0, 1)); TEX (&r1, s(r15, xwxw), texture0_RECT); TEX (&r2, r13, texture0_RECT); SUB (&r2, r1, r2); TEX (&r4, s(r13, xwxw), texture0_RECT); SUB (&r3, r2, r4); ADD (&r2, r4, r2); TEX (&r5, s(r14, xwxw), texture0_RECT); MADvvsv (&r2, r5, 2, r2); TEX (&r6, s(r13, xzxz), texture0_RECT); MADvvsv (&r3, r6, -2, r3); TEX (&r4, r14, texture0_RECT); MADvvsv (&r2, r4, -2, r2); TEX (&r5, r15, texture0_RECT); SUB (&r2, r2, r5); ADD (&r3, r5, r3); TEX (&r6, s(r15, xzxz), texture0_RECT); MADvvsv (&r3, r6, 2, r3); MUL (&r3, r3, r3); MAD (&r2, r2, r2, r3); DP3svs_SAT (r2.x, r2, 1); MAXs (r2.x, r2.x, 0.00000001); RSQs (r1.x, r2.x); MULs_SAT (r3.x, r1.x, r2.x); MULs (r3.x, r3.x, lineWidth.x); FLRs (r3.x, r3.x); SUBs (r3.x, 1, r3.x); TEX (&r1, fragment_texcoord0, texture0_RECT); MULvsv_xyz (&result_color, r3.x, r1); MOVs (result_color.w, r1.w); END }
