...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_KERNEL ShaderKernel_fxBloomH(COMMON_PARAMS) { BEGIN_NORMAL LOAD_PARAMS(9) PARAM (w1 , program_local[0]) PARAM (w2 , program_local[1]) PARAM (w3 , program_local[2]) PARAM (w4 , program_local[3]) PARAM (w5 , program_local[4]) PARAM (w6 , program_local[5]) PARAM (w7 , program_local[6]) PARAM (invSum, program_local[7]) PARAM (threshold, program_local[8]) TEMP r0, r1, r2, r3, r4, r5, r6; ADD (&r2, s(fragment_texcoord0, xxxy), co_xxxy(1, -1, 2, 0)); ADD (&r3, s(fragment_texcoord0, xxxy), co_xxxy(-2, 3, -3, 0)); ADD (&r4, s(fragment_texcoord0, xxxy), co_xxxy(4, -4, 5, 0)); ADD (&r5, s(fragment_texcoord0, xxxy), co_xxxy(-5, 6, -6, 0)); ADD (&r6, s(fragment_texcoord0, xxxy), co_xxxy(7, -7, 0, 0)); TEX (&r0, fragment_texcoord0, texture0_RECT); MAX (&r0, r0, threshold); TEX (&r1, s(r2, xwxw), texture0_RECT); MAX (&r1, r1, threshold); MAD (&r0, r1, w1, r0); TEX (&r1, s(r2, ywyw), texture0_RECT); MAX (&r1, r1, threshold); MAD (&r0, r1, w1, r0); TEX (&r1, s(r2, zwzw), texture0_RECT); MAX (&r1, r1, threshold); MAD (&r0, r1, w2, r0); TEX (&r1, s(r3, xwxw), texture0_RECT); MAX (&r1, r1, threshold); MAD (&r0, r1, w2, r0); TEX (&r1, s(r3, ywyw), texture0_RECT); MAX (&r1, r1, threshold); MAD (&r0, r1, w3, r0); TEX (&r1, s(r3, zwzw), texture0_RECT); MAX (&r1, r1, threshold); MAD (&r0, r1, w3, r0); TEX (&r1, s(r4, xwxw), texture0_RECT); MAX (&r1, r1, threshold); MAD (&r0, r1, w4, r0); TEX (&r1, s(r4, ywyw), texture0_RECT); MAX (&r1, r1, threshold); MAD (&r0, r1, w4, r0); TEX (&r1, s(r4, zwzw), texture0_RECT); MAX (&r1, r1, threshold); MAD (&r0, r1, w5, r0); TEX (&r1, s(r5, xwxw), texture0_RECT); MAX (&r1, r1, threshold); MAD (&r0, r1, w5, r0); TEX (&r1, s(r5, ywyw), texture0_RECT); MAX (&r1, r1, threshold); MAD (&r0, r1, w6, r0); TEX (&r1, s(r5, zwzw), texture0_RECT); MAX (&r1, r1, threshold); MAD (&r0, r1, w6, r0); TEX (&r1, s(r6, xwxw), texture0_RECT); MAX (&r1, r1, threshold); MAD (&r0, r1, w7, r0); TEX (&r1, s(r6, ywyw), texture0_RECT); MAX (&r1, r1, threshold); MAD (&r0, r1, w7, r0); MUL_xyz (&result_color, r0, invSum); END }
