...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_KERNEL ShaderKernel_fxSobelOperator(COMMON_PARAMS) { BEGIN_NORMAL TEMP r0, r1, r2, r11, r13, r15, r17; ADD (&r11, s(fragment_texcoord0, xyxy), co_xyxy(0, 1, -1, 1)); ADD (&r13, s(fragment_texcoord0, xyxy), co_xyxy(-1, 0, -1, -1)); ADD (&r15, s(fragment_texcoord0, xyxy), co_xyxy(0, -1, 1, -1)); ADD (&r17, s(fragment_texcoord0, xyxy), co_xyxy(1, 0, 1, 1)); TEX (&r2, s(r13, zwzw), texture0_RECT); TEX (&r1, s(r17, zwzw), texture0_RECT); SUB (&r2, r1, r2); TEX (&r1, s(r11, zwzw), texture0_RECT); SUB (&r0, r2, r1); ADD (&r2, r1, r2); TEX (&r1, r11, texture0_RECT); MADvvsv (&r2, r1, 2, r2); TEX (&r1, r13, texture0_RECT); MADvvsv (&r0, r1, -2, r0); TEX (&r1, r15, texture0_RECT); MADvvsv (&r2, r1, -2, r2); TEX (&r1, s(r15, zwzw), texture0_RECT); ADD (&r0, r1, r0); SUB (&r2, r2, r1); TEX (&r1, r17, texture0_RECT); MADvvsv (&r0, r1, 2, r0); MUL (&r0, r0, r0); MAD (&r2, r2, r2, r0); RSQs (r1.x, r2.x); RCPs (result_color.x, r1.x); RSQs (r1.y, r2.y); RCPs (result_color.y, r1.y); RSQs (r1.z, r2.z); RCPs (result_color.z, r1.z); TEXs_w (result_color.w, fragment_texcoord0, texture0_RECT); END }
