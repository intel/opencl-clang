...
#endif
GF_CUDA_TEXTURE(float4, texture0_RECT) GF_KERNEL ShaderKernel_Gain(COMMON_PARAMS) { BEGIN_NORMAL LOAD_PARAMS(1) PARAM (gain, program_local[0]) TEMP r0; TEX (&r0, fragment_texcoord0, texture0_RECT); MUL (&result_color, r0, gain); END }
