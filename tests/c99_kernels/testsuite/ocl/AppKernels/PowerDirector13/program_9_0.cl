...
__kernel void ChinesePainting_Kernel(__read_only image2d_t src, __read_only image2d_t orig, __write_only image2d_t dst)
{
	int2 coord = (int2)(get_global_id(0), get_global_id(1));
	...
	tempSrc = read_imageui(src, imageSampler, coord);
	tempAlpha = read_imageui(orig, imageSampler, coord);
