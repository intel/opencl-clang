...
__kernel void ColorPainting_AdjustLevel_Blend(__read_only image2d_t src1, __read_only image2d_t src2, __read_only image2d_t src3, __write_only image2d_t dst, int outputBlack)
{
    ...
    tempAlpha = read_imageui(src3, imageSampler2, coord);
