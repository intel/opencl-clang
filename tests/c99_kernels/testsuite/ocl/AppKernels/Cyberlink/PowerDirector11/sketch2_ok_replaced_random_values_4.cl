								...
								, int width)
{
	...
	*(RandomTable+id+0*size) = (11*intensity)%19;
	*(RandomTable+id+1*size) = (13*intensity*intensity)%19;
	*(RandomTable+id+2*size) = (17*intensity*intensity*intensity)%19;
	*(RandomTable+id+3*size) = (19*intensity*intensity*intensity*intensity)%19;
