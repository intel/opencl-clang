...
__constant sampler_t imageSamplerTemp = CLK_NORMALIZED_COORDS_FALSE | CLK_ADDRESS_CLAMP | CLK_FILTER_NEAREST;
...
__kernel void Bloom_Kernel(__read_only image2d_t src, __write_only image2d_t dst, __read_only image2d_t Temp, __constant int* Table, __constant float* Weight, int width, int height, int kernelNumber, int lightNumber, int scaleRatio)
{
	int2 coord;
	uint4 tempSrc;
