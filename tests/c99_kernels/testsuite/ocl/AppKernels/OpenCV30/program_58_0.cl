...
// buildOptions= -D INTEL_DEVICE -D DEPTH_0 -D scn=4 -D bidx=2 -D hscale=0.500000f
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D DEPTH_0 -D scn=4 -D bidx=2 -D hscale=0.500000f" %cfg_path --cl-device=%cl_device 2>&1
