...
// buildOptions= -D INTEL_DEVICE -D DEPTH_0 -D dcn=3 -D bidx=2 -D pixels_per_work_item=4
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D DEPTH_0 -D dcn=3 -D bidx=2 -D pixels_per_work_item=4" %cfg_path --cl-device=%cl_device 2>&1
