...
// buildOptions= -D INTEL_DEVICE -D srcT=int -D dstT=int -D convertToDstT=convert_int -D FUNC_SUM
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D srcT=int -D dstT=int -D convertToDstT=convert_int -D FUNC_SUM" %cfg_path --cl-device=%cl_device 2>&1
