...
// buildOptions= -D INTEL_DEVICE -D INTER_NEAREST -D BORDER_CONSTANT -D T=uchar4
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D INTER_NEAREST -D BORDER_CONSTANT -D T=uchar4" %cfg_path --cl-device=%cl_device 2>&1
