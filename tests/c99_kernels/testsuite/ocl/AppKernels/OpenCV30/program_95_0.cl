...
// buildOptions= -D INTEL_DEVICE -D T=uchar4 -D THRESH_BINARY
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D T=uchar4 -D THRESH_BINARY" %cfg_path --cl-device=%cl_device 2>&1
