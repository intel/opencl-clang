...
// buildOptions= -D INTEL_DEVICE -D INTER_LINEAR -D BORDER_CONSTANT -D T=uchar -D WT=float -D convertToT=convert_uchar_sat_rte -D convertToWT=convert_float -D convertToWT2=convert_float2 -D WT2=float2
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D INTER_LINEAR -D BORDER_CONSTANT -D T=uchar -D WT=float -D convertToT=convert_uchar_sat_rte -D convertToWT=convert_float -D convertToWT2=convert_float2 -D WT2=float2" %cfg_path --cl-device=%cl_device 2>&1
