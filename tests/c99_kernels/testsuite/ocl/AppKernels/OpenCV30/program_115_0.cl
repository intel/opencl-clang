...
// buildOptions= -D INTEL_DEVICE -D LN -D T=uchar4 -D WT=int -D WTV=int4 -D convertToWTV=convert_int4 -D convertToT=convert_uchar4_sat_rte
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D LN -D T=uchar4 -D WT=int -D WTV=int4 -D convertToWTV=convert_int4 -D convertToT=convert_uchar4_sat_rte" %cfg_path --cl-device=%cl_device 2>&1
