...
// buildOptions= -D INTEL_DEVICE -D GENTYPE=uchar -D BORDER_REPLICATE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D GENTYPE=uchar -D BORDER_REPLICATE" %cfg_path --cl-device=%cl_device 2>&1
