...
// buildOptions= -D INTEL_DEVICE -D T=uchar4 -D WT=short4 -D convertToT=convert_uchar4_sat_rte -D FUNC_ABS_DIFF -D convertToWT=convert_short4
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D T=uchar4 -D WT=short4 -D convertToT=convert_uchar4_sat_rte -D FUNC_ABS_DIFF -D convertToWT=convert_short4" %cfg_path --cl-device=%cl_device 2>&1
