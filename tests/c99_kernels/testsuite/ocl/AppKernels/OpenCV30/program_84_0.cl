...
// buildOptions= -D INTEL_DEVICE -D GENTYPE=uchar4 -D BORDER_REFLECT
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D GENTYPE=uchar4 -D BORDER_REFLECT" %cfg_path --cl-device=%cl_device 2>&1
