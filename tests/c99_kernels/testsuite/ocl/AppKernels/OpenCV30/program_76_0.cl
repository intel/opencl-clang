...
// buildOptions= -D INTEL_DEVICE -D BLK_X=16 -D BLK_Y=16 -D RADIUSX=3 -D RADIUSY=3 -D KERNEL_MATRIX_X=0x3d000000,0x3de00000,0x3e600000,0x3e900000,0x3e600000,0x3de00000,0x3d000000,0x0 -D KERNEL_MATRIX_Y=0x3d000000,0x3de00000,0x3e600000,0x3e900000,0x3e600000,0x3de00000,0x3d000000,0x0 -D SRCTYPE=float -D CONVERT_SRCTYPE= -D WORKTYPE=float -D DSTTYPE=float -D CONVERT_DSTTYPE= -D BORDER_REFLECT_101
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D BLK_X=16 -D BLK_Y=16 -D RADIUSX=3 -D RADIUSY=3 -D KERNEL_MATRIX_X=0x3d000000,0x3de00000,0x3e600000,0x3e900000,0x3e600000,0x3de00000,0x3d000000,0x0 -D KERNEL_MATRIX_Y=0x3d000000,0x3de00000,0x3e600000,0x3e900000,0x3e600000,0x3de00000,0x3d000000,0x0 -D SRCTYPE=float -D CONVERT_SRCTYPE= -D WORKTYPE=float -D DSTTYPE=float -D CONVERT_DSTTYPE= -D BORDER_REFLECT_101" %cfg_path --cl-device=%cl_device 2>&1
