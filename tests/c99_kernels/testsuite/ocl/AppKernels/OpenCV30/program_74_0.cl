...
// buildOptions= -D INTEL_DEVICE -D BLK_X=16 -D BLK_Y=16 -D RADIUSX=1 -D RADIUSY=1 -D KERNEL_MATRIX_X=0xbf800000,0x0,0x3f800000,0x0 -D KERNEL_MATRIX_Y=0x40400000,0x41200000,0x40400000,0x0 -D SRCTYPE=uchar -D CONVERT_SRCTYPE=convert_float -D WORKTYPE=float -D DSTTYPE=uchar -D CONVERT_DSTTYPE=convert_uchar_sat -D BORDER_REFLECT_101
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D BLK_X=16 -D BLK_Y=16 -D RADIUSX=1 -D RADIUSY=1 -D KERNEL_MATRIX_X=0xbf800000,0x0,0x3f800000,0x0 -D KERNEL_MATRIX_Y=0x40400000,0x41200000,0x40400000,0x0 -D SRCTYPE=uchar -D CONVERT_SRCTYPE=convert_float -D WORKTYPE=float -D DSTTYPE=uchar -D CONVERT_DSTTYPE=convert_uchar_sat -D BORDER_REFLECT_101" %cfg_path --cl-device=%cl_device 2>&1
