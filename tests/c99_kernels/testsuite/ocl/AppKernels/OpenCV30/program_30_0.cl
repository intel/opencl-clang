...
// buildOptions= -D INTEL_DEVICE -D Operation=& -D vloadn=vload4 -D vstoren=vstore4 -D elemSize=4 -D vlen=4 -D ucharv=uchar4
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D Operation=& -D vloadn=vload4 -D vstoren=vstore4 -D elemSize=4 -D vlen=4 -D ucharv=uchar4" %cfg_path --cl-device=%cl_device 2>&1
