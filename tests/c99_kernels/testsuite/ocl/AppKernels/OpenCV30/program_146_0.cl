...
// buildOptions= -D INTEL_DEVICE -D srcT=float -D dstT=float -D convertToDstT=convert_float -D BINARY
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D srcT=float -D dstT=float -D convertToDstT=convert_float -D BINARY" %cfg_path --cl-device=%cl_device 2>&1
