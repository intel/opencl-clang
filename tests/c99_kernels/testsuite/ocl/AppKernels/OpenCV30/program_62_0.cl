...
// buildOptions= -D INTEL_DEVICE -D DEPTH_0 -D dcn=3 -D bidx=2
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D DEPTH_0 -D dcn=3 -D bidx=2" %cfg_path --cl-device=%cl_device 2>&1
