...
// buildOptions= -D INTEL_DEVICE -D T=uchar -D WT=short -D convertToT=convert_uchar_sat_rte -D FUNC_ADD -D convertToWT=convert_short
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D T=uchar -D WT=short -D convertToT=convert_uchar_sat_rte -D FUNC_ADD -D convertToWT=convert_short" %cfg_path --cl-device=%cl_device 2>&1
