...
// buildOptions= -D INTEL_DEVICE -D T=uchar -D WT=float -D convertToT=convert_uchar_sat_rte -D FUNC_MUL -D convertToWT=convert_float
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D T=uchar -D WT=float -D convertToT=convert_uchar_sat_rte -D FUNC_MUL -D convertToWT=convert_float" %cfg_path --cl-device=%cl_device 2>&1
