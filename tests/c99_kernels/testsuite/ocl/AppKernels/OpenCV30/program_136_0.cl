...
// buildOptions= -D INTEL_DEVICE -D srcT=uchar -D dstT=float -D convertToDstType=
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D srcT=uchar -D dstT=float -D convertToDstType=" %cfg_path --cl-device=%cl_device 2>&1
