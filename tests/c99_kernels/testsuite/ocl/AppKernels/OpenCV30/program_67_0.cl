...
// buildOptions= -D INTEL_DEVICE -D RADIUSX=1 -D RADIUSY=1 -D LSIZE0=16 -D LSIZE1=16 -D ERODE -D RECTKERNEL -D VAL=255 -D GENTYPE=uchar4
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D RADIUSX=1 -D RADIUSY=1 -D LSIZE0=16 -D LSIZE1=16 -D ERODE -D RECTKERNEL -D VAL=255 -D GENTYPE=uchar4" %cfg_path --cl-device=%cl_device 2>&1
