...
// buildOptions= -D INTEL_DEVICE -D T=float -D Operation===
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D T=float -D Operation===" %cfg_path --cl-device=%cl_device 2>&1
