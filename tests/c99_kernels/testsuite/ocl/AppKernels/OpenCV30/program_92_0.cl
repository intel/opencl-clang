...
// buildOptions= -D INTEL_DEVICE -D BLK_X=16 -D BLK_Y=16 -D SRCTYPE=uchar -D BORDER_REFLECT
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D BLK_X=16 -D BLK_Y=16 -D SRCTYPE=uchar -D BORDER_REFLECT" %cfg_path --cl-device=%cl_device 2>&1
