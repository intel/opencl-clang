...
// buildOptions= -D INTEL_DEVICE -D GENTYPE=uchar4 -D BORDER_REFLECT_101
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D GENTYPE=uchar4 -D BORDER_REFLECT_101" %cfg_path --cl-device=%cl_device 2>&1
