...
// buildOptions= -D INTEL_DEVICE -D T=uchar4 -D WT=float4 -D convertToT=convert_uchar4_sat_rte -D FUNC_MUL -D convertToWT=convert_float4
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D T=uchar4 -D WT=float4 -D convertToT=convert_uchar4_sat_rte -D FUNC_MUL -D convertToWT=convert_float4" %cfg_path --cl-device=%cl_device 2>&1
