...
// buildOptions= -D INTEL_DEVICE -D T=uchar -D MAX_VAL=255 -D MIN_VAL=0
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D T=uchar -D MAX_VAL=255 -D MIN_VAL=0" %cfg_path --cl-device=%cl_device 2>&1
