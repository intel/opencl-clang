...
// buildOptions= -D INTEL_DEVICE -D T=uchar -D WT=float -D convertToT=convert_uchar_sat_rte
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D T=uchar -D WT=float -D convertToT=convert_uchar_sat_rte" %cfg_path --cl-device=%cl_device 2>&1
