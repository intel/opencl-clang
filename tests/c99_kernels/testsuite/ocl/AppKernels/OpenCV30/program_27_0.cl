...
// buildOptions= -D INTEL_DEVICE -D srcT=float -D dstT=int
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D srcT=float -D dstT=int" %cfg_path --cl-device=%cl_device 2>&1
