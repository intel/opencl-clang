...
// buildOptions= -D INTEL_DEVICE -D anX=3 -D anY=3 -D ksX=7 -D ksY=7 -D BORDER_REFLECT
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D anX=3 -D anY=3 -D ksX=7 -D ksY=7 -D BORDER_REFLECT" %cfg_path --cl-device=%cl_device 2>&1
