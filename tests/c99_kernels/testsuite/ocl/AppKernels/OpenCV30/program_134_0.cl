...
// buildOptions= -D INTEL_DEVICE -D TYPE=float -D TYPE4=float4 -D convert_TYPE4=convert_float4
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D TYPE=float -D TYPE4=float4 -D convert_TYPE4=convert_float4" %cfg_path --cl-device=%cl_device 2>&1
