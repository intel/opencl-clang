...
// buildOptions= -D INTEL_DEVICE -D T=short4 -D THRESH_TOZERO_INV
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D T=short4 -D THRESH_TOZERO_INV" %cfg_path --cl-device=%cl_device 2>&1
