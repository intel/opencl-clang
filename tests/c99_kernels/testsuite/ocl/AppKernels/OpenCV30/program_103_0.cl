...
// buildOptions= -D INTEL_DEVICE -D T=uchar -D THRESH_BINARY -D VECTORIZED -D VT=uchar4 -D VLOADN=vload4 -D VECSIZE=4 -D VSTOREN=vstore4 -D DST_ALIGNED -D SRC_ALIGNED
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D T=uchar -D THRESH_BINARY -D VECTORIZED -D VT=uchar4 -D VLOADN=vload4 -D VECSIZE=4 -D VSTOREN=vstore4 -D DST_ALIGNED -D SRC_ALIGNED" %cfg_path --cl-device=%cl_device 2>&1
