...
// buildOptions=-D BINARY_OP -D OP_PHASE_DEGREES -D dstT=float -D rowsPerWI=4 -D INTEL_DEVICE -dump-opt-llvm=core_Phase_program_1_0095442958.log
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D BINARY_OP -D OP_PHASE_DEGREES -D dstT=float -D rowsPerWI=4 -D INTEL_DEVICE -dump-opt-llvm=core_Phase_program_1_0095442958.log" %cfg_path --cl-device=%cl_device 2>&1
