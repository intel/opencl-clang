...
// buildOptions=-D BINARY_OP -D OP_MIN -D dstT=float -D dstT_C1=float -D workST=float -D cn=1 -D rowsPerWI=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D BINARY_OP -D OP_MIN -D dstT=float -D dstT_C1=float -D workST=float -D cn=1 -D rowsPerWI=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
