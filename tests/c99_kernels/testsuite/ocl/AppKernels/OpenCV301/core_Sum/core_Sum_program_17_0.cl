...
// buildOptions=-D srcT=ushort -D srcT1=ushort -D dstT=int -D dstTK=int -D dstT1=int -D ddepth=4 -D cn=1 -D convertToDT=convert_int -D OP_SUM -D WGS=256 -D WGS2_ALIGNED=128 -D HAVE_SRC_CONT -D kercn=1 -D convertFromU=convert_int -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D srcT=ushort -D srcT1=ushort -D dstT=int -D dstTK=int -D dstT1=int -D ddepth=4 -D cn=1 -D convertToDT=convert_int -D OP_SUM -D WGS=256 -D WGS2_ALIGNED=128 -D HAVE_SRC_CONT -D kercn=1 -D convertFromU=convert_int -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
