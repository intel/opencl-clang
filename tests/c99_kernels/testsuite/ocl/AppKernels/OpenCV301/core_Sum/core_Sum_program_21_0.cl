...
// buildOptions=-D srcT=ushort3 -D srcT1=ushort -D dstT=int3 -D dstTK=int3 -D dstT1=int -D ddepth=4 -D cn=3 -D convertToDT=convert_int3 -D OP_SUM -D WGS=256 -D WGS2_ALIGNED=128 -D HAVE_SRC_CONT -D kercn=1 -D convertFromU=convert_int3 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D srcT=ushort3 -D srcT1=ushort -D dstT=int3 -D dstTK=int3 -D dstT1=int -D ddepth=4 -D cn=3 -D convertToDT=convert_int3 -D OP_SUM -D WGS=256 -D WGS2_ALIGNED=128 -D HAVE_SRC_CONT -D kercn=1 -D convertFromU=convert_int3 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
