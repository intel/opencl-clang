...
// buildOptions=-D OP_MERGE -D cn=1 -D T=ulong -D DECLARE_SRC_PARAMS_N=DECLARE_SRC_PARAM(0) -D DECLARE_INDEX_N=DECLARE_INDEX(0) -D PROCESS_ELEMS_N=PROCESS_ELEM(0) -D scn0=1 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D OP_MERGE -D cn=1 -D T=ulong -D DECLARE_SRC_PARAMS_N=DECLARE_SRC_PARAM(0) -D DECLARE_INDEX_N=DECLARE_INDEX(0) -D PROCESS_ELEMS_N=PROCESS_ELEM(0) -D scn0=1 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
