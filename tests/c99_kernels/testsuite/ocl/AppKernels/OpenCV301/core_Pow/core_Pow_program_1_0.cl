...
// buildOptions=-D dstT=float -D depth=5 -D rowsPerWI=4 -D OP_POW -D UNARY_OP -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D dstT=float -D depth=5 -D rowsPerWI=4 -D OP_POW -D UNARY_OP -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
