...
// buildOptions=-D dstT=int -D rowsPerWI=4 -D dstST=int -D dstT1=int -D cn=1 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D dstT=int -D rowsPerWI=4 -D dstST=int -D dstT1=int -D cn=1 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
