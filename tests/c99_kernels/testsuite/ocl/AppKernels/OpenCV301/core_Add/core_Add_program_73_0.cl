...
// buildOptions=-D MASK_UNARY_OP -D OP_ADD -D srcT1=short -D srcT1_C1=short -D srcT2=int -D srcT2_C1=int -D dstT=short -D dstT_C1=short -D workT=int -D workST=int -D scaleT=int -D wdepth=4 -D convertToWT1=convert_int -D convertToWT2=noconvert -D convertToDT=convert_short_sat -D cn=1 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D MASK_UNARY_OP -D OP_ADD -D srcT1=short -D srcT1_C1=short -D srcT2=int -D srcT2_C1=int -D dstT=short -D dstT_C1=short -D workT=int -D workST=int -D scaleT=int -D wdepth=4 -D convertToWT1=convert_int -D convertToWT2=noconvert -D convertToDT=convert_short_sat -D cn=1 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
