...
// buildOptions=-D MASK_BINARY_OP -D OP_ADD -D srcT1=short3 -D srcT1_C1=short -D srcT2=short3 -D srcT2_C1=short -D dstT=short3 -D dstT_C1=short -D workT=int3 -D workST=int4 -D scaleT=int -D wdepth=4 -D convertToWT1=convert_int3 -D convertToWT2=convert_int3 -D convertToDT=convert_short3_sat -D cn=3 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D MASK_BINARY_OP -D OP_ADD -D srcT1=short3 -D srcT1_C1=short -D srcT2=short3 -D srcT2_C1=short -D dstT=short3 -D dstT_C1=short -D workT=int3 -D workST=int4 -D scaleT=int -D wdepth=4 -D convertToWT1=convert_int3 -D convertToWT2=convert_int3 -D convertToDT=convert_short3_sat -D cn=3 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
