...
// buildOptions=-D MASK_BINARY_OP -D OP_ADD -D srcT1=char4 -D srcT1_C1=char -D srcT2=char4 -D srcT2_C1=char -D dstT=char4 -D dstT_C1=char -D workT=int4 -D workST=int4 -D scaleT=int -D wdepth=4 -D convertToWT1=convert_int4 -D convertToWT2=convert_int4 -D convertToDT=convert_char4_sat -D cn=4 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D MASK_BINARY_OP -D OP_ADD -D srcT1=char4 -D srcT1_C1=char -D srcT2=char4 -D srcT2_C1=char -D dstT=char4 -D dstT_C1=char -D workT=int4 -D workST=int4 -D scaleT=int -D wdepth=4 -D convertToWT1=convert_int4 -D convertToWT2=convert_int4 -D convertToDT=convert_char4_sat -D cn=4 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
