...
// buildOptions=-D BINARY_OP -D OP_ADD -D srcT1=ushort -D srcT1_C1=ushort -D srcT2=ushort -D srcT2_C1=ushort -D dstT=ushort -D dstT_C1=ushort -D workT=int -D workST=int -D scaleT=int -D wdepth=4 -D convertToWT1=convert_int -D convertToWT2=convert_int -D convertToDT=convert_ushort_sat -D cn=1 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D BINARY_OP -D OP_ADD -D srcT1=ushort -D srcT1_C1=ushort -D srcT2=ushort -D srcT2_C1=ushort -D dstT=ushort -D dstT_C1=ushort -D workT=int -D workST=int -D scaleT=int -D wdepth=4 -D convertToWT1=convert_int -D convertToWT2=convert_int -D convertToDT=convert_ushort_sat -D cn=1 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
