...
// buildOptions=-D MASK_UNARY_OP -D OP_ADD -D srcT1=char -D srcT1_C1=char -D srcT2=int -D srcT2_C1=int -D dstT=char -D dstT_C1=char -D workT=int -D workST=int -D scaleT=int -D wdepth=4 -D convertToWT1=convert_int -D convertToWT2=noconvert -D convertToDT=convert_char_sat -D cn=1 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D MASK_UNARY_OP -D OP_ADD -D srcT1=char -D srcT1_C1=char -D srcT2=int -D srcT2_C1=int -D dstT=char -D dstT_C1=char -D workT=int -D workST=int -D scaleT=int -D wdepth=4 -D convertToWT1=convert_int -D convertToWT2=noconvert -D convertToDT=convert_char_sat -D cn=1 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
