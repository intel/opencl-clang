...
// buildOptions=-D INTER_NEAREST -D BORDER_REFLECT_101 -D T=uchar -D rowsPerWI=4 -D T=uchar -D T1=uchar -D cn=1 -D ST=uchar -D depth=0 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D INTER_NEAREST -D BORDER_REFLECT_101 -D T=uchar -D rowsPerWI=4 -D T=uchar -D T1=uchar -D cn=1 -D ST=uchar -D depth=0 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
