...
// buildOptions=-D INTER_NEAREST -D BORDER_REPLICATE -D T=ushort -D rowsPerWI=4 -D T=ushort -D T1=ushort -D cn=1 -D ST=ushort -D depth=2 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D INTER_NEAREST -D BORDER_REPLICATE -D T=ushort -D rowsPerWI=4 -D T=ushort -D T1=ushort -D cn=1 -D ST=ushort -D depth=2 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
