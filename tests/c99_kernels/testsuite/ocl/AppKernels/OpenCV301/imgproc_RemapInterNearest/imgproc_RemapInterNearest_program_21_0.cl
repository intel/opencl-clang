...
// buildOptions=-D INTER_NEAREST -D BORDER_CONSTANT -D T=ushort3 -D rowsPerWI=4 -D T=ushort3 -D T1=ushort -D cn=3 -D ST=ushort4 -D depth=2 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D INTER_NEAREST -D BORDER_CONSTANT -D T=ushort3 -D rowsPerWI=4 -D T=ushort3 -D T1=ushort -D cn=3 -D ST=ushort4 -D depth=2 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
