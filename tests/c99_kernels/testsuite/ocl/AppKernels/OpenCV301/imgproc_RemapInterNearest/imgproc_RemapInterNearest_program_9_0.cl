...
// buildOptions=-D INTER_NEAREST -D BORDER_REFLECT -D T=uchar3 -D rowsPerWI=4 -D T=uchar3 -D T1=uchar -D cn=3 -D ST=uchar4 -D depth=0 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D INTER_NEAREST -D BORDER_REFLECT -D T=uchar3 -D rowsPerWI=4 -D T=uchar3 -D T1=uchar -D cn=3 -D ST=uchar4 -D depth=0 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
