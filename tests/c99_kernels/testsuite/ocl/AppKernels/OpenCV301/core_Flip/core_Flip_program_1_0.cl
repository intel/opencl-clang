...
// buildOptions=-D T=uchar -D T1=uchar -D cn=1 -D PIX_PER_WI_Y=4 -D kercn=1 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D T=uchar -D T1=uchar -D cn=1 -D PIX_PER_WI_Y=4 -D kercn=1 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
