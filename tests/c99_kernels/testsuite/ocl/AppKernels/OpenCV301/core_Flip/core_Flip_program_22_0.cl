...
// buildOptions=-D T=ulong2 -D T1=ulong -D cn=2 -D PIX_PER_WI_Y=4 -D kercn=2 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D T=ulong2 -D T1=ulong -D cn=2 -D PIX_PER_WI_Y=4 -D kercn=2 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
