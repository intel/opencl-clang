...
// buildOptions=-D T=char3 -D T1=char -D cn=3 -D PIX_PER_WI_Y=4 -D kercn=3 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D T=char3 -D T1=char -D cn=3 -D PIX_PER_WI_Y=4 -D kercn=3 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
