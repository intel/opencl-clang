...
// buildOptions=-D DEPTH_3 -D srcT1=short -D HAVE_MASK -D WGS=256 -D srcT=short -D WGS2_ALIGNED=128 -D kercn=1 -D NEED_MAXVAL -D NEED_MAXLOC -D dstT1=int -D dstT=int -D convertToDT=convert_int -D HAVE_SRC2 -D wdepth=4 -D convertFromU=convert_int -D MINMAX_STRUCT_ALIGNMENT=8 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D DEPTH_3 -D srcT1=short -D HAVE_MASK -D WGS=256 -D srcT=short -D WGS2_ALIGNED=128 -D kercn=1 -D NEED_MAXVAL -D NEED_MAXLOC -D dstT1=int -D dstT=int -D convertToDT=convert_int -D HAVE_SRC2 -D wdepth=4 -D convertFromU=convert_int -D MINMAX_STRUCT_ALIGNMENT=8 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
