...
// buildOptions=-D DEPTH_3 -D srcT1=short -D WGS=256 -D srcT=short -D WGS2_ALIGNED=128 -D HAVE_SRC_CONT -D HAVE_MASK_CONT -D kercn=1 -D NEED_MAXVAL -D dstT1=int -D dstT=int -D convertToDT=convert_int -D OP_ABS -D wdepth=4 -D convertFromU=convert_int -D MINMAX_STRUCT_ALIGNMENT=8 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D DEPTH_3 -D srcT1=short -D WGS=256 -D srcT=short -D WGS2_ALIGNED=128 -D HAVE_SRC_CONT -D HAVE_MASK_CONT -D kercn=1 -D NEED_MAXVAL -D dstT1=int -D dstT=int -D convertToDT=convert_int -D OP_ABS -D wdepth=4 -D convertFromU=convert_int -D MINMAX_STRUCT_ALIGNMENT=8 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
