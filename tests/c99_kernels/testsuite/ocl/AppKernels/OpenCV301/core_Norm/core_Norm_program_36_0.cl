...
// buildOptions=-D DEPTH_1 -D srcT1=char -D HAVE_MASK -D WGS=256 -D srcT=char3 -D WGS2_ALIGNED=128 -D kercn=3 -D NEED_MAXVAL -D NEED_MAXLOC -D dstT1=int -D dstT=int3 -D convertToDT=convert_int3 -D OP_ABS -D wdepth=4 -D convertFromU=convert_int3 -D MINMAX_STRUCT_ALIGNMENT=8 -D INTEL_DEVICE
