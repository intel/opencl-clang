...
// buildOptions=-D DEPTH_5 -D srcT1=float -D HAVE_MASK -D WGS=256 -D srcT=float4 -D WGS2_ALIGNED=128 -D kercn=4 -D NEED_MAXVAL -D NEED_MAXLOC -D dstT1=float -D dstT=float4 -D convertToDT=noconvert -D HAVE_SRC2 -D wdepth=5 -D convertFromU=noconvert -D MINMAX_STRUCT_ALIGNMENT=8 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D DEPTH_5 -D srcT1=float -D HAVE_MASK -D WGS=256 -D srcT=float4 -D WGS2_ALIGNED=128 -D kercn=4 -D NEED_MAXVAL -D NEED_MAXLOC -D dstT1=float -D dstT=float4 -D convertToDT=noconvert -D HAVE_SRC2 -D wdepth=5 -D convertFromU=noconvert -D MINMAX_STRUCT_ALIGNMENT=8 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
