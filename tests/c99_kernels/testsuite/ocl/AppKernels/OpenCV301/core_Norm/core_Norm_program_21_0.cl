...
// buildOptions=-D DEPTH_5 -D srcT1=float -D WGS=256 -D srcT=float -D WGS2_ALIGNED=128 -D HAVE_SRC_CONT -D HAVE_MASK_CONT -D kercn=1 -D NEED_MAXVAL -D dstT1=float -D dstT=float -D convertToDT=noconvert -D OP_ABS -D wdepth=5 -D convertFromU=noconvert -D MINMAX_STRUCT_ALIGNMENT=8 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D DEPTH_5 -D srcT1=float -D WGS=256 -D srcT=float -D WGS2_ALIGNED=128 -D HAVE_SRC_CONT -D HAVE_MASK_CONT -D kercn=1 -D NEED_MAXVAL -D dstT1=float -D dstT=float -D convertToDT=noconvert -D OP_ABS -D wdepth=5 -D convertFromU=noconvert -D MINMAX_STRUCT_ALIGNMENT=8 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
