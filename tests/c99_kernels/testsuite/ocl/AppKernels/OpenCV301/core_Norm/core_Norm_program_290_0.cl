...
// buildOptions=-D DEPTH_2 -D srcT1=ushort -D HAVE_MASK -D WGS=256 -D srcT=ushort3 -D WGS2_ALIGNED=128 -D HAVE_SRC_CONT -D HAVE_MASK_CONT -D kercn=3 -D NEED_MAXVAL -D NEED_MAXLOC -D dstT1=int -D dstT=int3 -D convertToDT=convert_int3 -D HAVE_SRC2 -D OP_CALC2 -D HAVE_SRC2_CONT -D wdepth=4 -D convertFromU=convert_int3 -D MINMAX_STRUCT_ALIGNMENT=8 -D INTEL_DEVICE
