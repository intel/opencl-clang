...
// buildOptions=-D srcT=char2 -D srcT1=char -D dstT=int2 -D dstTK=int2 -D dstT1=int -D ddepth=4 -D cn=2 -D convertToDT=convert_int2 -D OP_SUM -D WGS=256 -D WGS2_ALIGNED=128 -D kercn=1 -D HAVE_SRC2 -D convertFromU=convert_int2 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D srcT=char2 -D srcT1=char -D dstT=int2 -D dstTK=int2 -D dstT1=int -D ddepth=4 -D cn=2 -D convertToDT=convert_int2 -D OP_SUM -D WGS=256 -D WGS2_ALIGNED=128 -D kercn=1 -D HAVE_SRC2 -D convertFromU=convert_int2 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
