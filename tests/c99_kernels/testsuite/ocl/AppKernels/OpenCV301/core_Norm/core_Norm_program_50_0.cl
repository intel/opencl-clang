...
// buildOptions=-D DEPTH_3 -D srcT1=short -D HAVE_MASK -D WGS=256 -D srcT=short2 -D WGS2_ALIGNED=128 -D kercn=2 -D NEED_MAXVAL -D NEED_MAXLOC -D dstT1=int -D dstT=int2 -D convertToDT=convert_int2 -D OP_ABS -D wdepth=4 -D convertFromU=convert_int2 -D MINMAX_STRUCT_ALIGNMENT=8 -D INTEL_DEVICE
