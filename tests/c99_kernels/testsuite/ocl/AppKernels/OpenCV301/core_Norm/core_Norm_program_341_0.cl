...
// buildOptions=-D srcT=uchar4 -D srcT1=uchar -D dstT=int4 -D dstTK=int4 -D dstT1=int -D ddepth=4 -D cn=4 -D convertToDT=convert_int4 -D OP_SUM -D WGS=256 -D WGS2_ALIGNED=128 -D HAVE_SRC_CONT -D kercn=1 -D HAVE_SRC2 -D HAVE_SRC2_CONT -D convertFromU=convert_int4 -D INTEL_DEVICE
