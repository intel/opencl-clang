...
// buildOptions=-D srcT=int -D srcT1=int -D dstT=int -D dstTK=int -D dstT1=int -D ddepth=4 -D cn=1 -D convertToDT=noconvert -D OP_SUM_ABS -D WGS=256 -D WGS2_ALIGNED=128 -D HAVE_MASK -D kercn=1 -D convertFromU=convert_int -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D srcT=int -D srcT1=int -D dstT=int -D dstTK=int -D dstT1=int -D ddepth=4 -D cn=1 -D convertToDT=noconvert -D OP_SUM_ABS -D WGS=256 -D WGS2_ALIGNED=128 -D HAVE_MASK -D kercn=1 -D convertFromU=convert_int -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
