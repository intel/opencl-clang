...
// buildOptions=-D DEPTH_0 -D srcT1=uchar -D WGS=256 -D srcT=uchar4 -D WGS2_ALIGNED=128 -D HAVE_MASK_CONT -D kercn=4 -D NEED_MAXVAL -D dstT1=int -D dstT=int4 -D convertToDT=convert_int4 -D HAVE_SRC2 -D wdepth=4 -D convertFromU=convert_int4 -D MINMAX_STRUCT_ALIGNMENT=8 -D INTEL_DEVICE
