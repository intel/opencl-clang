...
// buildOptions=-D DEPTH_0 -D srcT1=uchar -D HAVE_MASK -D WGS=256 -D srcT=uchar2 -D WGS2_ALIGNED=128 -D kercn=2 -D NEED_MAXVAL -D NEED_MAXLOC -D dstT1=int -D dstT=int2 -D convertToDT=convert_int2 -D HAVE_SRC2 -D OP_CALC2 -D wdepth=4 -D convertFromU=convert_int2 -D MINMAX_STRUCT_ALIGNMENT=8 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D DEPTH_0 -D srcT1=uchar -D HAVE_MASK -D WGS=256 -D srcT=uchar2 -D WGS2_ALIGNED=128 -D kercn=2 -D NEED_MAXVAL -D NEED_MAXLOC -D dstT1=int -D dstT=int2 -D convertToDT=convert_int2 -D HAVE_SRC2 -D OP_CALC2 -D wdepth=4 -D convertFromU=convert_int2 -D MINMAX_STRUCT_ALIGNMENT=8 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
