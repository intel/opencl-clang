...
// buildOptions=-D srcT=int4 -D srcT1=int -D dstT=int4 -D dstTK=int4 -D dstT1=int -D ddepth=4 -D cn=4 -D convertToDT=noconvert -D OP_SUM_ABS -D WGS=256 -D WGS2_ALIGNED=128 -D HAVE_MASK -D HAVE_SRC_CONT -D HAVE_MASK_CONT -D kercn=1 -D convertFromU=convert_int4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D srcT=int4 -D srcT1=int -D dstT=int4 -D dstTK=int4 -D dstT1=int -D ddepth=4 -D cn=4 -D convertToDT=noconvert -D OP_SUM_ABS -D WGS=256 -D WGS2_ALIGNED=128 -D HAVE_MASK -D HAVE_SRC_CONT -D HAVE_MASK_CONT -D kercn=1 -D convertFromU=convert_int4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
