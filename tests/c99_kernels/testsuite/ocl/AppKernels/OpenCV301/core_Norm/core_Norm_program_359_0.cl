...
// buildOptions=-D srcT=char4 -D srcT1=char -D dstT=int4 -D dstTK=int4 -D dstT1=int -D ddepth=4 -D cn=4 -D convertToDT=convert_int4 -D OP_SUM -D WGS=256 -D WGS2_ALIGNED=128 -D kercn=1 -D HAVE_SRC2 -D convertFromU=convert_int4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D srcT=char4 -D srcT1=char -D dstT=int4 -D dstTK=int4 -D dstT1=int -D ddepth=4 -D cn=4 -D convertToDT=convert_int4 -D OP_SUM -D WGS=256 -D WGS2_ALIGNED=128 -D kercn=1 -D HAVE_SRC2 -D convertFromU=convert_int4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
