...
// buildOptions=-D DEPTH_2 -D srcT1=ushort -D HAVE_MASK -D WGS=256 -D srcT=ushort4 -D WGS2_ALIGNED=128 -D kercn=4 -D NEED_MAXVAL -D NEED_MAXLOC -D dstT1=int -D dstT=int4 -D convertToDT=convert_int4 -D wdepth=4 -D convertFromU=convert_int4 -D MINMAX_STRUCT_ALIGNMENT=8 -D INTEL_DEVICE
