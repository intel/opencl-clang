...
// buildOptions=-D srcT=ushort2 -D srcT1=ushort -D dstT=int2 -D dstTK=int2 -D dstT1=int -D ddepth=4 -D cn=2 -D convertToDT=convert_int2 -D OP_SUM -D WGS=256 -D WGS2_ALIGNED=128 -D HAVE_SRC_CONT -D kercn=1 -D HAVE_SRC2 -D OP_CALC2 -D HAVE_SRC2_CONT -D convertFromU=convert_int2 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D srcT=ushort2 -D srcT1=ushort -D dstT=int2 -D dstTK=int2 -D dstT1=int -D ddepth=4 -D cn=2 -D convertToDT=convert_int2 -D OP_SUM -D WGS=256 -D WGS2_ALIGNED=128 -D HAVE_SRC_CONT -D kercn=1 -D HAVE_SRC2 -D OP_CALC2 -D HAVE_SRC2_CONT -D convertFromU=convert_int2 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
