...
// buildOptions=-D DEPTH_1 -D srcT1=char -D WGS=256 -D srcT=char2 -D WGS2_ALIGNED=128 -D HAVE_SRC_CONT -D HAVE_MASK_CONT -D kercn=2 -D NEED_MAXVAL -D dstT1=int -D dstT=int2 -D convertToDT=convert_int2 -D HAVE_SRC2 -D OP_CALC2 -D HAVE_SRC2_CONT -D wdepth=4 -D convertFromU=convert_int2 -D MINMAX_STRUCT_ALIGNMENT=8 -D INTEL_DEVICE
