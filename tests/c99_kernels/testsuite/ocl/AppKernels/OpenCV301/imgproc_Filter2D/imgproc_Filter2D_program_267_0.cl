...
// buildOptions=-D LOCAL_SIZE=128 -D cn=2 -D ANCHOR_X=2 -D ANCHOR_Y=4 -D KERNEL_SIZE_X=5 -D KERNEL_SIZE_Y=5 -D KERNEL_SIZE_Y2_ALIGNED=12 -D BORDER_REFLECT_101 -D NO_EXTRA_EXTRAPOLATION -D NO_BORDER_ISOLATED -D COEFF=DIG(-0.05276617780f)DIG(-0.04470018670f)DIG(-0.01594762318f)DIG(-0.05306454748f)DIG(0.02005895041f)DIG(-0.05276617780f)DIG(-0.04470018670f)DIG(-0.01594762318f)DIG(-0.05306454748f)DIG(0.02005895041f)DIG(0.0000000000f)DIG(0.0000000000f)DIG(-0.02600976266f)DIG(-0.07384630293f)DIG(-0.02897979878f)DIG(-0.02242335863f)DIG(-0.06834634393f)DIG(-0.02600976266f)DIG(-0.07384630293f)DIG(-0.02897979878f)DIG(-0.02242335863f)DIG(-0.06834634393f)DIG(0.0000000000f)DIG(0.0000000000f)DIG(0.05077016354f)DIG(-0.03577987105f)DIG(0.04538633674f)DIG(-0.05935856327f)DIG(-0.03985077888f)DIG(0.05077016354f)DIG(-0.03577987105f)DIG(0.04538633674f)DIG(-0.05935856327f)DIG(-0.03985077888f)DIG(0.0000000000f)DIG(0.0000000000f)DIG(-0.03640502691f)DIG(0.06885126978f)DIG(0.01110663824f)DIG(0.06730707735f)DIG(0.04123077169f)DIG(-0.03640502691f)DIG(0.06885126978f)DIG(0.01110663824f)DIG(0.06730707735f)DIG(0.04123077169f)DIG(0.0000000000f)DIG(0.0000000000f)DIG(0.06652115285f)DIG(-0.001180781052f)DIG(0.002152414527f)DIG(-0.03550439700f)DIG(-0.03245172277f)DIG(0.06652115285f)DIG(-0.001180781052f)DIG(0.002152414527f)DIG(-0.03550439700f)DIG(-0.03245172277f)DIG(0.0000000000f)DIG(0.0000000000f) -D srcT=ushort2 -D srcT1=ushort -D dstT=ushort2 -D dstT1=ushort -D WT=float2 -D WT1=float -D convertToWT=convert_float2 -D convertToDstT=convert_ushort2_sat_rte -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D LOCAL_SIZE=128 -D cn=2 -D ANCHOR_X=2 -D ANCHOR_Y=4 -D KERNEL_SIZE_X=5 -D KERNEL_SIZE_Y=5 -D KERNEL_SIZE_Y2_ALIGNED=12 -D BORDER_REFLECT_101 -D NO_EXTRA_EXTRAPOLATION -D NO_BORDER_ISOLATED -D COEFF=DIG(-0.05276617780f)DIG(-0.04470018670f)DIG(-0.01594762318f)DIG(-0.05306454748f)DIG(0.02005895041f)DIG(-0.05276617780f)DIG(-0.04470018670f)DIG(-0.01594762318f)DIG(-0.05306454748f)DIG(0.02005895041f)DIG(0.0000000000f)DIG(0.0000000000f)DIG(-0.02600976266f)DIG(-0.07384630293f)DIG(-0.02897979878f)DIG(-0.02242335863f)DIG(-0.06834634393f)DIG(-0.02600976266f)DIG(-0.07384630293f)DIG(-0.02897979878f)DIG(-0.02242335863f)DIG(-0.06834634393f)DIG(0.0000000000f)DIG(0.0000000000f)DIG(0.05077016354f)DIG(-0.03577987105f)DIG(0.04538633674f)DIG(-0.05935856327f)DIG(-0.03985077888f)DIG(0.05077016354f)DIG(-0.03577987105f)DIG(0.04538633674f)DIG(-0.05935856327f)DIG(-0.03985077888f)DIG(0.0000000000f)DIG(0.0000000000f)DIG(-0.03640502691f)DIG(0.06885126978f)DIG(0.01110663824f)DIG(0.06730707735f)DIG(0.04123077169f)DIG(-0.03640502691f)DIG(0.06885126978f)DIG(0.01110663824f)DIG(0.06730707735f)DIG(0.04123077169f)DIG(0.0000000000f)DIG(0.0000000000f)DIG(0.06652115285f)DIG(-0.001180781052f)DIG(0.002152414527f)DIG(-0.03550439700f)DIG(-0.03245172277f)DIG(0.06652115285f)DIG(-0.001180781052f)DIG(0.002152414527f)DIG(-0.03550439700f)DIG(-0.03245172277f)DIG(0.0000000000f)DIG(0.0000000000f) -D srcT=ushort2 -D srcT1=ushort -D dstT=ushort2 -D dstT1=ushort -D WT=float2 -D WT1=float -D convertToWT=convert_float2 -D convertToDstT=convert_ushort2_sat_rte -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
