...
// buildOptions=-D UNARY_OP -D srcT1=char2 -D dstT=uchar2 -D workT=srcT1 -D cn=2 -D convertToDT=convert_uchar2_sat -D OP_CMP -D CMP_OPERATOR=> -D srcT1_C1=char -D srcT2_C1=char -D dstT_C1=uchar -D workST=char2 -D rowsPerWI=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D UNARY_OP -D srcT1=char2 -D dstT=uchar2 -D workT=srcT1 -D cn=2 -D convertToDT=convert_uchar2_sat -D OP_CMP -D CMP_OPERATOR=> -D srcT1_C1=char -D srcT2_C1=char -D dstT_C1=uchar -D workST=char2 -D rowsPerWI=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
