...
// buildOptions=-D UNARY_OP -D srcT1=char4 -D dstT=uchar4 -D workT=srcT1 -D cn=4 -D convertToDT=convert_uchar4_sat -D OP_CMP -D CMP_OPERATOR=> -D srcT1_C1=char -D srcT2_C1=char -D dstT_C1=uchar -D workST=char4 -D rowsPerWI=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D UNARY_OP -D srcT1=char4 -D dstT=uchar4 -D workT=srcT1 -D cn=4 -D convertToDT=convert_uchar4_sat -D OP_CMP -D CMP_OPERATOR=> -D srcT1_C1=char -D srcT2_C1=char -D dstT_C1=uchar -D workST=char4 -D rowsPerWI=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
