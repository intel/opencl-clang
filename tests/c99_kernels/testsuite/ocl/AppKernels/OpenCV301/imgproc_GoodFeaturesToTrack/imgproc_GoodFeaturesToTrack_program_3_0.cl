...
// buildOptions=-D OP_MAX_EIGEN_VAL -D WGS=256 -D groupnum=20 -D WGS2_ALIGNED=128 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D OP_MAX_EIGEN_VAL -D WGS=256 -D groupnum=20 -D WGS2_ALIGNED=128 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
