...
// buildOptions=-D cn=3 -D ANCHOR_X=3 -D ANCHOR_Y=3 -D KERNEL_SIZE_X=7 -D KERNEL_SIZE_Y=7 -D PX_LOAD_VEC_SIZE=3 -D PX_LOAD_NUM_PX=1 -D DEPTH_0 -D PX_PER_WI_X=1 -D PX_PER_WI_Y=1 -D PRIV_DATA_WIDTH=7 -D BORDER_CONSTANT -D NO_BORDER_ISOLATED -D PX_LOAD_X_ITERATIONS=7 -D PX_LOAD_Y_ITERATIONS=7 -D srcT=uchar3 -D srcT1=uchar -D dstT=srcT -D dstT1=srcT1 -D WT=srcT -D WT1=srcT1 -D convertToWT=noconvert -D convertToDstT=noconvert -D PX_LOAD_FLOAT_VEC_CONV=convert_uchar3 -D PROCESS_ELEM_=PROCESS(0,0)PROCESS(0,1)PROCESS(0,2)PROCESS(0,3)PROCESS(0,4)PROCESS(0,5)PROCESS(0,6)PROCESS(1,0)PROCESS(1,1)PROCESS(1,2)PROCESS(1,3)PROCESS(1,4)PROCESS(1,5)PROCESS(1,6)PROCESS(2,0)PROCESS(2,1)PROCESS(2,2)PROCESS(2,3)PROCESS(2,4)PROCESS(2,5)PROCESS(2,6)PROCESS(3,0)PROCESS(3,1)PROCESS(3,2)PROCESS(3,3)PROCESS(3,4)PROCESS(3,5)PROCESS(3,6)PROCESS(4,0)PROCESS(4,1)PROCESS(4,2)PROCESS(4,3)PROCESS(4,4)PROCESS(4,5)PROCESS(4,6)PROCESS(5,0)PROCESS(5,1)PROCESS(5,2)PROCESS(5,3)PROCESS(5,4)PROCESS(5,5)PROCESS(5,6)PROCESS(6,0)PROCESS(6,1)PROCESS(6,2)PROCESS(6,3)PROCESS(6,4)PROCESS(6,5)PROCESS(6,6) -D OP_DILATE -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D cn=3 -D ANCHOR_X=3 -D ANCHOR_Y=3 -D KERNEL_SIZE_X=7 -D KERNEL_SIZE_Y=7 -D PX_LOAD_VEC_SIZE=3 -D PX_LOAD_NUM_PX=1 -D DEPTH_0 -D PX_PER_WI_X=1 -D PX_PER_WI_Y=1 -D PRIV_DATA_WIDTH=7 -D BORDER_CONSTANT -D NO_BORDER_ISOLATED -D PX_LOAD_X_ITERATIONS=7 -D PX_LOAD_Y_ITERATIONS=7 -D srcT=uchar3 -D srcT1=uchar -D dstT=srcT -D dstT1=srcT1 -D WT=srcT -D WT1=srcT1 -D convertToWT=noconvert -D convertToDstT=noconvert -D PX_LOAD_FLOAT_VEC_CONV=convert_uchar3 -D PROCESS_ELEM_=PROCESS(0,0)PROCESS(0,1)PROCESS(0,2)PROCESS(0,3)PROCESS(0,4)PROCESS(0,5)PROCESS(0,6)PROCESS(1,0)PROCESS(1,1)PROCESS(1,2)PROCESS(1,3)PROCESS(1,4)PROCESS(1,5)PROCESS(1,6)PROCESS(2,0)PROCESS(2,1)PROCESS(2,2)PROCESS(2,3)PROCESS(2,4)PROCESS(2,5)PROCESS(2,6)PROCESS(3,0)PROCESS(3,1)PROCESS(3,2)PROCESS(3,3)PROCESS(3,4)PROCESS(3,5)PROCESS(3,6)PROCESS(4,0)PROCESS(4,1)PROCESS(4,2)PROCESS(4,3)PROCESS(4,4)PROCESS(4,5)PROCESS(4,6)PROCESS(5,0)PROCESS(5,1)PROCESS(5,2)PROCESS(5,3)PROCESS(5,4)PROCESS(5,5)PROCESS(5,6)PROCESS(6,0)PROCESS(6,1)PROCESS(6,2)PROCESS(6,3)PROCESS(6,4)PROCESS(6,5)PROCESS(6,6) -D OP_DILATE -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
