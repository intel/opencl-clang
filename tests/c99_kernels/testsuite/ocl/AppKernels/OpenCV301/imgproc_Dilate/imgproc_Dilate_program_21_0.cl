...
// buildOptions=-D RADIUSX=2 -D RADIUSY=2 -D LSIZE0=16 -D LSIZE1=16 -D OP_DILATE -D PROCESS_ELEMS=PROCESS(0,0)PROCESS(0,1)PROCESS(0,2)PROCESS(0,3)PROCESS(0,4)PROCESS(1,0)PROCESS(1,1)PROCESS(1,2)PROCESS(2,0)PROCESS(2,4)PROCESS(3,0)PROCESS(3,1)PROCESS(3,3)PROCESS(3,4)PROCESS(4,0)PROCESS(4,1)PROCESS(4,2)PROCESS(4,4) -D T=uchar4 -D DEPTH_0 -D cn=4 -D T1=uchar -D convertToWT=convert_float4 -D convertToT=convert_uchar4_sat_rte -D ST=uchar4 -D INTEL_DEVICE
