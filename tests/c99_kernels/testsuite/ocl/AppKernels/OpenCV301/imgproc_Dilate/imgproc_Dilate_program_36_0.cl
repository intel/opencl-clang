...
// buildOptions=-D RADIUSX=3 -D RADIUSY=3 -D LSIZE0=16 -D LSIZE1=16 -D OP_DILATE -D PROCESS_ELEMS=PROCESS(0,0)PROCESS(0,1)PROCESS(0,2)PROCESS(0,3)PROCESS(0,4)PROCESS(0,5)PROCESS(0,6)PROCESS(1,0)PROCESS(1,3)PROCESS(2,0)PROCESS(2,1)PROCESS(2,2)PROCESS(2,4)PROCESS(2,5)PROCESS(2,6)PROCESS(3,0)PROCESS(3,1)PROCESS(3,3)PROCESS(3,5)PROCESS(3,6)PROCESS(4,1)PROCESS(4,2)PROCESS(4,3)PROCESS(4,5)PROCESS(4,6)PROCESS(5,0)PROCESS(5,2)PROCESS(5,3)PROCESS(5,5)PROCESS(6,0)PROCESS(6,1)PROCESS(6,2)PROCESS(6,4)PROCESS(6,6) -D T=float3 -D DEPTH_5 -D cn=3 -D T1=float -D convertToWT=noconvert -D convertToT=noconvert -D ST=float4 -D INTEL_DEVICE
