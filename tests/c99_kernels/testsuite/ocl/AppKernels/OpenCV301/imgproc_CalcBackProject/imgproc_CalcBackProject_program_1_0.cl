...
// buildOptions=-D histdims=1 -D scn=3 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D histdims=1 -D scn=3 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
