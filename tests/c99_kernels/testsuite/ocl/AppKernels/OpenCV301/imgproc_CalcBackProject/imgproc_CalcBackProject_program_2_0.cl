...
// buildOptions=-D histdims=2 -D scn1=3 -D scn2=2 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D histdims=2 -D scn1=3 -D scn2=2 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
