...
// buildOptions=-D T=ushort -D DECLARE_INPUT_MAT_N=DECLARE_INPUT_MAT(0)DECLARE_INPUT_MAT(1)DECLARE_INPUT_MAT(2)DECLARE_INPUT_MAT(3) -D DECLARE_OUTPUT_MAT_N=DECLARE_OUTPUT_MAT(0)DECLARE_OUTPUT_MAT(1)DECLARE_OUTPUT_MAT(2)DECLARE_OUTPUT_MAT(3) -D PROCESS_ELEM_N=PROCESS_ELEM(0)PROCESS_ELEM(1)PROCESS_ELEM(2)PROCESS_ELEM(3) -D DECLARE_INDEX_N=DECLARE_INDEX(0)DECLARE_INDEX(1)DECLARE_INDEX(2)DECLARE_INDEX(3) -D scn0=3 -D dcn0=2 -D scn1=3 -D dcn1=2 -D scn2=4 -D dcn2=2 -D scn3=4 -D dcn3=1 -D INTEL_DEVICE
