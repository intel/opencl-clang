...
// buildOptions=-D COPY_TO_MASK -D T1=ulong -D scn=3 -D mcn=1 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D COPY_TO_MASK -D T1=ulong -D scn=3 -D mcn=1 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
