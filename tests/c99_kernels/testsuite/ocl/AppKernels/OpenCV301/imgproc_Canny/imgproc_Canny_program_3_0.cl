...
// buildOptions=-D GET_EDGES -D PIX_PER_WI=8 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D GET_EDGES -D PIX_PER_WI=8 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
