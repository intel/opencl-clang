...
// buildOptions=-D WITH_SOBEL -D cn=1 -D TYPE=uchar -D convert_floatN=convert_float -D floatN=float -D GRP_SIZEX=32 -D GRP_SIZEY=8 -D L2GRAD -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D WITH_SOBEL -D cn=1 -D TYPE=uchar -D convert_floatN=convert_float -D floatN=float -D GRP_SIZEX=32 -D GRP_SIZEY=8 -D L2GRAD -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
