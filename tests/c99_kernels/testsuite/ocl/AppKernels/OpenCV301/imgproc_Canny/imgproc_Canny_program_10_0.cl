...
// buildOptions=-D WITHOUT_SOBEL -D cn=3 -D GRP_SIZEX=32 -D GRP_SIZEY=8 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D WITHOUT_SOBEL -D cn=3 -D GRP_SIZEX=32 -D GRP_SIZEY=8 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
