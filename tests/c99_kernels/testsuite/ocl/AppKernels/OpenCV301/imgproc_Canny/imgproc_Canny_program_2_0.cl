...
// buildOptions=-D STAGE2 -D PIX_PER_WI=8 -D LOCAL_X=32 -D LOCAL_Y=1 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D STAGE2 -D PIX_PER_WI=8 -D LOCAL_X=32 -D LOCAL_Y=1 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
