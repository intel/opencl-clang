...
// buildOptions=-D T=float -D TN=float -D kercn=1 -D T_FLOAT -D DIST_TYPE=2 -D BLOCK_SIZE=16 -D MAX_DESC_LEN=128 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D T=float -D TN=float -D kercn=1 -D T_FLOAT -D DIST_TYPE=2 -D BLOCK_SIZE=16 -D MAX_DESC_LEN=128 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
