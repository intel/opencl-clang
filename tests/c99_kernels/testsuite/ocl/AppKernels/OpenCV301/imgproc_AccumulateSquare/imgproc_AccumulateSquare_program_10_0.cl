...
// buildOptions=-D ACCUMULATE_SQUARE -D HAVE_MASK -D srcT1=ushort -D cn=3 -D dstT1=float -D rowsPerWI=4 -D convertToDT=convert_float -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D ACCUMULATE_SQUARE -D HAVE_MASK -D srcT1=ushort -D cn=3 -D dstT1=float -D rowsPerWI=4 -D convertToDT=convert_float -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
