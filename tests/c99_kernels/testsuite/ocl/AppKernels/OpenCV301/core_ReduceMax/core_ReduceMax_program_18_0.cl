...
// buildOptions=-D OCL_CV_REDUCE_MAX -D dim=1 -D cn=1 -D ddepth=3 -D srcT=short -D dstT=short -D dstT0=short -D convertToWT=convert_float -D convertToDT=noconvert -D convertToDT0=convert_short_sat_rte -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D OCL_CV_REDUCE_MAX -D dim=1 -D cn=1 -D ddepth=3 -D srcT=short -D dstT=short -D dstT0=short -D convertToWT=convert_float -D convertToDT=noconvert -D convertToDT0=convert_short_sat_rte -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
