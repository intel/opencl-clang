...
// buildOptions=-D OCL_CV_REDUCE_MAX -D dim=1 -D cn=3 -D ddepth=0 -D srcT=uchar -D dstT=uchar -D dstT0=uchar -D convertToWT=convert_float -D convertToDT=noconvert -D convertToDT0=convert_uchar_sat_rte -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D OCL_CV_REDUCE_MAX -D dim=1 -D cn=3 -D ddepth=0 -D srcT=uchar -D dstT=uchar -D dstT0=uchar -D convertToWT=convert_float -D convertToDT=noconvert -D convertToDT0=convert_uchar_sat_rte -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
