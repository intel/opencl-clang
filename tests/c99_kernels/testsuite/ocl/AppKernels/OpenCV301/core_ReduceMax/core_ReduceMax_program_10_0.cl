...
// buildOptions=-D OCL_CV_REDUCE_MAX -D dim=1 -D cn=1 -D ddepth=2 -D srcT=ushort -D dstT=ushort -D dstT0=ushort -D convertToWT=convert_float -D convertToDT=noconvert -D convertToDT0=convert_ushort_sat_rte -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D OCL_CV_REDUCE_MAX -D dim=1 -D cn=1 -D ddepth=2 -D srcT=ushort -D dstT=ushort -D dstT0=ushort -D convertToWT=convert_float -D convertToDT=noconvert -D convertToDT0=convert_ushort_sat_rte -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
