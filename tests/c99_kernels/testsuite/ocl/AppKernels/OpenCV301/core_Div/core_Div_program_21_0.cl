...
// buildOptions=-D UNARY_OP -D OP_RDIV_SCALE -D srcT1=ushort -D srcT1_C1=ushort -D srcT2=float -D srcT2_C1=float -D dstT=ushort -D dstT_C1=ushort -D workT=float -D workST=float -D scaleT=float -D wdepth=5 -D convertToWT1=convert_float -D convertToWT2=noconvert -D convertToDT=convert_ushort_sat_rte -D cn=1 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE
