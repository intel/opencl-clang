...
// buildOptions=-D BINARY_OP -D OP_RECIP_SCALE -D srcT1=uchar -D srcT1_C1=uchar -D srcT2=uchar -D srcT2_C1=uchar -D dstT=uchar -D dstT_C1=uchar -D workT=float -D workST=float -D scaleT=float -D wdepth=5 -D convertToWT1=convert_float -D convertToWT2=convert_float -D convertToDT=convert_uchar_sat_rte -D cn=1 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D BINARY_OP -D OP_RECIP_SCALE -D srcT1=uchar -D srcT1_C1=uchar -D srcT2=uchar -D srcT2_C1=uchar -D dstT=uchar -D dstT_C1=uchar -D workT=float -D workST=float -D scaleT=float -D wdepth=5 -D convertToWT1=convert_float -D convertToWT2=convert_float -D convertToDT=convert_uchar_sat_rte -D cn=1 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
