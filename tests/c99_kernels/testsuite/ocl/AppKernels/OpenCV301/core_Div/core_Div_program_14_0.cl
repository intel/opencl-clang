...
// buildOptions=-D UNARY_OP -D OP_RDIV_SCALE -D srcT1=uchar2 -D srcT1_C1=uchar -D srcT2=float2 -D srcT2_C1=float -D dstT=uchar2 -D dstT_C1=uchar -D workT=float2 -D workST=float2 -D scaleT=float -D wdepth=5 -D convertToWT1=convert_float2 -D convertToWT2=noconvert -D convertToDT=convert_uchar2_sat_rte -D cn=2 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE
