...
// buildOptions=-D UNARY_OP -D OP_RDIV_SCALE -D srcT1=short -D srcT1_C1=short -D srcT2=float -D srcT2_C1=float -D dstT=short -D dstT_C1=short -D workT=float -D workST=float -D scaleT=float -D wdepth=5 -D convertToWT1=convert_float -D convertToWT2=noconvert -D convertToDT=convert_short_sat_rte -D cn=1 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE
