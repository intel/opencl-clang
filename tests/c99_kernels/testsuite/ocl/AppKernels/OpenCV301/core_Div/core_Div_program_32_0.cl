...
// buildOptions=-D UNARY_OP -D OP_RDIV_SCALE -D srcT1=int4 -D srcT1_C1=int -D srcT2=float4 -D srcT2_C1=float -D dstT=int4 -D dstT_C1=int -D workT=float4 -D workST=float4 -D scaleT=float -D wdepth=5 -D convertToWT1=convert_float4 -D convertToWT2=noconvert -D convertToDT=convert_int4_rte -D cn=4 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE
