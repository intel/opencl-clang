...
// buildOptions=-D UNARY_OP -D OP_RDIV_SCALE -D srcT1=uchar -D srcT1_C1=uchar -D srcT2=float -D srcT2_C1=float -D dstT=uchar -D dstT_C1=uchar -D workT=float -D workST=float -D scaleT=float -D wdepth=5 -D convertToWT1=convert_float -D convertToWT2=noconvert -D convertToDT=convert_uchar_sat_rte -D cn=1 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE
