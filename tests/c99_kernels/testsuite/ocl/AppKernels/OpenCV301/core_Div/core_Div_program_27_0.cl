...
// buildOptions=-D UNARY_OP -D OP_RDIV_SCALE -D srcT1=short3 -D srcT1_C1=short -D srcT2=float3 -D srcT2_C1=float -D dstT=short3 -D dstT_C1=short -D workT=float3 -D workST=float4 -D scaleT=float -D wdepth=5 -D convertToWT1=convert_float3 -D convertToWT2=noconvert -D convertToDT=convert_short3_sat_rte -D cn=3 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE
