...
// buildOptions=-D OCL_CV_REDUCE_SUM -D dim=1 -D cn=3 -D ddepth=4 -D srcT=uchar -D dstT=int -D dstT0=int -D convertToWT=convert_float -D convertToDT=convert_float -D convertToDT0=convert_int_rte -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D OCL_CV_REDUCE_SUM -D dim=1 -D cn=3 -D ddepth=4 -D srcT=uchar -D dstT=int -D dstT0=int -D convertToWT=convert_float -D convertToDT=convert_float -D convertToDT0=convert_int_rte -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
