...
// buildOptions=-D MASK_UNARY_OP -D OP_SUB -D srcT1=int3 -D srcT1_C1=int -D srcT2=int3 -D srcT2_C1=int -D dstT=int3 -D dstT_C1=int -D workT=int3 -D workST=int4 -D scaleT=int -D wdepth=4 -D convertToWT1=noconvert -D convertToWT2=noconvert -D convertToDT=noconvert -D cn=3 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D MASK_UNARY_OP -D OP_SUB -D srcT1=int3 -D srcT1_C1=int -D srcT2=int3 -D srcT2_C1=int -D dstT=int3 -D dstT_C1=int -D workT=int3 -D workST=int4 -D scaleT=int -D wdepth=4 -D convertToWT1=noconvert -D convertToWT2=noconvert -D convertToDT=noconvert -D cn=3 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
