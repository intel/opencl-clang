...
// buildOptions=-D MASK_BINARY_OP -D OP_SUB -D srcT1=ushort3 -D srcT1_C1=ushort -D srcT2=ushort3 -D srcT2_C1=ushort -D dstT=ushort3 -D dstT_C1=ushort -D workT=int3 -D workST=int4 -D scaleT=int -D wdepth=4 -D convertToWT1=convert_int3 -D convertToWT2=convert_int3 -D convertToDT=convert_ushort3_sat -D cn=3 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D MASK_BINARY_OP -D OP_SUB -D srcT1=ushort3 -D srcT1_C1=ushort -D srcT2=ushort3 -D srcT2_C1=ushort -D dstT=ushort3 -D dstT_C1=ushort -D workT=int3 -D workST=int4 -D scaleT=int -D wdepth=4 -D convertToWT1=convert_int3 -D convertToWT2=convert_int3 -D convertToDT=convert_ushort3_sat -D cn=3 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
