...
// buildOptions=-D MASK_UNARY_OP -D OP_SUB -D srcT1=short4 -D srcT1_C1=short -D srcT2=int4 -D srcT2_C1=int -D dstT=short4 -D dstT_C1=short -D workT=int4 -D workST=int4 -D scaleT=int -D wdepth=4 -D convertToWT1=convert_int4 -D convertToWT2=noconvert -D convertToDT=convert_short4_sat -D cn=4 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D MASK_UNARY_OP -D OP_SUB -D srcT1=short4 -D srcT1_C1=short -D srcT2=int4 -D srcT2_C1=int -D dstT=short4 -D dstT_C1=short -D workT=int4 -D workST=int4 -D scaleT=int -D wdepth=4 -D convertToWT1=convert_int4 -D convertToWT2=noconvert -D convertToDT=convert_short4_sat -D cn=4 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
