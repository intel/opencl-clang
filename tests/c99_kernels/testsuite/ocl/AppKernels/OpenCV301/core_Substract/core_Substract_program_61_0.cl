...
// buildOptions=-D MASK_UNARY_OP -D OP_SUB -D srcT1=uchar -D srcT1_C1=uchar -D srcT2=int -D srcT2_C1=int -D dstT=uchar -D dstT_C1=uchar -D workT=int -D workST=int -D scaleT=int -D wdepth=4 -D convertToWT1=convert_int -D convertToWT2=noconvert -D convertToDT=convert_uchar_sat -D cn=1 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D MASK_UNARY_OP -D OP_SUB -D srcT1=uchar -D srcT1_C1=uchar -D srcT2=int -D srcT2_C1=int -D dstT=uchar -D dstT_C1=uchar -D workT=int -D workST=int -D scaleT=int -D wdepth=4 -D convertToWT1=convert_int -D convertToWT2=noconvert -D convertToDT=convert_uchar_sat -D cn=1 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
