...
// buildOptions=-D BINARY_OP -D OP_SUB -D srcT1=int -D srcT1_C1=int -D srcT2=int -D srcT2_C1=int -D dstT=int -D dstT_C1=int -D workT=int -D workST=int -D scaleT=int -D wdepth=4 -D convertToWT1=noconvert -D convertToWT2=noconvert -D convertToDT=noconvert -D cn=1 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D BINARY_OP -D OP_SUB -D srcT1=int -D srcT1_C1=int -D srcT2=int -D srcT2_C1=int -D dstT=int -D dstT_C1=int -D workT=int -D workST=int -D scaleT=int -D wdepth=4 -D convertToWT1=noconvert -D convertToWT2=noconvert -D convertToDT=noconvert -D cn=1 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
