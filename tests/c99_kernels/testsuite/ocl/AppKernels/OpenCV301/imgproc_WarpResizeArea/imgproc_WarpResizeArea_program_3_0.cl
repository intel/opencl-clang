...
// buildOptions=-D INTER_AREA -D T=uchar4 -D T1=uchar -D WTV=float4 -D convertToWTV=convert_float4 -D cn=4 -D convertToT=convert_uchar4_sat_rte -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D INTER_AREA -D T=uchar4 -D T1=uchar -D WTV=float4 -D convertToWTV=convert_float4 -D cn=4 -D convertToT=convert_uchar4_sat_rte -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
