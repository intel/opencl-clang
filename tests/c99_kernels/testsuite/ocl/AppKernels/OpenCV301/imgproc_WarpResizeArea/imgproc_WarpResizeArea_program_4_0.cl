...
// buildOptions=-D INTER_AREA -D T=uchar4 -D T1=uchar -D WTV=int4 -D convertToWTV=convert_int4 -D cn=4 -D convertToT=convert_uchar4_sat_rte -D WT2V=float4 -D convertToWT2V=convert_float4 -D INTER_AREA_FAST -D XSCALE=2 -D YSCALE=2 -D SCALE=0.250000f -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D INTER_AREA -D T=uchar4 -D T1=uchar -D WTV=int4 -D convertToWTV=convert_int4 -D cn=4 -D convertToT=convert_uchar4_sat_rte -D WT2V=float4 -D convertToWT2V=convert_float4 -D INTER_AREA_FAST -D XSCALE=2 -D YSCALE=2 -D SCALE=0.250000f -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
