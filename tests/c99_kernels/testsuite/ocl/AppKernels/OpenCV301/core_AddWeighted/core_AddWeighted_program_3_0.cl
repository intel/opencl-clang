...
// buildOptions=-D BINARY_OP -D OP_ADDW -D srcT1=uchar4 -D srcT1_C1=uchar -D srcT2=uchar4 -D srcT2_C1=uchar -D dstT=uchar4 -D dstT_C1=uchar -D workT=float4 -D workST=float4 -D scaleT=float -D wdepth=5 -D convertToWT1=convert_float4 -D convertToWT2=convert_float4 -D convertToDT=convert_uchar4_sat_rte -D cn=4 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D BINARY_OP -D OP_ADDW -D srcT1=uchar4 -D srcT1_C1=uchar -D srcT2=uchar4 -D srcT2_C1=uchar -D dstT=uchar4 -D dstT_C1=uchar -D workT=float4 -D workST=float4 -D scaleT=float -D wdepth=5 -D convertToWT1=convert_float4 -D convertToWT2=convert_float4 -D convertToDT=convert_uchar4_sat_rte -D cn=4 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
