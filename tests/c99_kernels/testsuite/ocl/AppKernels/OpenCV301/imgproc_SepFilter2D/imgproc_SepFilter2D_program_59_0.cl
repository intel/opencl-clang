...
// buildOptions=-D BLK_X=16 -D BLK_Y=8 -D RADIUSX=1 -D RADIUSY=1 -D KERNEL_MATRIX_X=DIG(0.08487193286f)DIG(0.6890161037f)DIG(0.2261119187f) -D KERNEL_MATRIX_Y=DIG(0.7018499970f)DIG(-0.1931490451f)DIG(0.1050009429f) -D srcT=uchar2 -D convertToWT=convert_float2 -D WT=float2 -D dstT=uchar2 -D convertToDstT=convert_uchar2_sat_rte -D BORDER_REFLECT -D srcT1=uchar -D dstT1=uchar -D WT1=float -D CN=2 -D SHIFT_BITS=16 -D INTEL_DEVICE
