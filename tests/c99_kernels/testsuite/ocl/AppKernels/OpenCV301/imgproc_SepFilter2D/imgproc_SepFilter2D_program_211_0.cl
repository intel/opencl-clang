...
// buildOptions=-D BLK_X=16 -D BLK_Y=8 -D RADIUSX=1 -D RADIUSY=1 -D KERNEL_MATRIX_X=DIG(0.08487193286f)DIG(0.6890161037f)DIG(0.2261119187f) -D KERNEL_MATRIX_Y=DIG(0.7018499970f)DIG(-0.1931490451f)DIG(0.1050009429f) -D srcT=float2 -D convertToWT=noconvert -D WT=float2 -D dstT=float2 -D convertToDstT=noconvert -D BORDER_REFLECT_101 -D srcT1=float -D dstT1=float -D WT1=float -D CN=2 -D SHIFT_BITS=16 -D INTEL_DEVICE
