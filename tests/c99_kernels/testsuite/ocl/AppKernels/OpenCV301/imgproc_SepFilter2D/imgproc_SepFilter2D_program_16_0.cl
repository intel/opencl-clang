...
// buildOptions=-D RADIUSX=1 -D LSIZE0=16 -D LSIZE1=16 -D CN=1 -D BORDER_REPLICATE -D EXTRA_EXTRAPOLATION -D NO_BORDER_ISOLATED -D srcT=uchar -D dstT=float -D convertToDstT=convert_float -D srcT1=uchar -D dstT1=float -D COEFF=DIG(-0.4779050946f)DIG(-0.2675260901f)DIG(-0.2545688152f) -D INTEL_DEVICE
