...
// buildOptions=-D RADIUSX=1 -D LSIZE0=16 -D LSIZE1=16 -D CN=4 -D BORDER_REPLICATE -D EXTRA_EXTRAPOLATION -D BORDER_ISOLATED -D srcT=uchar4 -D dstT=float4 -D convertToDstT=convert_float4 -D srcT1=uchar -D dstT1=float -D COEFF=DIG(-0.4779050946f)DIG(-0.2675260901f)DIG(-0.2545688152f) -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D RADIUSX=1 -D LSIZE0=16 -D LSIZE1=16 -D CN=4 -D BORDER_REPLICATE -D EXTRA_EXTRAPOLATION -D BORDER_ISOLATED -D srcT=uchar4 -D dstT=float4 -D convertToDstT=convert_float4 -D srcT1=uchar -D dstT1=float -D COEFF=DIG(-0.4779050946f)DIG(-0.2675260901f)DIG(-0.2545688152f) -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
