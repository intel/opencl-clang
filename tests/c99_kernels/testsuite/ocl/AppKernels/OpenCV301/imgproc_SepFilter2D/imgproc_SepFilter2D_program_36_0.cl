...
// buildOptions=-D RADIUSX=1 -D LSIZE0=16 -D LSIZE1=16 -D CN=1 -D BORDER_REFLECT_101 -D NO_EXTRA_EXTRAPOLATION -D BORDER_ISOLATED -D srcT=uchar -D dstT=float -D convertToDstT=convert_float -D srcT1=uchar -D dstT1=float -D COEFF=DIG(0.08487193286f)DIG(0.6890161037f)DIG(0.2261119187f) -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D RADIUSX=1 -D LSIZE0=16 -D LSIZE1=16 -D CN=1 -D BORDER_REFLECT_101 -D NO_EXTRA_EXTRAPOLATION -D BORDER_ISOLATED -D srcT=uchar -D dstT=float -D convertToDstT=convert_float -D srcT1=uchar -D dstT1=float -D COEFF=DIG(0.08487193286f)DIG(0.6890161037f)DIG(0.2261119187f) -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
