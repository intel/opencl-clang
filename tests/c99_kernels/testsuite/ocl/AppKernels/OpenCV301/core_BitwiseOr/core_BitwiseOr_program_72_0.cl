...
// buildOptions=-D MASK_UNARY_OP -D OP_OR -D dstT=ushort4 -D dstT_C1=ushort -D workST=ushort4 -D cn=4 -D rowsPerWI=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D MASK_UNARY_OP -D OP_OR -D dstT=ushort4 -D dstT_C1=ushort -D workST=ushort4 -D cn=4 -D rowsPerWI=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
