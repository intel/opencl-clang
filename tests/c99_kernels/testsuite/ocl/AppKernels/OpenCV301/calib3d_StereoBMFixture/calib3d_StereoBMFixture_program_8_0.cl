...
// buildOptions=-D DEFINE_KERNEL_STEREOBM -D MIN_DISP=0 -D NUM_DISP=128 -D BLOCK_SIZE_X=32 -D BLOCK_SIZE_Y=31 -D WSZ=21 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D DEFINE_KERNEL_STEREOBM -D MIN_DISP=0 -D NUM_DISP=128 -D BLOCK_SIZE_X=32 -D BLOCK_SIZE_Y=31 -D WSZ=21 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
