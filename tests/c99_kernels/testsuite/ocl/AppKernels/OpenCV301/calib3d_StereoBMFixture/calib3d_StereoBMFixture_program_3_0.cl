...
// buildOptions=-D dstT=short2 -D rowsPerWI=4 -D dstST=short2 -D dstT1=short -D cn=2 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D dstT=short2 -D rowsPerWI=4 -D dstST=short2 -D dstT1=short -D cn=2 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
