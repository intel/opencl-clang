...
// buildOptions=-D T=ushort2 -D FT=float2 -D convertToT=convert_ushort2_sat_rte -D convertToFT=convert_float2 -D T1=ushort -D cn=2 -D LOCAL_SIZE=16 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D T=ushort2 -D FT=float2 -D convertToT=convert_ushort2_sat_rte -D convertToFT=convert_float2 -D T1=ushort -D cn=2 -D LOCAL_SIZE=16 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
