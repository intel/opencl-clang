...
// buildOptions=-D T=short4 -D FT=float4 -D convertToT=convert_short4_sat_rte -D convertToFT=convert_float4 -D T1=short -D cn=4 -D LOCAL_SIZE=16 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D T=short4 -D FT=float4 -D convertToT=convert_short4_sat_rte -D convertToFT=convert_float4 -D T1=short -D cn=4 -D LOCAL_SIZE=16 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
