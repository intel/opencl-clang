...
// buildOptions=-D BINARY_OP -D dstT=float -D depth=5 -D rowsPerWI=4 -D OP_CTP_AD -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D BINARY_OP -D dstT=float -D depth=5 -D rowsPerWI=4 -D OP_CTP_AD -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
