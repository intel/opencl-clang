...
// buildOptions=-D THRESH_BINARY_INV -D T=uchar2 -D T1=uchar -D STRIDE_SIZE=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D THRESH_BINARY_INV -D T=uchar2 -D T1=uchar -D STRIDE_SIZE=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
