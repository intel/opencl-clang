...
// buildOptions=-D THRESH_TOZERO_INV -D T=float -D T1=float -D STRIDE_SIZE=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D THRESH_TOZERO_INV -D T=float -D T1=float -D STRIDE_SIZE=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
