...
// buildOptions=-D THRESH_TOZERO -D T=short -D T1=short -D STRIDE_SIZE=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D THRESH_TOZERO -D T=short -D T1=short -D STRIDE_SIZE=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
