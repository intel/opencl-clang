...
// buildOptions=-D T=short -D BORDER_WRAP -D T1=short -D cn=1 -D ST=short -D rowsPerWI=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D T=short -D BORDER_WRAP -D T1=short -D cn=1 -D ST=short -D rowsPerWI=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
