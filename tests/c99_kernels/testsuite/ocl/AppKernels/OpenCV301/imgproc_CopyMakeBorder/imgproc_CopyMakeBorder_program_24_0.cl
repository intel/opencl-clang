...
// buildOptions=-D T=short3 -D BORDER_WRAP -D T1=short -D cn=3 -D ST=short4 -D rowsPerWI=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D T=short3 -D BORDER_WRAP -D T1=short -D cn=3 -D ST=short4 -D rowsPerWI=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
