...
// buildOptions=-D T=short4 -D BORDER_REFLECT_101 -D T1=short -D cn=4 -D ST=short4 -D rowsPerWI=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D T=short4 -D BORDER_REFLECT_101 -D T1=short -D cn=4 -D ST=short4 -D rowsPerWI=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
