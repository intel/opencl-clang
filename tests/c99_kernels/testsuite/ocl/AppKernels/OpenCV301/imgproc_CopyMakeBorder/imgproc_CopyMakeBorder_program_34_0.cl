...
// buildOptions=-D T=int -D BORDER_WRAP -D T1=int -D cn=1 -D ST=int -D rowsPerWI=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D T=int -D BORDER_WRAP -D T1=int -D cn=1 -D ST=int -D rowsPerWI=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
