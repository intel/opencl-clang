...
// buildOptions=-D T=uchar3 -D BORDER_CONSTANT -D T1=uchar -D cn=3 -D ST=uchar4 -D rowsPerWI=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D T=uchar3 -D BORDER_CONSTANT -D T1=uchar -D cn=3 -D ST=uchar4 -D rowsPerWI=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
