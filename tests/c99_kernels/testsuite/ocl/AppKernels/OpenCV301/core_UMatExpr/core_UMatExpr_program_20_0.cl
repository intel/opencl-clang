...
// buildOptions=-D T=int4 -D T1=int -D cn=4 -D ST=int4 -D kercn=4 -D rowsPerWI=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D T=int4 -D T1=int -D cn=4 -D ST=int4 -D kercn=4 -D rowsPerWI=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
