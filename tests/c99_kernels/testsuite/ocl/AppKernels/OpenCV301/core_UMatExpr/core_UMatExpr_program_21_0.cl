...
// buildOptions=-D T=ulong -D T1=ulong -D cn=1 -D ST=ulong -D kercn=1 -D rowsPerWI=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D T=ulong -D T1=ulong -D cn=1 -D ST=ulong -D kercn=1 -D rowsPerWI=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
