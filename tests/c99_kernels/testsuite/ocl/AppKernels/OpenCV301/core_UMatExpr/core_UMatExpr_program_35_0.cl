...
// buildOptions=-D dstT=ushort3 -D rowsPerWI=4 -D dstST=ushort4 -D dstT1=ushort -D cn=3 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D dstT=ushort3 -D rowsPerWI=4 -D dstST=ushort4 -D dstT1=ushort -D cn=3 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
