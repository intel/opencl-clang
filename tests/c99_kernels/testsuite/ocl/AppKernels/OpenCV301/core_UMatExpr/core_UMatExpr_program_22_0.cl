...
// buildOptions=-D T=ulong2 -D T1=ulong -D cn=2 -D ST=ulong2 -D kercn=2 -D rowsPerWI=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D T=ulong2 -D T1=ulong -D cn=2 -D ST=ulong2 -D kercn=2 -D rowsPerWI=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
