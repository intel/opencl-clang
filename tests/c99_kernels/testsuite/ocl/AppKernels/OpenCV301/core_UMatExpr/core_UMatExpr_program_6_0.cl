...
// buildOptions=-D T=char2 -D T1=char -D cn=2 -D ST=char2 -D kercn=2 -D rowsPerWI=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D T=char2 -D T1=char -D cn=2 -D ST=char2 -D kercn=2 -D rowsPerWI=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
