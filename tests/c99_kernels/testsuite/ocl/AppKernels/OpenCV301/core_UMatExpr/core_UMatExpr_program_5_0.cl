...
// buildOptions=-D T=char -D T1=char -D cn=1 -D ST=char -D kercn=1 -D rowsPerWI=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D T=char -D T1=char -D cn=1 -D ST=char -D kercn=1 -D rowsPerWI=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
