...
// buildOptions=-D T=int2 -D T1=int -D cn=2 -D ST=int2 -D kercn=2 -D rowsPerWI=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D T=int2 -D T1=int -D cn=2 -D ST=int2 -D kercn=2 -D rowsPerWI=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
