...
// buildOptions=-D srcT=float -D srcT1=float -D cn=1 -D OP_COUNT_NON_ZERO -D WGS=256 -D kercn=1 -D WGS2_ALIGNED=128 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D srcT=float -D srcT1=float -D cn=1 -D OP_COUNT_NON_ZERO -D WGS=256 -D kercn=1 -D WGS2_ALIGNED=128 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
