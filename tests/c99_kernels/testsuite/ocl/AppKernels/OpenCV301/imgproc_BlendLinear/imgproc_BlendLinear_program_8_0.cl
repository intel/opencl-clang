...
// buildOptions=-D T=float -D cn=4 -D convertToT=noconvert -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D T=float -D cn=4 -D convertToT=noconvert -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
