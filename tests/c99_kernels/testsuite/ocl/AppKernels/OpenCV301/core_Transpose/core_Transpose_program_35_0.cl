...
// buildOptions=-D T=ushort3 -D T1=ushort -D cn=3 -D TILE_DIM=32 -D BLOCK_ROWS=8 -D rowsPerWI=4 -D INPLACE -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D T=ushort3 -D T1=ushort -D cn=3 -D TILE_DIM=32 -D BLOCK_ROWS=8 -D rowsPerWI=4 -D INPLACE -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
