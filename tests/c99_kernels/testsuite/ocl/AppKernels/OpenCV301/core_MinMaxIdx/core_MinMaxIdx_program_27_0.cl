...
// buildOptions=-D DEPTH_3 -D srcT1=short -D WGS=256 -D srcT=short -D WGS2_ALIGNED=128 -D HAVE_SRC_CONT -D HAVE_MASK_CONT -D kercn=1 -D NEED_MINVAL -D NEED_MAXVAL -D dstT1=short -D dstT=short -D convertToDT=noconvert -D wdepth=3 -D convertFromU=noconvert -D MINMAX_STRUCT_ALIGNMENT=8 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D DEPTH_3 -D srcT1=short -D WGS=256 -D srcT=short -D WGS2_ALIGNED=128 -D HAVE_SRC_CONT -D HAVE_MASK_CONT -D kercn=1 -D NEED_MINVAL -D NEED_MAXVAL -D dstT1=short -D dstT=short -D convertToDT=noconvert -D wdepth=3 -D convertFromU=noconvert -D MINMAX_STRUCT_ALIGNMENT=8 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
