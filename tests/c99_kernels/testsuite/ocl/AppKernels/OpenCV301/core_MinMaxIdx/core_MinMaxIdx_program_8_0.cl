...
// buildOptions=-D DEPTH_0 -D srcT1=uchar -D WGS=256 -D srcT=uchar4 -D WGS2_ALIGNED=128 -D HAVE_MASK_CONT -D kercn=4 -D NEED_MINVAL -D NEED_MAXVAL -D dstT1=uchar -D dstT=uchar4 -D convertToDT=noconvert -D wdepth=0 -D convertFromU=noconvert -D MINMAX_STRUCT_ALIGNMENT=8 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D DEPTH_0 -D srcT1=uchar -D WGS=256 -D srcT=uchar4 -D WGS2_ALIGNED=128 -D HAVE_MASK_CONT -D kercn=4 -D NEED_MINVAL -D NEED_MAXVAL -D dstT1=uchar -D dstT=uchar4 -D convertToDT=noconvert -D wdepth=0 -D convertFromU=noconvert -D MINMAX_STRUCT_ALIGNMENT=8 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
