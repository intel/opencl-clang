...
// buildOptions=-D cn=4 -D ANCHOR_X=2 -D ANCHOR_Y=3 -D KERNEL_SIZE_X=4 -D KERNEL_SIZE_Y=4 -D PX_LOAD_VEC_SIZE=4 -D PX_LOAD_NUM_PX=1 -D PX_PER_WI_X=2 -D PX_PER_WI_Y=1 -D PRIV_DATA_WIDTH=5 -D BORDER_CONSTANT -D NO_BORDER_ISOLATED -D PX_LOAD_X_ITERATIONS=5 -D PX_LOAD_Y_ITERATIONS=4 -D srcT=uchar4 -D srcT1=uchar -D dstT=uchar4 -D dstT1=uchar -D WT=float4 -D WT1=float -D convertToWT=convert_float4 -D convertToDstT=convert_uchar4_sat_rte -D PX_LOAD_FLOAT_VEC_CONV=convert_float4 -D OP_BOX_FILTER -D INTEL_DEVICE
