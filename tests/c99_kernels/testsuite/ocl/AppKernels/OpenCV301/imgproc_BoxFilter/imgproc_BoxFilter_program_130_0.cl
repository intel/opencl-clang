...
// buildOptions=-D cn=1 -D ANCHOR_X=2 -D ANCHOR_Y=3 -D KERNEL_SIZE_X=4 -D KERNEL_SIZE_Y=4 -D PX_LOAD_VEC_SIZE=4 -D PX_LOAD_NUM_PX=4 -D PX_PER_WI_X=4 -D PX_PER_WI_Y=1 -D PRIV_DATA_WIDTH=8 -D BORDER_CONSTANT -D NO_BORDER_ISOLATED -D PX_LOAD_X_ITERATIONS=2 -D PX_LOAD_Y_ITERATIONS=4 -D srcT=float -D srcT1=float -D dstT=float -D dstT1=float -D WT=float -D WT1=float -D convertToWT=noconvert -D convertToDstT=noconvert -D NORMALIZE -D PX_LOAD_FLOAT_VEC_CONV=convert_float4 -D OP_BOX_FILTER -D INTEL_DEVICE
