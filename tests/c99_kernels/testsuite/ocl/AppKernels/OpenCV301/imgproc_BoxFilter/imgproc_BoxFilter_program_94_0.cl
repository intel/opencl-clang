...
// buildOptions=-D LOCAL_SIZE_X=32 -D BLOCK_SIZE_Y=5 -D ST=short4 -D DT=short4 -D WT=float4 -D convertToDT=convert_short4_sat_rte -D convertToWT=convert_float4 -D ANCHOR_X=2 -D ANCHOR_Y=3 -D KERNEL_SIZE_X=4 -D KERNEL_SIZE_Y=4 -D BORDER_REFLECT -D NORMALIZE -D ST1=short -D DT1=short -D cn=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D LOCAL_SIZE_X=32 -D BLOCK_SIZE_Y=5 -D ST=short4 -D DT=short4 -D WT=float4 -D convertToDT=convert_short4_sat_rte -D convertToWT=convert_float4 -D ANCHOR_X=2 -D ANCHOR_Y=3 -D KERNEL_SIZE_X=4 -D KERNEL_SIZE_Y=4 -D BORDER_REFLECT -D NORMALIZE -D ST1=short -D DT1=short -D cn=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
