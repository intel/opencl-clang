...
// buildOptions=-D cn=2 -D ANCHOR_X=2 -D ANCHOR_Y=3 -D KERNEL_SIZE_X=4 -D KERNEL_SIZE_Y=4 -D PX_LOAD_VEC_SIZE=2 -D PX_LOAD_NUM_PX=1 -D PX_PER_WI_X=4 -D PX_PER_WI_Y=1 -D PRIV_DATA_WIDTH=7 -D BORDER_REPLICATE -D NO_BORDER_ISOLATED -D PX_LOAD_X_ITERATIONS=7 -D PX_LOAD_Y_ITERATIONS=4 -D srcT=short2 -D srcT1=short -D dstT=short2 -D dstT1=short -D WT=float2 -D WT1=float -D convertToWT=convert_float2 -D convertToDstT=convert_short2_sat_rte -D PX_LOAD_FLOAT_VEC_CONV=convert_float2 -D OP_BOX_FILTER -D INTEL_DEVICE
