...
// buildOptions=-D LOCAL_SIZE_X=32 -D BLOCK_SIZE_Y=5 -D ST=int3 -D DT=int3 -D WT=float3 -D convertToDT=convert_int3_rte -D convertToWT=convert_float3 -D ANCHOR_X=2 -D ANCHOR_Y=3 -D KERNEL_SIZE_X=4 -D KERNEL_SIZE_Y=4 -D BORDER_REPLICATE -D NORMALIZE -D ST1=int -D DT1=int -D cn=3 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D LOCAL_SIZE_X=32 -D BLOCK_SIZE_Y=5 -D ST=int3 -D DT=int3 -D WT=float3 -D convertToDT=convert_int3_rte -D convertToWT=convert_float3 -D ANCHOR_X=2 -D ANCHOR_Y=3 -D KERNEL_SIZE_X=4 -D KERNEL_SIZE_Y=4 -D BORDER_REPLICATE -D NORMALIZE -D ST1=int -D DT1=int -D cn=3 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
