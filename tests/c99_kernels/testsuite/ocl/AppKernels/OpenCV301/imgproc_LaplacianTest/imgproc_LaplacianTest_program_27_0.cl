...
// buildOptions=-D ONLY_SUM_CONVERT -D srcT=short -D WT=int -D dstT=uchar -D coeffT=int -D wdepth=4 -D convertToWT=convert_int -D convertToDT=convert_uchar_sat -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D ONLY_SUM_CONVERT -D srcT=short -D WT=int -D dstT=uchar -D coeffT=int -D wdepth=4 -D convertToWT=convert_int -D convertToDT=convert_uchar_sat -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
