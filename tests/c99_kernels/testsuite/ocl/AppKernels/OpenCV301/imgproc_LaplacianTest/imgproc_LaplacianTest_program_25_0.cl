...
// buildOptions=-D BLK_X=16 -D BLK_Y=16 -D RADIUS=2 -D KERNEL_MATRIX_X=DIG(1.000000000f)DIG(0.0000000000f)DIG(-2.000000000f)DIG(0.0000000000f)DIG(1.000000000f) -D KERNEL_MATRIX_Y=DIG(1.000000000f)DIG(4.000000000f)DIG(6.000000000f)DIG(4.000000000f)DIG(1.000000000f) -D convertToWT=convert_float -D convertToDT=convert_uchar_sat_rte -D BORDER_CONSTANT -D srcT1=uchar -D dstT1=uchar -D WT1=float -D srcT=uchar -D dstT=uchar -D WT=float -D CN=1  -D INTEL_DEVICE
