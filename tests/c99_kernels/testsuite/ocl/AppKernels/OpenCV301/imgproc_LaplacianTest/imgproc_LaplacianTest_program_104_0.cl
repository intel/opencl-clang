...
// buildOptions=-D cn=1 -D ANCHOR_X=1 -D ANCHOR_Y=1 -D KERNEL_SIZE_X=3 -D KERNEL_SIZE_Y=3 -D PX_LOAD_VEC_SIZE=1 -D PX_LOAD_NUM_PX=1 -D PX_PER_WI_X=1 -D PX_PER_WI_Y=1 -D PRIV_DATA_WIDTH=3 -D BORDER_REFLECT_101 -D NO_BORDER_ISOLATED -D PX_LOAD_X_ITERATIONS=3 -D PX_LOAD_Y_ITERATIONS=3 -D srcT=ushort -D srcT1=ushort -D dstT=ushort -D dstT1=ushort -D WT=float -D WT1=float -D convertToWT=convert_float -D convertToDstT=convert_ushort_sat_rte  -D COEFF=DIG(0.0000000000f)DIG(3.000000000f)DIG(0.0000000000f)DIG(3.000000000f)DIG(-12.00000000f)DIG(3.000000000f)DIG(0.0000000000f)DIG(3.000000000f)DIG(0.0000000000f) -D INTEL_DEVICE
