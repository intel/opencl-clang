...
// buildOptions=-D cn=4 -D ANCHOR_X=1 -D ANCHOR_Y=1 -D KERNEL_SIZE_X=3 -D KERNEL_SIZE_Y=3 -D PX_LOAD_VEC_SIZE=4 -D PX_LOAD_NUM_PX=1 -D PX_PER_WI_X=1 -D PX_PER_WI_Y=1 -D PRIV_DATA_WIDTH=3 -D BORDER_REFLECT_101 -D NO_BORDER_ISOLATED -D PX_LOAD_X_ITERATIONS=3 -D PX_LOAD_Y_ITERATIONS=3 -D srcT=uchar4 -D srcT1=uchar -D dstT=uchar4 -D dstT1=uchar -D WT=float4 -D WT1=float -D convertToWT=convert_float4 -D convertToDstT=convert_uchar4_sat_rte  -D COEFF=DIG(0.4000000060f)DIG(0.0000000000f)DIG(0.4000000060f)DIG(0.0000000000f)DIG(-1.600000024f)DIG(0.0000000000f)DIG(0.4000000060f)DIG(0.0000000000f)DIG(0.4000000060f) -D INTEL_DEVICE
