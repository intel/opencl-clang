...
// buildOptions=-D BLK_X=16 -D BLK_Y=16 -D RADIUS=2 -D KERNEL_MATRIX_X=DIG(1.000000000f)DIG(0.0000000000f)DIG(-2.000000000f)DIG(0.0000000000f)DIG(1.000000000f) -D KERNEL_MATRIX_Y=DIG(1.000000000f)DIG(4.000000000f)DIG(6.000000000f)DIG(4.000000000f)DIG(1.000000000f) -D convertToWT=convert_float4 -D convertToDT=convert_ushort4_sat_rte -D BORDER_REPLICATE -D srcT1=ushort -D dstT1=ushort -D WT1=float -D srcT=ushort4 -D dstT=ushort4 -D WT=float4 -D CN=4  -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D BLK_X=16 -D BLK_Y=16 -D RADIUS=2 -D KERNEL_MATRIX_X=DIG(1.000000000f)DIG(0.0000000000f)DIG(-2.000000000f)DIG(0.0000000000f)DIG(1.000000000f) -D KERNEL_MATRIX_Y=DIG(1.000000000f)DIG(4.000000000f)DIG(6.000000000f)DIG(4.000000000f)DIG(1.000000000f) -D convertToWT=convert_float4 -D convertToDT=convert_ushort4_sat_rte -D BORDER_REPLICATE -D srcT1=ushort -D dstT1=ushort -D WT1=float -D srcT=ushort4 -D dstT=ushort4 -D WT=float4 -D CN=4  -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
