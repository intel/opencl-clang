...
// buildOptions=-D BLK_X=16 -D BLK_Y=8 -D RADIUSX=2 -D RADIUSY=2 -D KERNEL_MATRIX_X=DIG(1.000000000f)DIG(0.0000000000f)DIG(-2.000000000f)DIG(0.0000000000f)DIG(1.000000000f) -D KERNEL_MATRIX_Y=DIG(1.000000000f)DIG(4.000000000f)DIG(6.000000000f)DIG(4.000000000f)DIG(1.000000000f) -D srcT=ushort3 -D convertToWT=convert_float3 -D WT=float3 -D dstT=float3 -D convertToDstT=noconvert -D BORDER_REFLECT_101 -D srcT1=ushort -D dstT1=float -D WT1=float -D CN=3 -D SHIFT_BITS=16 -D INTEL_DEVICE
