...
// buildOptions=-D depth=2 -D scn=1 -D PIX_PER_WI_Y=4 -D bidx=0 -D dcn=3 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D depth=2 -D scn=1 -D PIX_PER_WI_Y=4 -D bidx=0 -D dcn=3 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
