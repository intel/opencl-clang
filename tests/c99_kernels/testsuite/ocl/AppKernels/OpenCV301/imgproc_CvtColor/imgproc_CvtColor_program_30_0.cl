...
// buildOptions=-D depth=5 -D scn=4 -D PIX_PER_WI_Y=4 -D dcn=1 -D bidx=2 -D STRIPE_SIZE=1 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D depth=5 -D scn=4 -D PIX_PER_WI_Y=4 -D dcn=1 -D bidx=2 -D STRIPE_SIZE=1 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
