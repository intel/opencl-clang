...
// buildOptions=-D T=uchar2 -D T1=uchar -D cn=2 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D T=uchar2 -D T1=uchar -D cn=2 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
