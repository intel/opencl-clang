...
// buildOptions=-D dcn=4 -D lcn=1 -D srcT=uchar -D dstT=uchar -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D dcn=4 -D lcn=1 -D srcT=uchar -D dstT=uchar -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
