...
// buildOptions=-D dcn=2 -D lcn=1 -D srcT=char -D dstT=char -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D dcn=2 -D lcn=1 -D srcT=char -D dstT=char -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
