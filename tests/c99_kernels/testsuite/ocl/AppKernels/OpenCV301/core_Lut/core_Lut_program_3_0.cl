...
// buildOptions=-D dcn=2 -D lcn=2 -D srcT=uchar -D dstT=uchar -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D dcn=2 -D lcn=2 -D srcT=uchar -D dstT=uchar -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
