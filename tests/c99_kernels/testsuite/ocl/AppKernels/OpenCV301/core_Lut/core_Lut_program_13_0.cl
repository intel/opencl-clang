...
// buildOptions=-D dcn=3 -D lcn=3 -D srcT=uchar -D dstT=ushort -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D dcn=3 -D lcn=3 -D srcT=uchar -D dstT=ushort -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
