...
// buildOptions=-D CCORR -D T=uchar4 -D T1=uchar -D WT=float4 -D WT1=float -D convertToWT=convert_float4 -D convertToWT1=convert_float -D cn=1 -D PIX_PER_WI_X=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D CCORR -D T=uchar4 -D T1=uchar -D WT=float4 -D WT1=float -D convertToWT=convert_float4 -D convertToWT1=convert_float -D cn=1 -D PIX_PER_WI_X=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
