...
// buildOptions=-D CALC_SUM -D T=uchar -D T1=uchar -D WT=float -D cn=1 -D convertToWT=convert_float -D WGS=256 -D WGS2_ALIGNED=128 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D CALC_SUM -D T=uchar -D T1=uchar -D WT=float -D cn=1 -D convertToWT=convert_float -D WGS=256 -D WGS2_ALIGNED=128 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
