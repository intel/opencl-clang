...
// buildOptions=-D SUM_SQUARE -D sumT=float -D sumSQT=float -D LOCAL_SUM_SIZE=16 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D SUM_SQUARE -D sumT=float -D sumSQT=float -D LOCAL_SUM_SIZE=16 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
