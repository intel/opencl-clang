...
// buildOptions=-D CCOEFF -D T=float -D T1=float -D cn=1 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D CCOEFF -D T=float -D T1=float -D cn=1 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
