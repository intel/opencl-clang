...
// buildOptions=-D SQDIFF_NORMED -D T=uchar -D cn=1 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D SQDIFF_NORMED -D T=uchar -D cn=1 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
