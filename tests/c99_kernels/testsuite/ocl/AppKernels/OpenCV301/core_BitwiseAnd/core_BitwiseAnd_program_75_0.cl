...
// buildOptions=-D MASK_UNARY_OP -D OP_AND -D dstT=short3 -D dstT_C1=short -D workST=short4 -D cn=3 -D rowsPerWI=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D MASK_UNARY_OP -D OP_AND -D dstT=short3 -D dstT_C1=short -D workST=short4 -D cn=3 -D rowsPerWI=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
