...
// buildOptions=-D MASK_BINARY_OP -D OP_AND -D dstT=short2 -D dstT_C1=short -D workST=short2 -D cn=2 -D rowsPerWI=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D MASK_BINARY_OP -D OP_AND -D dstT=short2 -D dstT_C1=short -D workST=short2 -D cn=2 -D rowsPerWI=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
