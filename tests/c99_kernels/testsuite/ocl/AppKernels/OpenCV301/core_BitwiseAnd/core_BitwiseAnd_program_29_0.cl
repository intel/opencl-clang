...
// buildOptions=-D MASK_BINARY_OP -D OP_AND -D dstT=int -D dstT_C1=int -D workST=int -D cn=1 -D rowsPerWI=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D MASK_BINARY_OP -D OP_AND -D dstT=int -D dstT_C1=int -D workST=int -D cn=1 -D rowsPerWI=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
