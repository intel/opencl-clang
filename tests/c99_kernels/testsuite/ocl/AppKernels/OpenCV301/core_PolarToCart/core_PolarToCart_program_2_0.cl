...
// buildOptions=-D dstT=float -D rowsPerWI=4 -D depth=5 -D BINARY_OP -D OP_PTC_AR -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D dstT=float -D rowsPerWI=4 -D depth=5 -D BINARY_OP -D OP_PTC_AR -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
