...
// buildOptions=-D srcT=uchar -D dstT=uchar -D convertToWT=convert_float -D cn=1 -D rowsPerWI=4 -D convertToDT=convert_uchar_sat_rte -D workT=float -D HAVE_SCALE -D srcT1=uchar -D dstT1=uchar -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D srcT=uchar -D dstT=uchar -D convertToWT=convert_float -D cn=1 -D rowsPerWI=4 -D convertToDT=convert_uchar_sat_rte -D workT=float -D HAVE_SCALE -D srcT1=uchar -D dstT1=uchar -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
