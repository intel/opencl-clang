...
// buildOptions=-D srcT=char -D dstT=char -D convertToWT=convert_float -D cn=1 -D rowsPerWI=4 -D convertToDT=convert_char_sat_rte -D workT=float -D HAVE_SCALE -D srcT1=char -D dstT1=char -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D srcT=char -D dstT=char -D convertToWT=convert_float -D cn=1 -D rowsPerWI=4 -D convertToDT=convert_char_sat_rte -D workT=float -D HAVE_SCALE -D srcT1=char -D dstT1=char -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
