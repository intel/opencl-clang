...
// buildOptions=-D MASK_BINARY_OP -D OP_XOR -D dstT=ulong -D dstT_C1=ulong -D workST=ulong -D cn=1 -D rowsPerWI=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D MASK_BINARY_OP -D OP_XOR -D dstT=ulong -D dstT_C1=ulong -D workST=ulong -D cn=1 -D rowsPerWI=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
