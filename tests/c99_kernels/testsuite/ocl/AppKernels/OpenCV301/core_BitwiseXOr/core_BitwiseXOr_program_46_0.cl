...
// buildOptions=-D UNARY_OP -D OP_XOR -D dstT=ushort2 -D dstT_C1=ushort -D workST=ushort2 -D cn=2 -D rowsPerWI=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D UNARY_OP -D OP_XOR -D dstT=ushort2 -D dstT_C1=ushort -D workST=ushort2 -D cn=2 -D rowsPerWI=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
