...
// buildOptions=-D UNARY_OP -D OP_XOR -D dstT=short -D dstT_C1=short -D workST=short -D cn=1 -D rowsPerWI=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D UNARY_OP -D OP_XOR -D dstT=short -D dstT_C1=short -D workST=short -D cn=1 -D rowsPerWI=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
