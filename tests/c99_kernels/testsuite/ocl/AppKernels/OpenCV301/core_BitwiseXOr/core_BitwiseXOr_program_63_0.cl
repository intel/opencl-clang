...
// buildOptions=-D MASK_UNARY_OP -D OP_XOR -D dstT=uchar3 -D dstT_C1=uchar -D workST=uchar4 -D cn=3 -D rowsPerWI=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D MASK_UNARY_OP -D OP_XOR -D dstT=uchar3 -D dstT_C1=uchar -D workST=uchar4 -D cn=3 -D rowsPerWI=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
