...
// buildOptions=-D BINARY_OP -D OP_ABSDIFF -D srcT1=uchar4 -D srcT1_C1=uchar -D srcT2=uchar4 -D srcT2_C1=uchar -D dstT=uchar4 -D dstT_C1=uchar -D workT=int4 -D workST=int4 -D scaleT=int -D wdepth=4 -D convertToWT1=convert_int4 -D convertToWT2=convert_int4 -D convertToDT=convert_uchar4_sat -D cn=4 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D BINARY_OP -D OP_ABSDIFF -D srcT1=uchar4 -D srcT1_C1=uchar -D srcT2=uchar4 -D srcT2_C1=uchar -D dstT=uchar4 -D dstT_C1=uchar -D workT=int4 -D workST=int4 -D scaleT=int -D wdepth=4 -D convertToWT1=convert_int4 -D convertToWT2=convert_int4 -D convertToDT=convert_uchar4_sat -D cn=4 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
