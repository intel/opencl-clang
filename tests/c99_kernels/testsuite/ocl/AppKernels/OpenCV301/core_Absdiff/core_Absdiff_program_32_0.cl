...
// buildOptions=-D UNARY_OP -D OP_ABSDIFF -D srcT1=int4 -D srcT1_C1=int -D srcT2=int4 -D srcT2_C1=int -D dstT=int4 -D dstT_C1=int -D workT=int4 -D workST=int4 -D scaleT=int -D wdepth=4 -D convertToWT1=noconvert -D convertToWT2=noconvert -D convertToDT=noconvert -D cn=4 -D rowsPerWI=4 -D convertFromU=convert_int4 -D INTEL_DEVICE
