...
// buildOptions=-D OP_SCALE_ADD -D BINARY_OP -D dstT=float -D workT=float -D convertToWT1=noconvert -D srcT1=dstT -D srcT2=dstT -D convertToDT=noconvert -D workT1=float -D wdepth=5 -D rowsPerWI=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D OP_SCALE_ADD -D BINARY_OP -D dstT=float -D workT=float -D convertToWT1=noconvert -D srcT1=dstT -D srcT2=dstT -D convertToDT=noconvert -D workT1=float -D wdepth=5 -D rowsPerWI=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
