...
// buildOptions=-D OP_SCALE_ADD -D BINARY_OP -D dstT=int -D workT=float -D convertToWT1=convert_float -D srcT1=dstT -D srcT2=dstT -D convertToDT=convert_int_rte -D workT1=float -D wdepth=5 -D rowsPerWI=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D OP_SCALE_ADD -D BINARY_OP -D dstT=int -D workT=float -D convertToWT1=convert_float -D srcT1=dstT -D srcT2=dstT -D convertToDT=convert_int_rte -D workT1=float -D wdepth=5 -D rowsPerWI=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
