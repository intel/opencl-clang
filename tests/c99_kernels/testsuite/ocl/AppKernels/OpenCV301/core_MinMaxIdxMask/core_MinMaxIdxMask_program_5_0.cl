...
// buildOptions=-D DEPTH_2 -D srcT1=ushort -D HAVE_MASK -D WGS=256 -D srcT=ushort -D WGS2_ALIGNED=128 -D HAVE_SRC_CONT -D HAVE_MASK_CONT -D kercn=1 -D NEED_MINVAL -D NEED_MAXVAL -D NEED_MINLOC -D NEED_MAXLOC -D dstT1=ushort -D dstT=ushort -D convertToDT=noconvert -D wdepth=2 -D convertFromU=noconvert -D MINMAX_STRUCT_ALIGNMENT=8 -D INTEL_DEVICE
