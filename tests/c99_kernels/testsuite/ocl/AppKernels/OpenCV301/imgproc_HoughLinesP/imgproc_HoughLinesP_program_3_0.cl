...
// buildOptions=-D FILL_ACCUM_LOCAL -D LOCAL_SIZE=256 -D BUFFER_SIZE=1403 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D FILL_ACCUM_LOCAL -D LOCAL_SIZE=256 -D BUFFER_SIZE=1403 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
// XFAIL: *
