...
// buildOptions=-D MAKE_POINTS_LIST -D GROUP_SIZE=25 -D LOCAL_SIZE=400 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D MAKE_POINTS_LIST -D GROUP_SIZE=25 -D LOCAL_SIZE=400 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
