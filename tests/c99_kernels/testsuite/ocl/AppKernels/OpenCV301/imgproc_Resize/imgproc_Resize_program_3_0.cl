...
// buildOptions=-D USE_SAMPLER -D depth=0 -D T=uchar -D T1=uchar -D convertToDT=convert_uchar_sat -D cn=1 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D USE_SAMPLER -D depth=0 -D T=uchar -D T1=uchar -D convertToDT=convert_uchar_sat -D cn=1 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
