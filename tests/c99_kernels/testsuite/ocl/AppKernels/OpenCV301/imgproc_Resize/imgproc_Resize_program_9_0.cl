...
// buildOptions=-D USE_SAMPLER -D depth=2 -D T=ushort2 -D T1=ushort -D convertToDT=convert_ushort2_sat -D cn=2 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D USE_SAMPLER -D depth=2 -D T=ushort2 -D T1=ushort -D convertToDT=convert_ushort2_sat -D cn=2 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
