...
// buildOptions=-D INTER_LINEAR -D depth=0 -D T=uchar4 -D T1=uchar -D WT=int4 -D convertToWT=convert_int4 -D convertToDT=convert_uchar4_sat -D cn=4 -D INTER_RESIZE_COEF_BITS=11 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D INTER_LINEAR -D depth=0 -D T=uchar4 -D T1=uchar -D WT=int4 -D convertToWT=convert_int4 -D convertToDT=convert_uchar4_sat -D cn=4 -D INTER_RESIZE_COEF_BITS=11 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
