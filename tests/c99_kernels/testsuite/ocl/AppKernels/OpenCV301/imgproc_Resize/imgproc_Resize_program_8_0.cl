...
// buildOptions=-D INTER_LINEAR -D depth=2 -D T=ushort2 -D T1=ushort -D WT=int2 -D convertToWT=convert_int2 -D convertToDT=convert_ushort2_sat -D cn=2 -D INTER_RESIZE_COEF_BITS=11 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D INTER_LINEAR -D depth=2 -D T=ushort2 -D T1=ushort -D WT=int2 -D convertToWT=convert_int2 -D convertToDT=convert_ushort2_sat -D cn=2 -D INTER_RESIZE_COEF_BITS=11 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
