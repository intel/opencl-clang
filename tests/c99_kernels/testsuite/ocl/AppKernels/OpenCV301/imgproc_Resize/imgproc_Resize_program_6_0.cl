...
// buildOptions=-D USE_SAMPLER -D depth=0 -D T=uchar4 -D T1=uchar -D convertToDT=convert_uchar4_sat -D cn=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D USE_SAMPLER -D depth=0 -D T=uchar4 -D T1=uchar -D convertToDT=convert_uchar4_sat -D cn=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
