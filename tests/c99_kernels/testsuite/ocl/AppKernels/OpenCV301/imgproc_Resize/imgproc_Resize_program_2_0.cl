...
// buildOptions=-D INTER_LINEAR -D depth=0 -D T=uchar -D T1=uchar -D WT=int -D convertToWT=convert_int -D convertToDT=convert_uchar_sat -D cn=1 -D INTER_RESIZE_COEF_BITS=11 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D INTER_LINEAR -D depth=0 -D T=uchar -D T1=uchar -D WT=int -D convertToWT=convert_int -D convertToDT=convert_uchar_sat -D cn=1 -D INTER_RESIZE_COEF_BITS=11 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
