...
// buildOptions=-D BINARY_OP -D OP_MUL -D srcT1=short -D srcT1_C1=short -D srcT2=short -D srcT2_C1=short -D dstT=short -D dstT_C1=short -D workT=float -D workST=float -D scaleT=float -D wdepth=5 -D convertToWT1=convert_float -D convertToWT2=convert_float -D convertToDT=convert_short_sat_rte -D cn=1 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D BINARY_OP -D OP_MUL -D srcT1=short -D srcT1_C1=short -D srcT2=short -D srcT2_C1=short -D dstT=short -D dstT_C1=short -D workT=float -D workST=float -D scaleT=float -D wdepth=5 -D convertToWT1=convert_float -D convertToWT2=convert_float -D convertToDT=convert_short_sat_rte -D cn=1 -D rowsPerWI=4 -D convertFromU=noconvert -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
