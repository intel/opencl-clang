...
// buildOptions=-D BINS=256 -D HISTS_COUNT=20 -D WGS=256 -D kercn=1 -D T=uchar -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D BINS=256 -D HISTS_COUNT=20 -D WGS=256 -D kercn=1 -D T=uchar -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
