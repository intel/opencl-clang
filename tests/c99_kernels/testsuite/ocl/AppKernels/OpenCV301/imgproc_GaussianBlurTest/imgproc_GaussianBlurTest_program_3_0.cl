...
// buildOptions=-D RADIUSX=1 -D LSIZE0=16 -D LSIZE1=16 -D CN=1 -D BORDER_REPLICATE -D EXTRA_EXTRAPOLATION -D NO_BORDER_ISOLATED -D srcT=uchar -D dstT=float -D convertToDstT=convert_float -D srcT1=uchar -D dstT1=float -D INTEGER_ARITHMETIC -D COEFF=DIG(60.00000000f)DIG(136.0000000f)DIG(60.00000000f) -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D RADIUSX=1 -D LSIZE0=16 -D LSIZE1=16 -D CN=1 -D BORDER_REPLICATE -D EXTRA_EXTRAPOLATION -D NO_BORDER_ISOLATED -D srcT=uchar -D dstT=float -D convertToDstT=convert_float -D srcT1=uchar -D dstT1=float -D INTEGER_ARITHMETIC -D COEFF=DIG(60.00000000f)DIG(136.0000000f)DIG(60.00000000f) -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
