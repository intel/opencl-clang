...
// buildOptions=-D RADIUSY=1 -D LSIZE0=16 -D LSIZE1=16 -D CN=1 -D srcT=float -D dstT=uchar -D convertToDstT=convert_uchar_sat_rte -D srcT1=float -D dstT1=uchar -D SHIFT_BITS=16 -D INTEGER_ARITHMETIC -D COEFF=DIG(30.00000000f)DIG(196.0000000f)DIG(30.00000000f) -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D RADIUSY=1 -D LSIZE0=16 -D LSIZE1=16 -D CN=1 -D srcT=float -D dstT=uchar -D convertToDstT=convert_uchar_sat_rte -D srcT1=float -D dstT1=uchar -D SHIFT_BITS=16 -D INTEGER_ARITHMETIC -D COEFF=DIG(30.00000000f)DIG(196.0000000f)DIG(30.00000000f) -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
