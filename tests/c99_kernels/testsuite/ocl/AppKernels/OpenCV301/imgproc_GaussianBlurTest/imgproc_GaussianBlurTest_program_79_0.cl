...
// buildOptions=-D RADIUSX=1 -D LSIZE0=16 -D LSIZE1=16 -D CN=4 -D BORDER_REPLICATE -D EXTRA_EXTRAPOLATION -D NO_BORDER_ISOLATED -D srcT=ushort4 -D dstT=float4 -D convertToDstT=convert_float4 -D srcT1=ushort -D dstT1=float -D COEFF=DIG(0.2349398732f)DIG(0.5301202536f)DIG(0.2349398732f) -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D RADIUSX=1 -D LSIZE0=16 -D LSIZE1=16 -D CN=4 -D BORDER_REPLICATE -D EXTRA_EXTRAPOLATION -D NO_BORDER_ISOLATED -D srcT=ushort4 -D dstT=float4 -D convertToDstT=convert_float4 -D srcT1=ushort -D dstT1=float -D COEFF=DIG(0.2349398732f)DIG(0.5301202536f)DIG(0.2349398732f) -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
