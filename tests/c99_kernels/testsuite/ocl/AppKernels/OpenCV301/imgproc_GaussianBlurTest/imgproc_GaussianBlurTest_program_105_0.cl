...
// buildOptions=-D BLK_X=16 -D BLK_Y=8 -D RADIUSX=2 -D RADIUSY=2 -D KERNEL_MATRIX_X=DIG(1.734861326e-005f)DIG(0.05876003206f)DIG(0.8824452162f)DIG(0.05876003206f)DIG(1.734861326e-005f) -D KERNEL_MATRIX_Y=DIG(1.734861326e-005f)DIG(0.05876003206f)DIG(0.8824452162f)DIG(0.05876003206f)DIG(1.734861326e-005f) -D srcT=float -D convertToWT=noconvert -D WT=float -D dstT=float -D convertToDstT=noconvert -D BORDER_REFLECT_101 -D srcT1=float -D dstT1=float -D WT1=float -D CN=1 -D SHIFT_BITS=16 -D INTEL_DEVICE
