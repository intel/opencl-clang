...
// buildOptions=-D BLK_X=16 -D BLK_Y=8 -D RADIUSX=1 -D RADIUSY=1 -D KERNEL_MATRIX_X=DIG(15.00000000f)DIG(226.0000000f)DIG(15.00000000f) -D KERNEL_MATRIX_Y=DIG(15.00000000f)DIG(226.0000000f)DIG(15.00000000f) -D srcT=uchar4 -D convertToWT=convert_float4 -D WT=float4 -D dstT=uchar4 -D convertToDstT=convert_uchar4_sat_rte -D BORDER_REFLECT -D srcT1=uchar -D dstT1=uchar -D WT1=float -D CN=4 -D SHIFT_BITS=16 -D INTEGER_ARITHMETIC -D INTEL_DEVICE
