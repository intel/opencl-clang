...
// buildOptions=-D ACCUMULATE_PRODUCT -D HAVE_MASK -D srcT1=float -D cn=4 -D dstT1=float -D rowsPerWI=4 -D convertToDT=noconvert -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D ACCUMULATE_PRODUCT -D HAVE_MASK -D srcT1=float -D cn=4 -D dstT1=float -D rowsPerWI=4 -D convertToDT=noconvert -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
