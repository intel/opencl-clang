...
// buildOptions=-D anX=1 -D anY=1 -D ksX=3 -D ksY=3 -D BORDER_CONSTANT -D CORNER_HARRIS -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D anX=1 -D anY=1 -D ksX=3 -D ksY=3 -D BORDER_CONSTANT -D CORNER_HARRIS -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
