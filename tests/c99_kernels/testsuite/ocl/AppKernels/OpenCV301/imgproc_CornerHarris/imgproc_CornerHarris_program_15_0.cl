...
// buildOptions=-D BLK_X=16 -D BLK_Y=16 -D BORDER_REFLECT -D SRCTYPE=float -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D BLK_X=16 -D BLK_Y=16 -D BORDER_REFLECT -D SRCTYPE=float -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
