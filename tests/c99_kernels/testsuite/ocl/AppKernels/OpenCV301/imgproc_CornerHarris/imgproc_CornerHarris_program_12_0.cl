...
// buildOptions=-D anX=2 -D anY=2 -D ksX=5 -D ksY=5 -D BORDER_REFLECT101 -D CORNER_HARRIS -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D anX=2 -D anY=2 -D ksX=5 -D ksY=5 -D BORDER_REFLECT101 -D CORNER_HARRIS -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
