...
// buildOptions=-D cn=2 -D srcT=int2 -D srcT1=int -D dstT=uchar -D kercn=2 -D depth=4 -D colsPerWI=1 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D cn=2 -D srcT=int2 -D srcT1=int -D dstT=uchar -D kercn=2 -D depth=4 -D colsPerWI=1 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
