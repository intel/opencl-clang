...
// buildOptions=-D cn=3 -D srcT=short3 -D srcT1=short -D dstT=uchar -D kercn=3 -D depth=3 -D colsPerWI=1 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D cn=3 -D srcT=short3 -D srcT1=short -D dstT=uchar -D kercn=3 -D depth=3 -D colsPerWI=1 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
