...
// buildOptions=-D cn=2 -D srcT=uchar2 -D srcT1=uchar -D dstT=uchar -D kercn=2 -D depth=0 -D colsPerWI=1 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D cn=2 -D srcT=uchar2 -D srcT1=uchar -D dstT=uchar -D kercn=2 -D depth=0 -D colsPerWI=1 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
