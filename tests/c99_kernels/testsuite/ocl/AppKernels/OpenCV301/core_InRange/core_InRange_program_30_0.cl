...
// buildOptions=-D HAVE_SCALAR -D cn=2 -D srcT=char2 -D srcT1=char -D dstT=uchar -D kercn=2 -D depth=1 -D colsPerWI=1 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D HAVE_SCALAR -D cn=2 -D srcT=char2 -D srcT1=char -D dstT=uchar -D kercn=2 -D depth=1 -D colsPerWI=1 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
