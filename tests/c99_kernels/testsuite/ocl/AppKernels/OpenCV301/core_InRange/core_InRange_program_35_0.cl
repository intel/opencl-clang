...
// buildOptions=-D HAVE_SCALAR -D cn=3 -D srcT=ushort3 -D srcT1=ushort -D dstT=uchar -D kercn=3 -D depth=2 -D colsPerWI=1 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D HAVE_SCALAR -D cn=3 -D srcT=ushort3 -D srcT1=ushort -D dstT=uchar -D kercn=3 -D depth=2 -D colsPerWI=1 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
