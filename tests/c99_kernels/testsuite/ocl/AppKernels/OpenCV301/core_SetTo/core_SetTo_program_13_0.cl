...
// buildOptions=-D dstT=short -D rowsPerWI=4 -D dstST=short -D dstT1=short -D cn=1 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D dstT=short -D rowsPerWI=4 -D dstST=short -D dstT1=short -D cn=1 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
