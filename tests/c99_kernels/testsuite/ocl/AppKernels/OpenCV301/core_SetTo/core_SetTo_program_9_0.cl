...
// buildOptions=-D dstT=ushort -D rowsPerWI=4 -D dstST=ushort -D dstT1=ushort -D cn=1 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D dstT=ushort -D rowsPerWI=4 -D dstST=ushort -D dstT1=ushort -D cn=1 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
