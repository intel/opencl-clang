...
// buildOptions=-D dstT=char4 -D rowsPerWI=4 -D dstST=char4 -D dstT1=char -D cn=4 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D dstT=char4 -D rowsPerWI=4 -D dstST=char4 -D dstT1=char -D cn=4 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
