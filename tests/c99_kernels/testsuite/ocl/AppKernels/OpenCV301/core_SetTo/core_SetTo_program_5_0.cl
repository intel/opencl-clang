...
// buildOptions=-D dstT=char -D rowsPerWI=4 -D dstST=char -D dstT1=char -D cn=1 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D dstT=char -D rowsPerWI=4 -D dstST=char -D dstT1=char -D cn=1 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
