...
// buildOptions=-D T=ushort2 -D nx=2 -D ny=1 -D rowsPerWI=4 -D cn=2 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D T=ushort2 -D nx=2 -D ny=1 -D rowsPerWI=4 -D cn=2 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
