...
// buildOptions=-D depth=0 -D scn=3 -D PIX_PER_WI_Y=4 -D dcn=3 -D bidx=0 -D hrange=180 -D hscale=0.033333f -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D depth=0 -D scn=3 -D PIX_PER_WI_Y=4 -D dcn=3 -D bidx=0 -D hrange=180 -D hscale=0.033333f -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
