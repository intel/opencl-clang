...
// buildOptions=-D depth=0 -D scn=4 -D PIX_PER_WI_Y=4 -D hscale=0.500000f -D bidx=2 -D dcn=3 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D depth=0 -D scn=4 -D PIX_PER_WI_Y=4 -D hscale=0.500000f -D bidx=2 -D dcn=3 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
