...
// buildOptions=-D depth=0 -D scn=3 -D PIX_PER_WI_Y=4 -D dcn=4 -D bidx=2 -D hrange=255 -D hscale=0.023529f -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D depth=0 -D scn=3 -D PIX_PER_WI_Y=4 -D dcn=4 -D bidx=2 -D hrange=255 -D hscale=0.023529f -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
