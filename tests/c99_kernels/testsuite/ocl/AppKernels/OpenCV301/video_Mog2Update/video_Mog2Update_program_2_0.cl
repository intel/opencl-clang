...
// buildOptions=-D CN=1 -D NMIXTURES=5 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D CN=1 -D NMIXTURES=5 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
