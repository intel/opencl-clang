...
// buildOptions=-D srcT=uchar3 -D srcT1=uchar -D dstT=int3 -D dstT1=int -D sqddepth=5 -D sqdstT=float3 -D sqdstT1=float -D convertToSDT=convert_float3 -D cn=3 -D HAVE_MASK_CONT -D convertToDT=convert_int3 -D WGS=256 -D WGS2_ALIGNED=128 -D INTEL_DEVICE
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D srcT=uchar3 -D srcT1=uchar -D dstT=int3 -D dstT1=int -D sqddepth=5 -D sqdstT=float3 -D sqdstT1=float -D convertToSDT=convert_float3 -D cn=3 -D HAVE_MASK_CONT -D convertToDT=convert_int3 -D WGS=256 -D WGS2_ALIGNED=128 -D INTEL_DEVICE" %cfg_path --cl-device=%cl_device 2>&1
