...
// buildOptions=-D srcT=uchar4 -D srcT1=uchar -D dstT=int4 -D dstT1=int -D sqddepth=5 -D sqdstT=float4 -D sqdstT1=float -D convertToSDT=convert_float4 -D cn=4 -D HAVE_SRC_CONT -D HAVE_MASK_CONT -D convertToDT=convert_int4 -D WGS=256 -D WGS2_ALIGNED=128 -D INTEL_DEVICE
