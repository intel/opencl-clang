...
// buildOptions=-D REAL3=float3 -D REAL=float -D REAL4=float4 -D ZERO3=(0,0,0)
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D REAL3=float3 -D REAL=float -D REAL4=float4 -D ZERO3=(0,0,0)" %cfg_path --cl-device=%cl_device 2>&1
