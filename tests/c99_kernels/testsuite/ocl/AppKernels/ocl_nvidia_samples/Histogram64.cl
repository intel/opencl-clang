...
// buildOptions=-D HISTOGRAM64_WORKGROUP_SIZE=10 -D LOCAL_MEMORY_BANKS=123 -D MERGE_WORKGROUP_SIZE=256
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D HISTOGRAM64_WORKGROUP_SIZE=10 -D LOCAL_MEMORY_BANKS=123 -D MERGE_WORKGROUP_SIZE=256" %cfg_path --cl-device=%cl_device 2>&1
