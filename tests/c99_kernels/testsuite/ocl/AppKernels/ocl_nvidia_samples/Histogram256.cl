...
// buildOptions=-D LOG2_WARP_SIZE=4 -D UITN_BITS=32 -D WARP_COUNT=3 -D MERGE_WORKGROUP_SIZE=44
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D LOG2_WARP_SIZE=4 -D UITN_BITS=32 -D WARP_COUNT=3 -D MERGE_WORKGROUP_SIZE=44" %cfg_path --cl-device=%cl_device 2>&1
