                        ...
                        __local unsigned int* uiLocalBuff)
{
    ...
    xIndex = mul24((uint)get_group_id(1), (uint)get_local_size(1)) + get_local_id(0);
    yIndex = mul24((uint)get_group_id(0), (uint)get_local_size(0)) + get_local_id(1);
                                  ...
                                  int iWidth, int iHeight, float a)
{
    ...
    unsigned int X = mul24((uint)get_group_id(0), (uint)get_local_size(0)) + get_local_id(0);
	if (X >= iWidth) return;
