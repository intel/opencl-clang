                       ...
                       )
{
    ...
    int iDevGMEMOffset = mul24((uint)iDevYPrime, (uint)get_global_size(0)) + iImagePosX;

    // Compute initial offset of current pixel within work group LMEM block
    int iLocalPixOffset = mul24((uint)get_local_id(1), (uint)iLocalPixPitch) + get_local_id(0) + 1;
    ...
    if (get_local_id(1) < 2)
    {
        ...
        iLocalPixOffset += mul24((int)get_local_size(1), (int)iLocalPixPitch);
        ...
        if (((iDevYPrime + get_local_size(1)) < iDevImageHeight) && (iImagePosX < iImageWidth))
        {
            ...
            uc4LocalData[iLocalPixOffset] = uc4Source[iDevGMEMOffset + mul24((uint)get_local_size(1), (uint)get_global_size(0))];
        }
        else
        {
            uc4LocalData[iLocalPixOffset] = (uchar4)0;
    ...
    if (get_local_id(0) == (get_local_size(0) - 1))
    {
        ...
        iLocalPixOffset = mul24((int)get_local_id(1), (int)iLocalPixPitch);
        ...
        if ((iDevYPrime > -1) && (iDevYPrime < iDevImageHeight) && (get_group_id(0) > 0))
        {
            ...
            uc4LocalData[iLocalPixOffset] = uc4Source[mul24((int)iDevYPrime, (int)get_global_size(0)) + mul24((uint)get_group_id(0), (uint)get_local_size(0)) - 1];
        }
        else
        {
            uc4LocalData[iLocalPixOffset] = (uchar4)0;
        ...
        if (get_local_id(1) < 2)
        {
            ...
            if (((iDevYPrime + get_local_size(1)) < iDevImageHeight) && (get_group_id(0) > 0))
            {
                ...
                uc4LocalData[iLocalPixOffset] = uc4Source[mul24((iDevYPrime + (int)get_local_size(1)), (int)get_global_size(0)) + mul24((uint)get_group_id(0), get_local_size(0)) - 1];
            }
            else
            {
                uc4LocalData[iLocalPixOffset] = (uchar4)0;
    ...
    else if (get_local_id(0) == 0) // Work items with x ID at left workgroup edge will read right apron pixel
    {
        ...
        if ((iDevYPrime > -1) && (iDevYPrime < iDevImageHeight) && (mul24(((int)get_group_id(0) + 1), (int)get_local_size(0)) < iImageWidth))
        {
            ...
            uc4LocalData[iLocalPixOffset] = uc4Source[mul24(iDevYPrime, (int)get_global_size(0)) + mul24((get_group_id(0) + 1), (uint)get_local_size(0))];
        }
        else
        {
            uc4LocalData[iLocalPixOffset] = (uchar4)0;
        ...
        if (get_local_id(1) < 2)
        {
            ...
            if (((iDevYPrime + get_local_size(1)) < iDevImageHeight) && (mul24((get_group_id(0) + 1), (uint)get_local_size(0)) < iImageWidth) )
            {
                ...
                uc4LocalData[iLocalPixOffset] = uc4Source[mul24((iDevYPrime + (int)get_local_size(1)), (int)get_global_size(0)) + mul24((get_group_id(0) + 1), (uint)get_local_size(0))];
            }
            else
            {
                uc4LocalData[iLocalPixOffset] = (uchar4)0;
