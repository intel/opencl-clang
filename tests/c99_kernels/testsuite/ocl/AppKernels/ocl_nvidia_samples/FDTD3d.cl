...
// buildOptions=-D MAXWORKY=10 -D MAXWORKX=10 -D RADIUS=3
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D MAXWORKY=10 -D MAXWORKX=10 -D RADIUS=3" %cfg_path --cl-device=%cl_device 2>&1
