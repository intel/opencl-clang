...
// buildOptions=-D T=float -D blockSize=64 -D nIsPow2=true
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D T=float -D blockSize=64 -D nIsPow2=true" %cfg_path --cl-device=%cl_device 2>&1
