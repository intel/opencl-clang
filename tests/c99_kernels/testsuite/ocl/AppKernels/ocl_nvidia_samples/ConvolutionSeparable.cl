...
// buildOptions=-D COLUMNS_BLOCKDIM_Y=10  -D COLUMNS_BLOCKDIM_X=10 -D ROWS_BLOCKDIM_X=10 -D ROWS_BLOCKDIM_Y=10 -D ROWS_RESULT_STEPS=20 -D COLUMNS_RESULT_STEPS=20 -D ROWS_HALO_STEPS=4 -D COLUMNS_HALO_STEPS=4 -D KERNEL_RADIUS=3
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D COLUMNS_BLOCKDIM_Y=10  -D COLUMNS_BLOCKDIM_X=10 -D ROWS_BLOCKDIM_X=10 -D ROWS_BLOCKDIM_Y=10 -D ROWS_RESULT_STEPS=20 -D COLUMNS_RESULT_STEPS=20 -D ROWS_HALO_STEPS=4 -D COLUMNS_HALO_STEPS=4 -D KERNEL_RADIUS=3" %cfg_path --cl-device=%cl_device 2>&1
