...
__kernel void zc20949a44d(__global float4*zf8d9fd6cb8,__global float4*
z718a062ddd,int8 z30eaaf69b7,uint z021babbfad,uint z958df11031,float zab55369935
...
__kernel void zc20949a44d(__global float4*zf8d9fd6cb8,__global float4*
z718a062ddd,int8 z30eaaf69b7,uint z021babbfad,uint z958df11031,float2
z5b8c31c8e4,float4 zed5a2cac4e){int2 zba94ee46da=(int2)(get_global_id(0),
get_global_id(1));if(zba94ee46da.x>=z30eaaf69b7.s2||zba94ee46da.y>=z30eaaf69b7.
s3)return;int2 z83640e5796=zba94ee46da+z30eaaf69b7.s45;zba94ee46da+=z30eaaf69b7.
s01;float4 z493deefb55=zf8d9fd6cb8[z83640e5796.x+z83640e5796.y*(z021babbfad)];
float ze4b052164b=z493deefb55.s0;float z2e91460297=z493deefb55.s1;float
z7e674d442a=z493deefb55.s2;
...
get_global_id(1));if(zba94ee46da.x>=z30eaaf69b7.s2||zba94ee46da.y>=z30eaaf69b7.
s3)return;int2 z83640e5796=zba94ee46da+z30eaaf69b7.s45;zba94ee46da+=z30eaaf69b7.
s01;float4 z324e6de430=zf8d9fd6cb8[z83640e5796.x+z83640e5796.y*(z021babbfad)];
float4 ze4351005bc;float zf58e28dfbc=z324e6de430.s0*(1.f/z5b8c31c8e4.s0);
...
,__global float4*z718a062ddd,int8 z30eaaf69b7,uint z45c01651ac,uint z958df11031)
{int2 zba94ee46da=(int2)(get_global_id(0),get_global_id(1));if(zba94ee46da.x>=
z30eaaf69b7.s2||zba94ee46da.y>=z30eaaf69b7.s3)return;int2 z83640e5796=
...
__kernel void zc20949a44d(__global float4*zf8d9fd6cb8,__global float4*
z718a062ddd,int8 z30eaaf69b7,uint z45c01651ac,uint z958df11031,float4
z7c54807ee5){int2 zba94ee46da=(int2)(get_global_id(0),get_global_id(1));if(
...
z395b96baac=zf8d9fd6cb8[z83640e5796.x+z83640e5796.y*(z45c01651ac)];float4
ze4351005bc=z718a062ddd[zba94ee46da.x+zba94ee46da.y*(z958df11031)];const float
zdbd1b64bbd=z7c54807ee5.s0;const float z0893e495b9=z7c54807ee5.s1;const float
z9f2409475e=z7c54807ee5.s2;const float z7c95d32f3a=z7c54807ee5.s3;
