...
z6d7333005c(zb273728874,z305c8a97dc);bool z7b437af491=(fabs(z0e9f85a3b3)>=0.001f
);bool zb696c584b7=(fabs(zdf15203512)>=0.001f);float4 ze8a7296882=convert_float4
(z4633c865c6);if(zb696c584b7){
