...
typedef int zdba6b93f69;__kernel void zb4a41b922a(__global ushort*za1a97eb1a6,
__global float4*zc558e28212,int4 z30eaaf69b7,uint z58c1e26fb1,uint z958df11031,
float2 zf184786901,float z4b359ac3f7,__global float4*z69c89f1ddb,int4
z2bdcf1622d
#if zbc6516e8d5
,__local ushort*zf485e5e12c
#endif
){int2 zba94ee46da=(int2)(2*get_global_id(0),get_global_id(1));if(zba94ee46da.x+
1>=z30eaaf69b7.z||zba94ee46da.y>=z30eaaf69b7.w)return;
int2 z83640e5796=zba94ee46da;__global ushort*zf8d9fd6cb8=za1a97eb1a6+z30eaaf69b7
.x+z30eaaf69b7.y*z58c1e26fb1;__global float4*z718a062ddd=zc558e28212+z30eaaf69b7
.x+z30eaaf69b7.y*(z958df11031/4);zdba6b93f69 z198f8f5bb8=2;zdba6b93f69
...
#endif
float z2c2edb5c43=0.f;if(z2bdcf1622d.z>0){int2 z2d8c19d9c9=(zba94ee46da+
z2bdcf1622d.xy)/(int2)(8,8);float4 z340a9974be=z69c89f1ddb[z2d8c19d9c9.x+
z2d8c19d9c9.y*z2bdcf1622d.z];
z2c2edb5c43=fabs(z340a9974be.x-z340a9974be.y);}
...
else{z4e601f9b2d=z976c4c4519;z5c2c3bdbd0=zc20893b06d;}float w=1.0f;if(
z2c2edb5c43>=0.1f)w=1.f+z2c2edb5c43*z2c2edb5c43*z2c2edb5c43*2.5f;
if(z8b418de27c<z5c2c3bdbd0*w&&ze4d2e61ee9<zd4b983e425)z234809fd59=z23ae35c8d7;
else if(z4e601f9b2d<z93d66aa12c*w&&zd4b983e425<ze4d2e61ee9)z234809fd59=
z54fd70a5dd;else{z234809fd59=zfc1306fadf;
