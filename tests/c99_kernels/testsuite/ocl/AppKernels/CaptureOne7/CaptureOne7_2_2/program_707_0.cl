...
z8a7ff02448,float2 z5462909dc1){int2 zba94ee46da=(int2)(get_global_id(0),
get_global_id(1));if(zba94ee46da.x>=z30eaaf69b7.s2||zba94ee46da.y>=z30eaaf69b7.
s3)return;__global z6aa1f558f1*zf8d9fd6cb8=zba15fb8bb8+z30eaaf69b7.s4+
z30eaaf69b7.s5*z2824fcf57d;float2 z4377fdece7=convert_float2(zba94ee46da)+(
float2)0.5f;
