...
return dot(ze28128c2dd,(float4)(1.0f,-1.105f,1.702f,0.0f));}float z3741ed4e99(
float z64e69d3b08){float z55c265223f=z64e69d3b08*0.005f;if(z55c265223f<0)
z55c265223f*=0.5f;
z55c265223f*=1.2f;return z55c265223f;}__kernel void z1a1bdd4bc6(__global ushort4
*zf8d9fd6cb8,__global ushort4*z718a062ddd,int4 z30eaaf69b7,uint z45c01651ac,uint
 zb41a4b7008,__global float4*z758a551ffb,uint z13849615d3,float zf7fc1a6db6,int2
 zd72c7cd02e,int zce7e428e71,int z5599675f2e,__global uchar*zec145e35cf,int16
...
;
z0d8849857d=z0d8849857d*(1.0f/(z56abd2ad9d*z9c02de091b));
...
za22b597f84[z1d8bd19892];}}zf7fc1a6db6=z3741ed4e99(zf7fc1a6db6);if(zce7e428e71<8
)
zf7fc1a6db6*=2.0f;
