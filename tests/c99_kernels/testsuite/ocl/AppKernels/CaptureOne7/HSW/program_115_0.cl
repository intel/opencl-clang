...
__global float*z718a062ddd,int4 z30eaaf69b7,uint z45c01651ac,uint z958df11031,
int2 zd72c7cd02e){int2 zba94ee46da=(int2)(get_global_id(0),get_global_id(1));if(
