...
z55c265223f=max(-1.0f,z55c265223f);return z55c265223f;}
#else
float zed389ca108(float z64e69d3b08){float z55c265223f;if(z64e69d3b08<0.0f)
z55c265223f=z64e69d3b08*0.01f;else z55c265223f=z64e69d3b08*0.02f;
z55c265223f=max(-1.0f,z55c265223f);return z55c265223f;}
#endif
...
,int8 z30eaaf69b7,int z021babbfad,int z958df11031){int2 zba94ee46da=(int2)(
...
z718a062ddd,int8 z30eaaf69b7,int z021babbfad,int z958df11031,float4 zdcf7ad01e1,
__global float*z5413c0ac97,int4 z0cda232ab2,__global float*z6dbcfbb363,int4
zf719ec198f,__global uchar*zec145e35cf,int16 z7f76fb323c,int4 z3576e84f20,
