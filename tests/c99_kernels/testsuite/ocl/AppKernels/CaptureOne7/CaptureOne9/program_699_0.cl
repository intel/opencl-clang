...
z718a062ddd,int8 z30eaaf69b7,int z2824fcf57d,int z9562068e13,float8 z3c211c8179)
...
z64a05257f8=z3c211c8179.s0;float z947813c07b=z3c211c8179.s1;float z19f71788a3=
z3c211c8179.s2;float zef2403cf04=z3c211c8179.s3;float ze82613f501=z3c211c8179.s4
;float zfe91d24aed=z3c211c8179.s5;
...
float z5413c0ac97=(ze4b052164b*(1.f/z64a05257f8)+z2e91460297*(2.f/z947813c07b)+
z7e674d442a*(1.f/z19f71788a3))*0.25f;float z7a5269b418=MAX(ze4b052164b*(1.f/
z64a05257f8),z2e91460297*(1.f/z947813c07b));z7a5269b418=MAX(z7a5269b418,
z7e674d442a*(1.f/z19f71788a3));
if(z64a05257f8<MIN(z947813c07b,z19f71788a3)){if(z2e91460297<zef2403cf04*
z947813c07b&&z2e91460297>ze4b052164b){float zcfff1e38a8=z2e91460297*(1.f/(
zef2403cf04*z947813c07b));zcfff1e38a8=MAX(ze82613f501,MIN(1.f,zcfff1e38a8));
z2e91460297=zcfff1e38a8*z2e91460297+(1.f-zcfff1e38a8)*z2e91460297*(1.f/
z947813c07b);z2e91460297=MAX(z2e91460297,ze4b052164b);}if(z7e674d442a<
zef2403cf04*z19f71788a3&&z7e674d442a>ze4b052164b){float ze4d1094aab=z7e674d442a*
(1.f/(zef2403cf04*z19f71788a3));ze4d1094aab=MAX(ze82613f501,MIN(1.f,ze4d1094aab)
);z7e674d442a=ze4d1094aab*z7e674d442a+(1.f-ze4d1094aab)*z7e674d442a*(1.f/
z19f71788a3);z7e674d442a=MAX(z7e674d442a,ze4b052164b);}}else if(z19f71788a3<MIN(
z64a05257f8,z947813c07b)){if(z2e91460297<zef2403cf04*z947813c07b&&z2e91460297>
z7e674d442a){float zcfff1e38a8=z2e91460297*(1.f/(zef2403cf04*z947813c07b));
zcfff1e38a8=MAX(ze82613f501,MIN(1.f,zcfff1e38a8));z2e91460297=zcfff1e38a8*
z2e91460297+(1.f-zcfff1e38a8)*z2e91460297*(1.f/z947813c07b);z2e91460297=MAX(
z2e91460297,z7e674d442a);}if(ze4b052164b<zef2403cf04*z64a05257f8&&ze4b052164b>
z7e674d442a){float zbffee8d12d=ze4b052164b*(1.f/(zef2403cf04*z64a05257f8));
zbffee8d12d=MAX(ze82613f501,MIN(1.f,zbffee8d12d));ze4b052164b=zbffee8d12d*
ze4b052164b+(1.f-zbffee8d12d)*ze4b052164b*(1.f/z64a05257f8);ze4b052164b=MAX(
ze4b052164b,z7e674d442a);}}else{
if(ze4b052164b<zef2403cf04*z64a05257f8&&ze4b052164b>z2e91460297){float
zbffee8d12d=ze4b052164b*(1.f/(zef2403cf04*z64a05257f8));zbffee8d12d=MAX(
ze82613f501,MIN(1.f,zbffee8d12d));ze4b052164b=zbffee8d12d*ze4b052164b+(1.f-
zbffee8d12d)*ze4b052164b*(1.f/z64a05257f8);ze4b052164b=MAX(ze4b052164b,
z2e91460297);}if(z7e674d442a<zef2403cf04*z19f71788a3&&z7e674d442a>z2e91460297){
float ze4d1094aab=z7e674d442a*(1.f/(zef2403cf04*z19f71788a3));ze4d1094aab=MAX(
ze82613f501,MIN(1.f,ze4d1094aab));z7e674d442a=ze4d1094aab*z7e674d442a+(1.f-
ze4d1094aab)*z7e674d442a*(1.f/z19f71788a3);z7e674d442a=MAX(z7e674d442a,
z2e91460297);}}
float z2da58847dd=(z7a5269b418)*(1.f/(zfe91d24aed));z2da58847dd=MAX(0.f,
z2da58847dd);
...
#if (z3dbd1ff682==1 )
__kernel void z05fab7fbaa(__global float4*zf8d9fd6cb8,__global float4*
z718a062ddd,int8 z30eaaf69b7,int z2824fcf57d,int z9562068e13,__global float4*
...
#if z3dbd1ff682==3
__kernel void z05fab7fbaa(__global float4*zf8d9fd6cb8,__global float4*
z718a062ddd,int8 z30eaaf69b7,int z2824fcf57d,int z9562068e13,float z0a00e1c231,
