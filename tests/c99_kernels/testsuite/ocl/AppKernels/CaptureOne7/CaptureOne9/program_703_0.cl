...
,int z958df11031,float2 zfe5849ca60,float2 zf897261185,float z6df7ccb0a4,float
zcd810bcd22,__constant float4*za80b27518d,int z7054fd23fd,__constant float4*
z4135b87944,int zb049e6b30d){int2 zba94ee46da=(int2)(get_global_id(0),
