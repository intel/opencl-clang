...
#endif
__kernel void z7c242b1d55(__global ushort4*zf8d9fd6cb8,__global ushort4*
z718a062ddd,int4 z30eaaf69b7,int z45c01651ac,int z745057f086,__global float*
z3ad6f7586a,int zb85bf64f18,float z3ee057f4d6,int2 zd72c7cd02e,__global uchar*
zec145e35cf,int16 z7f76fb323c,int4 z3576e84f20,float16 z4af71b4d47){int2
zba94ee46da=(int2)(get_global_id(0),get_global_id(1));if(zba94ee46da.x>=
z30eaaf69b7.z||zba94ee46da.y>=z30eaaf69b7.w)return;int2 zdc2396006d=(int2)(
get_global_id(0),get_global_id(1));zba94ee46da+=z30eaaf69b7.xy;int2 z83640e5796=
zba94ee46da;int2 z9b046bc3a1=z83640e5796;
...
z98cd6733c3];if(za097e3cbf4>0)z3ee057f4d6+=(convert_float(za097e3cbf4)/255.0f)*
za22b597f84[z1d8bd19892];}}ushort4 z493deefb55=zf8d9fd6cb8[z83640e5796.x+
z83640e5796.y*(z45c01651ac/4)];float4 z1ba64f1f2a=convert_float4(z493deefb55);
int z0b6cb751d4=zb85bf64f18;__global float*z1765c59f1b=z3ad6f7586a;zdc2396006d+=
zd72c7cd02e.xy;int z910b0f86fe=zdc2396006d.y>>3;int zad47d72831=zdc2396006d.x>>3
;
