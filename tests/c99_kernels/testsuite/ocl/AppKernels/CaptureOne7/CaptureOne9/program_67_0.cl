...
z718a062ddd,int4 z30eaaf69b7,int z021babbfad,int z958df11031,float4 zf808996ffa,
int2 zf793de71f2,__global float4*z69c89f1ddb,int zc9ba02a8f8
#if zbc6516e8d5
...
z945895b462+zf793de71f2)/(int2)(8,8);
#if 0
