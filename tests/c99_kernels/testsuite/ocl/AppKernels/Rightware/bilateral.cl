...
#define RANGE_DEVIATION 1
#define VALUE_DEVIATION 10
#define VALUE_DEVIATION_F (0.02f)
...
/* TODO: change this to float3 and half3 when supporting drivers become available. */
