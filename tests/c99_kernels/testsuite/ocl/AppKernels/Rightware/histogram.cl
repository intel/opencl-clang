...
/* TODO: Make a version of histogram which does not require atomic operations and a version without using floats */
...
* This function requires the device to support atomic functions in addition to atleast 4kB of local memory
*/
