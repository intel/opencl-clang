...
// buildOptions=-DWAVEFRONT_BLOCK_MULTIPLIER=2 -DWAVEFRONT_SIZE=32 -DMAX_NUM_VERTICES_PER_WAVE=48 -DMAX_BATCHES_PER_WAVE=48
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -DWAVEFRONT_BLOCK_MULTIPLIER=2 -DWAVEFRONT_SIZE=32 -DMAX_NUM_VERTICES_PER_WAVE=48 -DMAX_BATCHES_PER_WAVE=48" %cfg_path --cl-device=%cl_device 2>&1
