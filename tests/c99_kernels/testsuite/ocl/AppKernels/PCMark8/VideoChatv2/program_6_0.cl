...
// buildOptions= -D INTEL_DEVICE -D PACKED_CLASSIFIER -D NODE_SIZE=12 -D WND_SIZE_X=20 -D WND_SIZE_Y=20 -D STUMP_BASED=1 -D LSx=8 -D LSy=16 -D SPLITNODE=40 -D SPLITSTAGE=3 -D OUTPUTSZ=73728
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S  -D INTEL_DEVICE -D PACKED_CLASSIFIER -D NODE_SIZE=12 -D WND_SIZE_X=20 -D WND_SIZE_Y=20 -D STUMP_BASED=1 -D LSx=8 -D LSy=16 -D SPLITNODE=40 -D SPLITSTAGE=3 -D OUTPUTSZ=73728" %cfg_path --cl-device=%cl_device 2>&1
