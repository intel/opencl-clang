...
__kernel void specialKernel0(read_only image2d_t inputImage, write_only image2d_t outputImage)
{
    ...
    float4 pixel0 = read_imagef(inputImage,sampler,(int2)(i-2,j-1));
    float4 pixel1 = read_imagef(inputImage,sampler,(int2)(i-1,j-2));
    ...
    float4 pixel5 = read_imagef(inputImage,sampler,(int2)(i+1,j+2));
    ...
    float4 pixel13 = read_imagef(inputImage,sampler,(int2)(i+1,j+1));
    float4 pixel14 = read_imagef(inputImage,sampler,(int2)(i+1,j-1));
    float4 pixel15 = read_imagef(inputImage,sampler,(int2)(i-1,j-1));
    float4 pixel16 = read_imagef(inputImage,sampler,(int2)(i-0,j+0));
    float4 pixel17 = read_imagef(inputImage,sampler,(int2)(i-1,j+0));
    float4 pixel18 = read_imagef(inputImage,sampler,(int2)(i-0,j-1));
    float4 pixel19 = read_imagef(inputImage,sampler,(int2)(i+1,j+0));
    float4 pixel20 = read_imagef(inputImage,sampler,(int2)(i-0,j+1));
