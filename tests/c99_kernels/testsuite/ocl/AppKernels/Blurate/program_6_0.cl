...
__kernel void specialKernel0(read_only image2d_t inputImage, write_only image2d_t outputImage)
{
    ...
    float4 pixel0 = read_imagef(inputImage,sampler,(int2)(i-1,j+1));
    float4 pixel1 = read_imagef(inputImage,sampler,(int2)(i+1,j+1));
    float4 pixel2 = read_imagef(inputImage,sampler,(int2)(i+1,j-1));
    float4 pixel3 = read_imagef(inputImage,sampler,(int2)(i-1,j-1));
    float4 pixel4 = read_imagef(inputImage,sampler,(int2)(i-0,j+0));
    float4 pixel5 = read_imagef(inputImage,sampler,(int2)(i-1,j+0));
    float4 pixel6 = read_imagef(inputImage,sampler,(int2)(i-0,j-1));
    float4 pixel7 = read_imagef(inputImage,sampler,(int2)(i+1,j+0));
    float4 pixel8 = read_imagef(inputImage,sampler,(int2)(i-0,j+1));
