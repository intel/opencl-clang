...
// buildOptions=-D NEURON_COUNT=15 -D WEIGHT_COUNT=75 -D LEARN_RPROP
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D NEURON_COUNT=15 -D WEIGHT_COUNT=75 -D LEARN_RPROP" %cfg_path --cl-device=%cl_device 2>&1
