...
// buildOptions=-cl-fast-relaxed-math -DIMAGE_SUPPORT
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -cl-fast-relaxed-math -DIMAGE_SUPPORT" %cfg_path --cl-device=%cl_device 2>&1
