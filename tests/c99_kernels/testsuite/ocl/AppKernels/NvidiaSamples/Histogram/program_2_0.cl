...
// buildOptions=-D LOG2_WARP_SIZE=5 -D WARP_COUNT=6 -D MERGE_WORKGROUP_SIZE=256
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -D LOG2_WARP_SIZE=5 -D WARP_COUNT=6 -D MERGE_WORKGROUP_SIZE=256" %cfg_path --cl-device=%cl_device 2>&1
