...
// buildOptions=                -cl-fast-relaxed-math                                                  -D KERNEL_RADIUS=8                -D ROWS_BLOCKDIM_X=16 -D COLUMNS_BLOCKDIM_X=16                -D ROWS_BLOCKDIM_Y=4 -D COLUMNS_BLOCKDIM_Y=8                -D ROWS_RESULT_STEPS=8 -D COLUMNS_RESULT_STEPS=8                -D ROWS_HALO_STEPS=1 -D COLUMNS_HALO_STEPS=1
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S                 -cl-fast-relaxed-math                                                  -D KERNEL_RADIUS=8                -D ROWS_BLOCKDIM_X=16 -D COLUMNS_BLOCKDIM_X=16                -D ROWS_BLOCKDIM_Y=4 -D COLUMNS_BLOCKDIM_Y=8                -D ROWS_RESULT_STEPS=8 -D COLUMNS_RESULT_STEPS=8                -D ROWS_HALO_STEPS=1 -D COLUMNS_HALO_STEPS=1" %cfg_path --cl-device=%cl_device 2>&1
