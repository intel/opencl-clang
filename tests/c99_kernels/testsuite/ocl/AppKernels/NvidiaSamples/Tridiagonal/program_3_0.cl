...
// buildOptions=-cl-fast-relaxed-math -D BLOCK_DIM=16 -D system_size=128 -D REORDER
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -cl-fast-relaxed-math -D BLOCK_DIM=16 -D system_size=128 -D REORDER" %cfg_path --cl-device=%cl_device 2>&1
