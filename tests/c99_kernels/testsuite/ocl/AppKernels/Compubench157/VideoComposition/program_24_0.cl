...
__constant float filterWeights[ 35 ] =
{
0.000990575f,
0.00160681f,
0.00253109f,
...
// buildOptions=-cl-fast-relaxed-math -D FILTER_RAD=17 -D FILTER_SIZE=35
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -cl-fast-relaxed-math -D FILTER_RAD=17 -D FILTER_SIZE=35" %cfg_path --cl-device=%cl_device 2>&1
