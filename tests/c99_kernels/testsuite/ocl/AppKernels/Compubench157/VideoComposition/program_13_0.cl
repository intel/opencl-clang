...
// buildOptions=-cl-fast-relaxed-math -D FILTER_RAD=6 -D FILTER_SIZE=13
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -cl-fast-relaxed-math -D FILTER_RAD=6 -D FILTER_SIZE=13" %cfg_path --cl-device=%cl_device 2>&1
