...
// buildOptions=-cl-fast-relaxed-math -D FILTER_RAD=11 -D FILTER_SIZE=23
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -cl-fast-relaxed-math -D FILTER_RAD=11 -D FILTER_SIZE=23" %cfg_path --cl-device=%cl_device 2>&1
