...
__constant float filterWeights[ 33 ] =
{
0.00106779f,
0.00177995f,
0.00287086f,
...
// buildOptions=-cl-fast-relaxed-math -D FILTER_RAD=16 -D FILTER_SIZE=33
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -cl-fast-relaxed-math -D FILTER_RAD=16 -D FILTER_SIZE=33" %cfg_path --cl-device=%cl_device 2>&1
