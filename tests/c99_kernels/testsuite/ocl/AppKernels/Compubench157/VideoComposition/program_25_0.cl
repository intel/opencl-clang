...
__constant float filterWeights[ 37 ] =
{
0.000923596f,
0.00146186f,
0.00225388f,
...
// buildOptions=-cl-fast-relaxed-math -D FILTER_RAD=18 -D FILTER_SIZE=37
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -cl-fast-relaxed-math -D FILTER_RAD=18 -D FILTER_SIZE=37" %cfg_path --cl-device=%cl_device 2>&1
