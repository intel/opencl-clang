...
// buildOptions=-cl-fast-relaxed-math -D FILTER_RAD=10 -D FILTER_SIZE=21
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -cl-fast-relaxed-math -D FILTER_RAD=10 -D FILTER_SIZE=21" %cfg_path --cl-device=%cl_device 2>&1
