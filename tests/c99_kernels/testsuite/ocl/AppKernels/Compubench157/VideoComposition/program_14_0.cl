...
__constant float filterWeights[ 15 ] =
{
0.00332002f,
0.00926682f,
0.0220858f,
...
// buildOptions=-cl-fast-relaxed-math -D FILTER_RAD=7 -D FILTER_SIZE=15
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -cl-fast-relaxed-math -D FILTER_RAD=7 -D FILTER_SIZE=15" %cfg_path --cl-device=%cl_device 2>&1
