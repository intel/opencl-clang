...
// buildOptions=-cl-fast-relaxed-math -DWORK_GROUP_SIZE=64 -DSQRT=native_sqrt -DRSQRT=native_rsqrt -DRECIP=native_recip -DINVERSE_TOTAL_MASS=4.64563118e-003f
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -cl-fast-relaxed-math -DWORK_GROUP_SIZE=64 -DSQRT=native_sqrt -DRSQRT=native_rsqrt -DRECIP=native_recip -DINVERSE_TOTAL_MASS=4.64563118e-003f" %cfg_path --cl-device=%cl_device 2>&1
