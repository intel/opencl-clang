...
// buildOptions=-cl-fast-relaxed-math -DWORK_GROUP_SIZE=64 -DSQRT=native_sqrt -DRSQRT=native_rsqrt -DRECIP=native_recip -DNUM_ATOMS=32 -DPADDED_NUM_ATOMS=32
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -cl-fast-relaxed-math -DWORK_GROUP_SIZE=64 -DSQRT=native_sqrt -DRSQRT=native_rsqrt -DRECIP=native_recip -DNUM_ATOMS=32 -DPADDED_NUM_ATOMS=32" %cfg_path --cl-device=%cl_device 2>&1
