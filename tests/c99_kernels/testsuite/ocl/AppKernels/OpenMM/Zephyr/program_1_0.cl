...
// buildOptions=-cl-fast-relaxed-math -DWORK_GROUP_SIZE=64
// RUN: %occ-cli %s --cl-options="-I%cwd -I%S -cl-fast-relaxed-math -DWORK_GROUP_SIZE=64" %cfg_path --cl-device=%cl_device 2>&1
