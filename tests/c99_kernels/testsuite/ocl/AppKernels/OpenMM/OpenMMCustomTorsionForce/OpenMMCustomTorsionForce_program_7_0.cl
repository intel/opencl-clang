...
#endif
__kernel void computeBondedForces(__global real4* restrict forceBuffers, __global real* restrict energyBuffer, __global const real4* restrict posq, int groups, __global const uint4* restrict atomIndices0, __global const uint4* restrict bufferIndices0, __global float* customArg1, __global float2* customArg2) {
real energy = 0.0f;
if ((groups&1) != 0)
...
float2 torsionParams1 = customArg2[index];
real temp4 = torsionParams1.y*theta;
real temp5 = temp4-torsionParams1.x;
real temp6 = cos(temp5);
real temp7 = 1.00000000e+00f+temp6;
real temp8 = customArg1[0]*temp7;
energy += temp8;
real temp9 = sin(temp5);
real temp10 = temp9*torsionParams1.y;
real temp11 = customArg1[0]*temp10;
real temp12 = -temp11;
real dEdAngle = temp12;
