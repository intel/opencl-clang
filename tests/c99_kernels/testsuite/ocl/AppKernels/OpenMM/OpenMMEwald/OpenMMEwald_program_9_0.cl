...
#define CUTOFF 1.20000000e+00f
#define CUTOFF_SQUARED 1.44000000e+00f
#define FIRST_EXCLUSION_TILE 0
#define FORCE_WORK_GROUP_SIZE 32
#define LAST_EXCLUSION_TILE 28
#define NUM_ATOMS 894
#define NUM_BLOCKS 28
#define NUM_TILES_WITH_EXCLUSIONS 28
#define PADDED_NUM_ATOMS 896
...
__kernel void computeNonbonded(
    ...
    const real alphaR = 2.74111928e+00f*r;
    ...
    tempForce += prefactor*(invR - 2.0f*2.83843885e-01f*r2);
    tempEnergy += select((real) 0, prefactor*(invR + 2.83843885e-01f*r2 - 1.24206853e+00f), includeInteraction);
  #else
    const real prefactor = 138.935456f*posq1.w*posq2.w*invR;
    tempForce += prefactor;
