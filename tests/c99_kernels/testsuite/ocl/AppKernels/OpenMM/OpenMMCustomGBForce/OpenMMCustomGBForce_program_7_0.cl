...
#define CUTOFF 2.00000000e+00f
#define CUTOFF_SQUARED 4.00000000e+00f
#define FIRST_EXCLUSION_TILE 0
#define FORCE_WORK_GROUP_SIZE 32
#define LAST_EXCLUSION_TILE 5
#define NUM_ATOMS 140
#define NUM_BLOCKS 5
#define NUM_TILES_WITH_EXCLUSIONS 5
...
#endif
        , __global const float2* restrict global_obcParams, __global const real* restrict global_bornForce) {
...
real bornForce1 = global_bornForce[atom1];
        ...
        if (x == y) {
            ...
            localData[localAtomIndex].obcParams_x = obcParams1.x;
localData[localAtomIndex].obcParams_y = obcParams1.y;
localData[localAtomIndex].bornForce = bornForce1;
...
real bornForce2 = localData[atom2].bornForce;
...
localData[localAtomIndex].obcParams_x = temp_obcParams.x;
localData[localAtomIndex].obcParams_y = temp_obcParams.y;
localData[localAtomIndex].bornForce = global_bornForce[j];
