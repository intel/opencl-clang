...
#define LAST_EXCLUSION_TILE 18
#define NUM_ATOMS 320
#define NUM_BLOCKS 10
#define NUM_TILES_WITH_EXCLUSIONS 18
...
localData[localAtomIndex].sigmaEpsilon_y = sigmaEpsilon1.y;
    ...
    tempEnergy += select((real) 0, prefactor*(invR + 4.90482234e-01f*r2 - 1.49048223e+00f), includeInteraction);
  #else
    const real prefactor = 138.935456f*posq1.w*posq2.w*invR;
    tempForce += prefactor;
