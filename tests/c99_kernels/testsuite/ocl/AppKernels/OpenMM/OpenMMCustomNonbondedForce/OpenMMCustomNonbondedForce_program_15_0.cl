...
typedef struct {
    ...
    real q;
    real fx, fy, fz;
    float custom0_params1_x;
float custom0_params1_y;
...
__kernel void computeNonbonded(
...
#endif
        , __global const float2* restrict global_custom0_params1, __constant float* restrict custom0_globals) {
    ...
    for (int pos = firstExclusionTile; pos < lastExclusionTile; pos++) {
        ...
        float2 custom0_params11 = global_custom0_params1[atom1];
        ...
        if (x == y) {
            ...
            localData[localAtomIndex].custom0_params1_x = custom0_params11.x;
localData[localAtomIndex].custom0_params1_y = custom0_params11.y;
            ...
            for (unsigned int j = 0; j < TILE_SIZE; j++) {
                ...
                real invR = RSQRT(r2);
                real r = r2*invR;
                float2 custom0_params12 = (float2) (localData[atom2].custom0_params1_x, localData[atom2].custom0_params1_y);
...
#endif
    real tempForce = 0.0f;
    float custom0_temp9 = custom0_params11.x*custom0_params12.x;
float custom0_temp10 = custom0_globals[0]*custom0_temp9;
float custom0_temp11 = custom0_globals[1]+custom0_params11.y;
float custom0_temp12 = custom0_temp11+custom0_params12.y;
float custom0_temp13 = r*custom0_temp12;
float custom0_temp14 = custom0_temp13*custom0_temp13*custom0_temp13;
float custom0_temp15 = custom0_temp10*custom0_temp14;
tempEnergy += custom0_temp15;
float custom0_temp16 = custom0_temp13*custom0_temp13;
float custom0_temp17 = 3.00000000e+00f*custom0_temp16;
float custom0_temp18 = custom0_temp17*custom0_temp12;
float custom0_temp19 = custom0_temp10*custom0_temp18;
tempForce -= custom0_temp19;
    ...
    dEdR += tempForce*invR;
            ...
            float2 temp_custom0_params1 = global_custom0_params1[j];
localData[localAtomIndex].custom0_params1_x = temp_custom0_params1.x;
localData[localAtomIndex].custom0_params1_y = temp_custom0_params1.y;
