...
__kernel void computePerDof(__global real4* restrict posq, __global real4* restrict posqCorrection, __global mixed4* restrict posDelta,
    ...
    while (index < NUM_ATOMS) {
        ...
        if (velocity.w != 0.0) {
            ...
            int uniformIndex = 0;
            float temp0_7 = 5.00000000e-01f*stepSize;
float temp0_8 = temp0_7*f.x;
float temp0_9 = temp0_8/mass;
float temp0_10 = velocity.x+temp0_9;
float temp0_11 = mass*temp0_10;
float temp0_12 = temp0_11*temp0_10;
float temp0_13 = 5.00000000e-01f*temp0_12;
sum[3*index+0] = temp0_13;
float temp1_7 = 5.00000000e-01f*stepSize;
float temp1_8 = temp1_7*f.y;
float temp1_9 = temp1_8/mass;
float temp1_10 = velocity.y+temp1_9;
float temp1_11 = mass*temp1_10;
float temp1_12 = temp1_11*temp1_10;
float temp1_13 = 5.00000000e-01f*temp1_12;
sum[3*index+1] = temp1_13;
float temp2_7 = 5.00000000e-01f*stepSize;
float temp2_8 = temp2_7*f.z;
float temp2_9 = temp2_8/mass;
float temp2_10 = velocity.z+temp2_9;
float temp2_11 = mass*temp2_10;
float temp2_12 = temp2_11*temp2_10;
float temp2_13 = 5.00000000e-01f*temp2_12;
sum[3*index+2] = temp2_13;
