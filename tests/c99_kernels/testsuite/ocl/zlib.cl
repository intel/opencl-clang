...
/*  'testsuite\gcc.dg\20020426-2.c'  */
#define exit(code) {if(ocl_test_results[1] == 0) {ocl_test_results[1] = 1; ocl_test_results[2] = code;}}
...
int
main_function_ocl(int argc, char **argv, __global int *ocl_test_results)
{
