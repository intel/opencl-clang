...
// RUN: not %occ-cli %s --cl-options="-triple spir-unknown-unknown -cl-std=CL3.0" --cl-options-ex="-cl-ext=-cl_khr_fp64,-__opencl_c_fp64,-cl_khr_3d_image_writes,-__opencl_c_3d_image_writes" --cl-device=%cl_device %cfg_path 2>&1 | FileCheck %s
// RUN: not %occ-cli %s --cl-options="-triple spir-unknown-unknown -cl-std=CL3.1" --cl-options-ex="-cl-ext=-cl_khr_fp64,-__opencl_c_fp64,-cl_khr_3d_image_writes,-__opencl_c_3d_image_writes" --cl-device=%cl_device %cfg_path 2>&1 | FileCheck %s
